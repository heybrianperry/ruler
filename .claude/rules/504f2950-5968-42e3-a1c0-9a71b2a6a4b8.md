<rule_activation id="504f2950-5968-42e3-a1c0-9a71b2a6a4b8" title="Standardize Environment Variable Access for Configuration Management: Configuration Loaders Configloader" applies_to="**/*">
These rules are ALWAYS ACTIVE for all configuration loading, agent initialization, and runtime environment setup code.
</rule_activation>

### Rules

- **R-CFG-001** MUST: Configuration loaders (ConfigLoader, UnifiedConfigLoader) MUST provide a centralized interface for accessing environment variables rather than direct process.env access scattered throughout the codebase.
