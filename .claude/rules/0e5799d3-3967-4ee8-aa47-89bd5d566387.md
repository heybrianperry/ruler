<rule_activation id="0e5799d3-3967-4ee8-aa47-89bd5d566387" title="Standardize Environment Variable Access for Configuration Management: Agent Implementations Retrieve" applies_to="**/*">
These rules are ALWAYS ACTIVE for all configuration loading, agent initialization, and runtime environment setup code.
</rule_activation>

### Rules

- **R-ENV-001** MUST: Agent implementations MUST retrieve all runtime configuration through the configuration loader abstraction layer (ConfigLoader or UnifiedConfigLoader).
