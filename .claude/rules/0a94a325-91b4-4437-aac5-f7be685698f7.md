<rule_activation id="0a94a325-91b4-4437-aac5-f7be685698f7" title="Adopt Unit Testing for CI/CD Pipeline Components: Changes Components Not" applies_to="**/*">
These rules are ALWAYS ACTIVE for all CI/CD pipeline components, build tooling, and deployment automation code.
</rule_activation>

### Rules

- **R-CICD-001** MUST: Changes to CI/CD components MUST NOT be merged without passing unit tests to prevent pipeline regressions.
...
<enforcement>
Claude Code MUST verify unit tests exist and pass for all CI/CD components before approving changes. Verification is mandatory and cannot be deferred or skipped.
</enforcement>