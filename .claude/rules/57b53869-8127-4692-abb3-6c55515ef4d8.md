<rule_activation id="57b53869-8127-4692-abb3-6c55515ef4d8" title="Adopt Async/Await Concurrency Model for External API Interactions: Functions That Interact" applies_to="**/*">
These rules are ALWAYS ACTIVE for all external API interactions and public-facing API implementations within the system.
</rule_activation>

### Rules

- **R-ASYNC-001** MUST: All functions that interact with external APIs MUST be declared as async and return Promises.
...
<enforcement>
Claude Code MUST NOT skip or defer verification. All external API interaction functions MUST comply with R-ASYNC-001 before code acceptance.
</enforcement>