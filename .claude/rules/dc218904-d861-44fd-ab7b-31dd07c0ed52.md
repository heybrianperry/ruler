<rule_activation id="dc218904-d861-44fd-ab7b-31dd07c0ed52" title="Adopt Unit Testing for CI/CD Pipeline Components: Agent Implementations Have" applies_to="**/*">
These rules are ALWAYS ACTIVE for all CI/CD pipeline components, build tooling, and deployment automation code.
</rule_activation>

### Rules

- **R-CICD-001** MUST: All CI/CD agent implementations MUST have corresponding unit tests covering core functionality, error handling, and edge cases.
...
<enforcement>
Claude Code MUST verify unit test coverage for all CI/CD components before approving changes. Verification is mandatory and cannot be deferred or skipped.
</enforcement>