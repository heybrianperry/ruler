<rule_activation id="de981c50-a250-4c20-b365-8528a41793be" title="Adopt Async/Await Concurrency Model for External API Interactions: External Calls Not" applies_to="**/*">
These rules are ALWAYS ACTIVE for all external API interactions and public-facing API implementations within the system.
</rule_activation>

### Rules

- **R-ASYNC-001** MUST_NOT: External API calls MUST NOT use synchronous blocking operations or busy-wait loops.
...
# Verify ESLint rules for floating promises
...
<enforcement>
Claude Code MUST verify compliance with R-ASYNC-001 before accepting code changes involving external API interactions. Verification is mandatory and cannot be deferred.
</enforcement>