<rule_activation id="5ba77196-7a8b-4961-8e05-74b187934dda" title="Standardize Structured Logging with Consistent Format and Levels: Structured Log Entries" applies_to="**/*">
...
- **R-LOG-001** MUST: Structured log entries MUST include contextual metadata such as timestamp, component name, and operation identifier where applicable.
...
<enforcement>
Claude Code MUST NOT skip or defer verification of structured logging compliance.
</enforcement>