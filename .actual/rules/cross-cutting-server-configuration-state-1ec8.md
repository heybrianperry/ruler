# Standardize Map-Based In-Memory Cache for Server Configuration State: Server Configuration State
...
- **R-CACHE-001** MUST: Server configuration state MUST be cached in-memory using Map data structures indexed by server name or URL during read-modify-write operations.
