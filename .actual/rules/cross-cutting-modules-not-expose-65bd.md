# Standardize Public API Contracts Through Exported Interfaces and Types: Modules Not Expose
...
- **R-API-001** MUST NOT: Modules MUST NOT expose internal implementation details or private helper functions as part of the public API contract.
