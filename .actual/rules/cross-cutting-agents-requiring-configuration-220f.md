# Standardize Agent Implementation Using Core Interface Contracts and Configuration Loaders: Agents Requiring Configuration
...
- **R-AGENT-CONFIG-001** SHOULD: Agents requiring configuration application SHOULD use applyRulerConfig for consistent rule processing.
...
# Verify consistent parsing patterns (JSON.parse, parseTOML) in key agents
...
- Agents requiring configuration use applyRulerConfig for consistent rule processing
