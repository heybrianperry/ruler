...
- **R-CORE-FS-001** MUST: Core modules requiring file system interactions MUST use the capabilities provided by the Node.js `fs` module, potentially abstracted through local utility modules.
