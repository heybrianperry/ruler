# Adopt Comprehensive Test Coverage for CI/CD Pipeline Components: Integration Points External
...
1. MUST: Integration points with external systems (such as MCP skills) MUST include integration test suites

## Policy Block

- MUST Integration points with external systems (such as MCP skills) MUST include integration test suites
