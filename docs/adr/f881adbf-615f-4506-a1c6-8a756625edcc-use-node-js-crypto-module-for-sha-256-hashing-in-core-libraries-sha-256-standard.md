...
1. MUST: SHA-256 MUST be the standard hashing algorithm for content addressing and integrity verification

## Policy Block

- MUST SHA-256 MUST be the standard hashing algorithm for content addressing and integrity verification
