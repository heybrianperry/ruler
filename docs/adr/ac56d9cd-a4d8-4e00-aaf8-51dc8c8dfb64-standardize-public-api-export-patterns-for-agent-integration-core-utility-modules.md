# Standardize Public API Export Patterns for Agent Integration: Core Utility Modules
...
1. MUST: Core utility modules MUST export pure functions with well-defined input/output contracts and no side effects

## Policy Block

- MUST Core utility modules MUST export pure functions with well-defined input/output contracts and no side effects
