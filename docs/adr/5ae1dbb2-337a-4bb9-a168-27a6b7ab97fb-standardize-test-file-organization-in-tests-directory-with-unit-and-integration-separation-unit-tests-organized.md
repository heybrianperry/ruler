# Standardize Test File Organization in tests/ Directory with Unit and Integration Separation: Unit Tests Organized
...
1. MUST: Unit tests MUST be organized under tests/unit/ subdirectory with structure mirroring the source code organization

## Policy Block

- MUST Unit tests MUST be organized under tests/unit/ subdirectory with structure mirroring the source code organization
