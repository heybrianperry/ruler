...
1. MUST: All agent implementations MUST implement the IAgent interface or extend AbstractAgent base class to ensure contract compliance

## Policy Block

- MUST All agent implementations MUST implement the IAgent interface or extend AbstractAgent base class to ensure contract compliance
