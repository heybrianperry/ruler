...
1. SHOULD: Configuration loaders SHOULD implement fallback behavior that allows execution to continue when non-critical configuration is unavailable

## Policy Block

- SHOULD Configuration loaders SHOULD implement fallback behavior that allows execution to continue when non-critical configuration is unavailable
