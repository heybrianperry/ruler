...
1. MUST: Configuration path resolution MUST respect the XDG Base Directory specification by reading process.env.XDG_CONFIG_HOME as the primary configuration directory source

## Policy Block

- MUST Configuration path resolution MUST respect the XDG Base Directory specification by reading process.env.XDG_CONFIG_HOME as the primary configuration directory source
