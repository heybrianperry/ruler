# Standardize Agent Architecture with External API Integration Pattern: New Agent Types
...
1. MUST: New agent types MUST be placed in the agents directory following the naming convention [ServiceName]Agent.ts

## Policy Block

- MUST New agent types MUST be placed in the agents directory following the naming convention [ServiceName]Agent.ts
