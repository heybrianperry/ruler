# Adopt Async/Await Concurrency Model for External API Interactions: Developers Use Async
...
1. MAY: Developers MAY use async generators (async function*) for streaming API responses or paginated data

## Policy Block

- MAY Developers MAY use async generators (async function*) for streaming API responses or paginated data
