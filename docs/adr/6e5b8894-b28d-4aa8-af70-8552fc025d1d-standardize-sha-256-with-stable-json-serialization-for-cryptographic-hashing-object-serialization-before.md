...
1. MUST: Object serialization before hashing MUST use stable JSON serialization to ensure deterministic key ordering

## Policy Block

- MUST Object serialization before hashing MUST use stable JSON serialization to ensure deterministic key ordering
