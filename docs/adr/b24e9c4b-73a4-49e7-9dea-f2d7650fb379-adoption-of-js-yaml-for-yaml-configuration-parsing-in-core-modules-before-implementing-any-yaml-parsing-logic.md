...
1. MUST: Before implementing any YAML parsing logic using `js-yaml`, developers MUST discover the ecosystem's lock file and resolve the exact locked version.
