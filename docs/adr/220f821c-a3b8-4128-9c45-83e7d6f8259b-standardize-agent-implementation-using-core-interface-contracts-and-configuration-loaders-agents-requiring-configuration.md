...
1. SHOULD: Agents requiring configuration application SHOULD use applyRulerConfig for consistent rule processing

## Policy Block

- SHOULD Agents requiring configuration application SHOULD use applyRulerConfig for consistent rule processing
