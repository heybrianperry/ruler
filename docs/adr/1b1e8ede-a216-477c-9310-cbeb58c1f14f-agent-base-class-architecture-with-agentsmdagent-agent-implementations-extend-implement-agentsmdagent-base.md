...
1. MUST: All agent implementations MUST extend or implement the AgentsMdAgent base class or IAgent interface to ensure consistent agent behavior and interface contracts

## Policy Block

- MUST All agent implementations MUST extend or implement the AgentsMdAgent base class or IAgent interface to ensure consistent agent behavior and interface contracts
