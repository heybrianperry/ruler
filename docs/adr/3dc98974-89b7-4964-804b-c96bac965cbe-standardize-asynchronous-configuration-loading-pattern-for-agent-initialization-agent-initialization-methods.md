...
1. MUST: Agent initialization methods that load configuration MUST be declared as async and return Promises

## Policy Block

- MUST Agent initialization methods that load configuration MUST be declared as async and return Promises
