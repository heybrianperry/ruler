...
1. MUST: SkillsProcessor and SubagentsProcessor MUST delegate isolation logic and provenance inspection to shared utility functions in SkillsUtils.

## Policy Block

- MUST SkillsProcessor and SubagentsProcessor MUST delegate isolation logic and provenance inspection to shared utility functions in SkillsUtils.
