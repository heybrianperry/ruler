...
1. MUST_NOT: Core engine components MUST NOT independently parse configuration files or bypass the ConfigLoader module to read raw configuration values.

## Policy Block

- MUST_NOT Core engine components MUST NOT independently parse configuration files or bypass the ConfigLoader module to read raw configuration values.
