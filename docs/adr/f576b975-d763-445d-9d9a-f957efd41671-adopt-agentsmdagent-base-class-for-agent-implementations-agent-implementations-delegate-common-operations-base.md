# Adopt AgentsMdAgent Base Class for Agent Implementations: Agent Implementations Delegate Common Operations Base
...
1. SHOULD: Agent implementations SHOULD delegate common operations to base class methods rather than reimplementing shared functionality.

## Policy Block

- SHOULD Agent implementations SHOULD delegate common operations to base class methods rather than reimplementing shared functionality.
