# Adopt Vitest with vi.mock() for Unit Testing TypeScript Agent Modules: Module Level Mocking
...
1. MUST: Module-level mocking MUST be performed using Vitest's vi.mock() API at the top of test files

## Policy Block

- MUST Module-level mocking MUST be performed using Vitest's vi.mock() API at the top of test files
