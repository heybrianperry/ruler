...
1. SHOULD: Logging functions (logVerbose, logInfo, logWarn) SHOULD be defined in a central constants module and exported as part of the public API contract

## Policy Block

- SHOULD Logging functions (logVerbose, logInfo, logWarn) SHOULD be defined in a central constants module and exported as part of the public API contract
