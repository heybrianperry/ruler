...
1. MUST: Test harnesses MUST use JSON.parse to validate configuration file contents before asserting on configuration structure, server definitions, or key presence

## Policy Block

- MUST Test harnesses MUST use JSON.parse to validate configuration file contents before asserting on configuration structure, server definitions, or key presence
