...
1. MUST: Map-based caches MUST use server.name as the key for stdio server types and url as the key for SSE and SHTTP server types

## Policy Block

- MUST Map-based caches MUST use server.name as the key for stdio server types and url as the key for SSE and SHTTP server types
