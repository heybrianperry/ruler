# Standardize Test File Organization in tests/ Directory with Unit and Integration Separation: Additional Test Subdirectories
...
1. MAY: Additional test subdirectories (e.g., tests/e2e/, tests/performance/) MAY be created for specialized test types following the same organizational principles

## Policy Block

- MAY Additional test subdirectories (e.g., tests/e2e/, tests/performance/) MAY be created for specialized test types following the same organizational principles
