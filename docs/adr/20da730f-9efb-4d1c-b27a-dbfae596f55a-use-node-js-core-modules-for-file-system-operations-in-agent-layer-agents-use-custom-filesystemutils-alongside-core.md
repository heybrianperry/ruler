...
1. MAY: Agents MAY use custom FileSystemUtils alongside core modules to provide project-specific abstractions over file system primitives

## Policy Block

- MAY Agents MAY use custom FileSystemUtils alongside core modules to provide project-specific abstractions over file system primitives
