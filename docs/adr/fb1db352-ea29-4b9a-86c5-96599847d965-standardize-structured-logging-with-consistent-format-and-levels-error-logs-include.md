# Standardize Structured Logging with Consistent Format and Levels: Error Logs Include
...
1. SHOULD: Error logs SHOULD include stack traces and error context to facilitate debugging

## Policy Block

- SHOULD Error logs SHOULD include stack traces and error context to facilitate debugging
