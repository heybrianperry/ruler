...
1. SHOULD: Operating system-specific operations (home directory resolution, platform detection) SHOULD use the 'os' core module.

## Policy Block

- SHOULD Operating system-specific operations (home directory resolution, platform detection) SHOULD use the 'os' core module.
