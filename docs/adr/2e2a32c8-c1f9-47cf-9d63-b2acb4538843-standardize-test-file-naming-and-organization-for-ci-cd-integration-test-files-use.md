...
1. MUST: All test files MUST use the .test.ts extension to enable automated test discovery by CI/CD tooling

## Policy Block

- MUST All test files MUST use the .test.ts extension to enable automated test discovery by CI/CD tooling
