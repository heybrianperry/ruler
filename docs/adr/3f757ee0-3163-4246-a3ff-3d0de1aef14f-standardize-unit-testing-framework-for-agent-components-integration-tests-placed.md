# Standardize Unit Testing Framework for Agent Components: Integration Tests Placed
...
1. MAY: Integration tests MAY be placed in separate directories outside of `tests/unit/` to distinguish from unit tests

## Policy Block

- MAY Integration tests MAY be placed in separate directories outside of `tests/unit/` to distinguish from unit tests
