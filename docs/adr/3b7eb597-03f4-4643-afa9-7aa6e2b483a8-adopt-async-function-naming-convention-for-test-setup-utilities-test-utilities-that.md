...
1. SHOULD: Test utilities that parse JSON from file system reads SHOULD combine the read and parse operations in a single async function

## Policy Block

- SHOULD Test utilities that parse JSON from file system reads SHOULD combine the read and parse operations in a single async function
