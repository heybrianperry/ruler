...
1. SHOULD: Log messages SHOULD include the operation being performed and the specific resource (file path, configuration key) that triggered the condition

## Policy Block

- SHOULD Log messages SHOULD include the operation being performed and the specific resource (file path, configuration key) that triggered the condition
