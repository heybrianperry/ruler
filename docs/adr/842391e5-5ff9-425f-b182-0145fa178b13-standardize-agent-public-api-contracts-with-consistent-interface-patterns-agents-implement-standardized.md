# Standardize Agent Public API Contracts with Consistent Interface Patterns: Agents Implement Standardized
...
1. MUST: All agents MUST implement a standardized error handling pattern that provides consistent error types and messages across the public API surface

## Policy Block

- MUST All agents MUST implement a standardized error handling pattern that provides consistent error types and messages across the public API surface
