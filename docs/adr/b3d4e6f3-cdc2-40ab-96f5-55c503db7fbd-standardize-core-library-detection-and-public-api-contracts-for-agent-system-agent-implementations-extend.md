...
1. SHOULD: Agent implementations SHOULD extend AgentsMdAgent or AbstractAgent base classes to inherit common configuration application patterns

## Policy Block

- SHOULD Agent implementations SHOULD extend AgentsMdAgent or AbstractAgent base classes to inherit common configuration application patterns
