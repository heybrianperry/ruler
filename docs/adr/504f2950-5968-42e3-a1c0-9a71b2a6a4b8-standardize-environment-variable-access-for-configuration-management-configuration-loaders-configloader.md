# Standardize Environment Variable Access for Configuration Management: Configuration Loaders Configloader
...
1. MUST: Configuration loaders (ConfigLoader, UnifiedConfigLoader) MUST provide a centralized interface for accessing environment variables rather than direct process.env access scattered throughout the codebase

## Policy Block

- MUST Configuration loaders (ConfigLoader, UnifiedConfigLoader) MUST provide a centralized interface for accessing environment variables rather than direct process.env access scattered throughout the codebase
