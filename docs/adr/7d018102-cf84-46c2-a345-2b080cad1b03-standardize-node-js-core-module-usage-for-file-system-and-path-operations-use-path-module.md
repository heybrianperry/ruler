...
1. MUST: Use the 'path' module for all file path construction, resolution, and manipulation to ensure cross-platform compatibility

## Policy Block

- MUST Use the 'path' module for all file path construction, resolution, and manipulation to ensure cross-platform compatibility
