# Adopt Vitest with vi.mock() for Unit Testing TypeScript Agent Modules: Each Agent Implementation
...
1. MUST: Each agent implementation MUST have a corresponding unit test file that mocks external dependencies

## Policy Block

- MUST Each agent implementation MUST have a corresponding unit test file that mocks external dependencies
