...
1. MUST: Path manipulation operations MUST use the 'path' core module for all path resolution, joining, normalization, and parsing operations

## Policy Block

- MUST Path manipulation operations MUST use the 'path' core module for all path resolution, joining, normalization, and parsing operations
