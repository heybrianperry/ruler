# Adopt Async/Await Concurrency Model for External API Interactions: External Calls Not
...
1. MUST_NOT: External API calls MUST NOT use synchronous blocking operations or busy-wait loops

## Policy Block

- MUST_NOT External API calls MUST NOT use synchronous blocking operations or busy-wait loops
