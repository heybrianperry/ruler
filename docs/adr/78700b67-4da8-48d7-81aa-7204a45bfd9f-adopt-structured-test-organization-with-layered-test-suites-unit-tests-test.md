# Adopt Structured Test Organization with Layered Test Suites: Unit Tests Test
...
1. MUST: Unit tests MUST test isolated components without external dependencies (databases, networks, file systems)

## Policy Block

- MUST Unit tests MUST test isolated components without external dependencies (databases, networks, file systems)
