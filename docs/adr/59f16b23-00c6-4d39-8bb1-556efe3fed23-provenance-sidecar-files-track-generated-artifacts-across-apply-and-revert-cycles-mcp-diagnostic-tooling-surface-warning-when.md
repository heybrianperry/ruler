...
1. SHOULD: MCP diagnostic tooling SHOULD surface a warning when a generated artifact is found without a corresponding .ruler-provenance.json sidecar, indicating a provenance gap that requires remediation.

## Policy Block

- SHOULD MCP diagnostic tooling SHOULD surface a warning when a generated artifact is found without a corresponding .ruler-provenance.json sidecar, indicating a provenance gap that requires remediation.
