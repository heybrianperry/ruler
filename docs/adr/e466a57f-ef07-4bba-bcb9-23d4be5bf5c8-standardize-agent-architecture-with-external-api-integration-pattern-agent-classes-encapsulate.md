# Standardize Agent Architecture with External API Integration Pattern: Agent Classes Encapsulate
...
1. MUST: Agent classes MUST encapsulate external API communication logic within their implementation boundaries

## Policy Block

- MUST Agent classes MUST encapsulate external API communication logic within their implementation boundaries
