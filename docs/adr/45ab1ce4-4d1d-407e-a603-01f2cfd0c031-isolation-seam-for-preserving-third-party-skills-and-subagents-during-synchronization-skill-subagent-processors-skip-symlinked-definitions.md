...
1. MUST: Skill and subagent processors MUST skip symlinked definitions during propagation and cleanup passes to maintain isolation.

## Policy Block

- MUST Skill and subagent processors MUST skip symlinked definitions during propagation and cleanup passes to maintain isolation.
