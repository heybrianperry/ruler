...
1. MUST: Modules MUST import dependencies using explicit relative or package paths (e.g., './IAgent', '../core/FileSystemUtils', 'fs/promises') to maintain clear dependency graphs

## Policy Block

- MUST Modules MUST import dependencies using explicit relative or package paths (e.g., './IAgent', '../core/FileSystemUtils', 'fs/promises') to maintain clear dependency graphs
