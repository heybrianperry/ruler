# Adopt Vitest with vi.mock() for Unit Testing TypeScript Agent Modules: Unit Tests Agent
...
1. MUST: All unit tests for agent modules MUST use Vitest as the testing framework

## Policy Block

- MUST All unit tests for agent modules MUST use Vitest as the testing framework
