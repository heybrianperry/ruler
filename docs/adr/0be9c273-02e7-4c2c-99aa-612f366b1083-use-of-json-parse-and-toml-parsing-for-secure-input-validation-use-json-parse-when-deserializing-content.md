...
1. MUST: MUST use JSON.parse() when deserializing JSON content from external sources.

## Policy Block

- MUST MUST use JSON.parse() when deserializing JSON content from external sources.
