...
1. MUST_NOT: Modules MUST_NOT invoke synchronous file system methods on the main execution thread.

## Policy Block

- MUST_NOT Modules MUST_NOT invoke synchronous file system methods on the main execution thread.
