...
1. MUST: All path construction, resolution, and manipulation operations MUST use the Node.js core path module to ensure cross-platform compatibility

## Policy Block

- MUST All path construction, resolution, and manipulation operations MUST use the Node.js core path module to ensure cross-platform compatibility
