...
1. SHOULD_NOT: Subsystem modules SHOULD NOT bypass the constants module by hardcoding fallback values directly in processing routines.

## Policy Block

- SHOULD_NOT Subsystem modules SHOULD NOT bypass the constants module by hardcoding fallback values directly in processing routines.
