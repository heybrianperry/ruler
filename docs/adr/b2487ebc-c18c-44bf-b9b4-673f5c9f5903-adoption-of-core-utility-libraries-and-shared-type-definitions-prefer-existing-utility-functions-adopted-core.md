...
1. SHOULD: SHOULD prefer existing utility functions from adopted core libraries over custom implementations for common tasks.

## Policy Block

- SHOULD SHOULD prefer existing utility functions from adopted core libraries over custom implementations for common tasks.
