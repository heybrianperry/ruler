...
1. MUST: All specialized agent implementations MUST extend the internal AbstractAgent base class to inherit foundational agent lifecycle and execution behavior.

## Policy Block

- MUST All specialized agent implementations MUST extend the internal AbstractAgent base class to inherit foundational agent lifecycle and execution behavior.
