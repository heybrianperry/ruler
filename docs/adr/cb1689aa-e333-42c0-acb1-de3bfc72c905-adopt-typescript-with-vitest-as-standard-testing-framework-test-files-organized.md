...
1. MUST: Test files MUST be organized into appropriate directories based on test type: tests/unit/, tests/integration/, or tests/e2e/

## Policy Block

- MUST Test files MUST be organized into appropriate directories based on test type: tests/unit/, tests/integration/, or tests/e2e/
