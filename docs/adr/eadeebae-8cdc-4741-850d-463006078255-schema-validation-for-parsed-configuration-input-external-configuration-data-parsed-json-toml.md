...
1. MUST: All external configuration data parsed from JSON or TOML files MUST be validated against an explicit schema before use in application logic

## Policy Block

- MUST All external configuration data parsed from JSON or TOML files MUST be validated against an explicit schema before use in application logic
