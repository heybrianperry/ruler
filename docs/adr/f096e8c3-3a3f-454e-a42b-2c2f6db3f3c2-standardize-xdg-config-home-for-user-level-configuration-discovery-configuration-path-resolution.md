...
1. SHOULD: Configuration path resolution SHOULD be centralized in core utilities rather than duplicated across CLI handlers and application logic

## Policy Block

- SHOULD Configuration path resolution SHOULD be centralized in core utilities rather than duplicated across CLI handlers and application logic
