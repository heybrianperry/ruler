# Standardize Public API Export Patterns for Agent Integration: Public Include Typescript
...
1. SHOULD: Public APIs SHOULD include TypeScript type definitions for all exported functions, classes, and interfaces

## Policy Block

- SHOULD Public APIs SHOULD include TypeScript type definitions for all exported functions, classes, and interfaces
