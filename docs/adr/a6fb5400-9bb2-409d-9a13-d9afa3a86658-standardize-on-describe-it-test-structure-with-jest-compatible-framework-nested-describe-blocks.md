...
1. SHOULD: Nested describe blocks SHOULD be used to create hierarchical test organization when testing multiple aspects of a component or feature

## Policy Block

- SHOULD Nested describe blocks SHOULD be used to create hierarchical test organization when testing multiple aspects of a component or feature
