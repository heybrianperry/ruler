...
1. SHOULD: Error messages related to configuration directory access SHOULD include the resolved XDG path to aid debugging

## Policy Block

- SHOULD Error messages related to configuration directory access SHOULD include the resolved XDG path to aid debugging
