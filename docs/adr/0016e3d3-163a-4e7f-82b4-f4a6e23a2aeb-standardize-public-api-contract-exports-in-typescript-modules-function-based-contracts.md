...
1. MUST: Function-based API contracts (e.g., parseFrontmatter, loadSubagentFile, mapRawAgentConfigs) MUST be exported as named functions with camelCase naming

## Policy Block

- MUST Function-based API contracts (e.g., parseFrontmatter, loadSubagentFile, mapRawAgentConfigs) MUST be exported as named functions with camelCase naming
