# Adopt TypeScript with Jest/Vitest for Unit Testing Framework: Test Files Use
...
1. SHOULD: Test files SHOULD use a Jest-compatible or Vitest-compatible testing framework to ensure broad ecosystem support and familiar syntax for developers.

## Policy Block

- SHOULD Test files SHOULD use a Jest-compatible or Vitest-compatible testing framework to ensure broad ecosystem support and familiar syntax for developers.
