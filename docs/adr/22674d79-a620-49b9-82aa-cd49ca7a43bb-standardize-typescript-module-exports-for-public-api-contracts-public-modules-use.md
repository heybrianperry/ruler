# Standardize TypeScript Module Exports for Public API Contracts: Public Modules Use
...
1. MUST: All public API modules MUST use explicit named exports for interfaces, types, and functions that form the public contract

## Policy Block

- MUST All public API modules MUST use explicit named exports for interfaces, types, and functions that form the public contract
