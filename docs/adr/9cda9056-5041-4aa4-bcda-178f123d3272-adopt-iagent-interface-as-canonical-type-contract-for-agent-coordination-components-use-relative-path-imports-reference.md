...
1. MUST: Components MUST use relative path imports to reference the IAgent interface, maintaining the established module resolution convention.

## Policy Block

- MUST Components MUST use relative path imports to reference the IAgent interface, maintaining the established module resolution convention.
