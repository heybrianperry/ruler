...
1. SHOULD: Test assertions SHOULD verify the found entity is defined before accessing nested properties

## Policy Block

- SHOULD Test assertions SHOULD verify the found entity is defined before accessing nested properties
