...
1. MUST: Developers MUST inspect the authoritative project dependency lock artifact to determine the exact resolved version of Zod before utilizing its schema validation APIs.

## Policy Block

- MUST Developers MUST inspect the authoritative project dependency lock artifact to determine the exact resolved version of Zod before utilizing its schema validation APIs.
