# Adopt Jest with TypeScript for Unit Testing in Developer Tooling: Tests Use Mocking
...
1. MUST: Tests MUST use mocking to isolate the unit under test from external dependencies including file system, network, and other agents

## Policy Block

- MUST Tests MUST use mocking to isolate the unit under test from external dependencies including file system, network, and other agents
