...
1. MUST_NOT: Modules MUST NOT export internal implementation details, private utilities, or temporary data structures as part of the public contract

## Policy Block

- MUST_NOT Modules MUST NOT export internal implementation details, private utilities, or temporary data structures as part of the public contract
