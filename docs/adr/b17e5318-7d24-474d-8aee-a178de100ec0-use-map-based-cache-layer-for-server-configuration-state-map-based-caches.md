...
1. SHOULD: Map-based caches SHOULD be named to reflect their content scope (e.g., existingServerMap, existingSseServers, existingStdioServers).

## Policy Block

- SHOULD Map-based caches SHOULD be named to reflect their content scope (e.g., existingServerMap, existingSseServers, existingStdioServers).
