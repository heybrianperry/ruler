# Adopt Vitest as Standard Unit Testing Framework for TypeScript Agent Development: Test Suites Organize
...
1. SHOULD: Test suites SHOULD organize tests using describe blocks for logical grouping and it/test blocks for individual test cases

## Policy Block

- SHOULD Test suites SHOULD organize tests using describe blocks for logical grouping and it/test blocks for individual test cases
