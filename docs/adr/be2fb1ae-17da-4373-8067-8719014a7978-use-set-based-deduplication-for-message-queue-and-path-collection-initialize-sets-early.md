...
1. SHOULD: Initialize Sets early in collection workflows (e.g., expectedGitignoreEntries, pathSet, targets, seen) before iterating over nested structures

## Policy Block

- SHOULD Initialize Sets early in collection workflows (e.g., expectedGitignoreEntries, pathSet, targets, seen) before iterating over nested structures
