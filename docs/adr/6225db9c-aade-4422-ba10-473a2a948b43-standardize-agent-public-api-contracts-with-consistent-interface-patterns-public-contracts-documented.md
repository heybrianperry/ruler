# Standardize Agent Public API Contracts with Consistent Interface Patterns: Public Contracts Documented
...
1. SHOULD: Public API contracts SHOULD be documented with OpenAPI/Swagger specifications or equivalent interface documentation for external consumers

## Policy Block

- SHOULD Public API contracts SHOULD be documented with OpenAPI/Swagger specifications or equivalent interface documentation for external consumers
