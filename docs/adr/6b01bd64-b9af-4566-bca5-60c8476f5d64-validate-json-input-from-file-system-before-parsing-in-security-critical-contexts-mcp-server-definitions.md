...
1. SHOULD: MCP server definitions SHOULD be validated for required fields (command, args, url, type) after parsing and before merging or applying

## Policy Block

- SHOULD MCP server definitions SHOULD be validated for required fields (command, args, url, type) after parsing and before merging or applying
