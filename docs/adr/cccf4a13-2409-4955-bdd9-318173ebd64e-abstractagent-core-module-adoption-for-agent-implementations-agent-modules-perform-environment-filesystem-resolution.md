...
1. SHOULD: Agent modules SHOULD perform environment and filesystem resolution using standard path utility modules when computing localized configurations or working directories.

## Policy Block

- SHOULD Agent modules SHOULD perform environment and filesystem resolution using standard path utility modules when computing localized configurations or working directories.
