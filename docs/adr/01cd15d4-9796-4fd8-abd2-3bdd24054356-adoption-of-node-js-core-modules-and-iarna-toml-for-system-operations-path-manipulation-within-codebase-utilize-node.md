# Adoption of Node.js Core Modules and @iarna/toml for System Operations: Path Manipulation Within Codebase Utilize Node
...
1. MUST: Path manipulation within the codebase MUST utilize the Node.js `path` module for consistency and cross-platform compatibility.

## Policy Block

- MUST Path manipulation within the codebase MUST utilize the Node.js `path` module for consistency and cross-platform compatibility.
