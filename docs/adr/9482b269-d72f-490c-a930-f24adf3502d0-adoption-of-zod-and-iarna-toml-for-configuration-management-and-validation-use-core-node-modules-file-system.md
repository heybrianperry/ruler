...
1. MUST: MUST use core Node.js modules for file system, path, and operating system interactions.

## Policy Block

- MUST MUST use core Node.js modules for file system, path, and operating system interactions.
