...
1. MUST: Core components requiring configuration access MUST use the ConfigLoader module rather than implementing independent configuration loading logic

## Policy Block

- MUST Core components requiring configuration access MUST use the ConfigLoader module rather than implementing independent configuration loading logic
