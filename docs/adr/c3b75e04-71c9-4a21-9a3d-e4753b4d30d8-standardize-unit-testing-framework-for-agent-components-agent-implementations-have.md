# Standardize Unit Testing Framework for Agent Components: Agent Implementations Have
...
1. MUST: All agent implementations MUST have corresponding unit test files following the naming convention `tests/unit/agents/{AgentName}.test.ts`

## Policy Block

- MUST All agent implementations MUST have corresponding unit test files following the naming convention `tests/unit/agents/{AgentName}.test.ts`
