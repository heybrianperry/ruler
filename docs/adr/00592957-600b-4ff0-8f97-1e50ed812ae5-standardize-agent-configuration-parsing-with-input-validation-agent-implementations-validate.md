...
1. MUST: All agent implementations MUST validate configuration input immediately after parsing TOML or JSON content using parseTOML or JSON.parse

## Policy Block

- MUST All agent implementations MUST validate configuration input immediately after parsing TOML or JSON content using parseTOML or JSON.parse
