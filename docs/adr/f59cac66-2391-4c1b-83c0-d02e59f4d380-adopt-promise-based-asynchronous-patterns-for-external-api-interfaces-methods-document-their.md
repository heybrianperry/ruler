# Adopt Promise-Based Asynchronous Patterns for External API Interfaces: Methods Document Their
...
1. SHOULD: API methods SHOULD document their asynchronous behavior, including expected resolution values and rejection scenarios

## Policy Block

- SHOULD API methods SHOULD document their asynchronous behavior, including expected resolution values and rejection scenarios
