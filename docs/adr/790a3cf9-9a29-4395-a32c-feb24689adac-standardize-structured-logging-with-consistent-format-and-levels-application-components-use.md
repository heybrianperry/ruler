# Standardize Structured Logging with Consistent Format and Levels: Application Components Use
...
1. MUST: All application components MUST use a centralized logging framework or utility rather than direct console.log/console.error calls

## Policy Block

- MUST All application components MUST use a centralized logging framework or utility rather than direct console.log/console.error calls
