# Standardize TypeScript Module Exports for Public Agent APIs: Public Modules Include
...
1. SHOULD: Public API modules SHOULD include TypeScript type definitions for all exported functions, classes, and interfaces

## Policy Block

- SHOULD Public API modules SHOULD include TypeScript type definitions for all exported functions, classes, and interfaces
