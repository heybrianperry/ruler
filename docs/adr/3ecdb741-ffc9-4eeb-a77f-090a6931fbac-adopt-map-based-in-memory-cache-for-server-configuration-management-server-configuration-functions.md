...
1. SHOULD: Server configuration functions SHOULD use consistent naming patterns (existingServerMap, existingSseServers, existingStdioServers) to indicate Map-based cache usage

## Policy Block

- SHOULD Server configuration functions SHOULD use consistent naming patterns (existingServerMap, existingSseServers, existingStdioServers) to indicate Map-based cache usage
