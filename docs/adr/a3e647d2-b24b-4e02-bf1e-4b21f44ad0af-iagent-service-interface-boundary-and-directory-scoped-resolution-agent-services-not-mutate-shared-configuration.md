...
1. MUST_NOT: Agent services MUST NOT mutate shared configuration state across distinct directory boundaries.

## Policy Block

- MUST_NOT Agent services MUST NOT mutate shared configuration state across distinct directory boundaries.
