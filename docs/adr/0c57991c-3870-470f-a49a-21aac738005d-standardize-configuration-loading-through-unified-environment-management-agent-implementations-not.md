# Standardize Configuration Loading Through Unified Environment Management: Agent Implementations Not
...
1. MUST_NOT: Agent implementations MUST NOT directly access process.env or other environment sources; they MUST use the provided configuration object

## Policy Block

- MUST_NOT Agent implementations MUST NOT directly access process.env or other environment sources; they MUST use the provided configuration object
