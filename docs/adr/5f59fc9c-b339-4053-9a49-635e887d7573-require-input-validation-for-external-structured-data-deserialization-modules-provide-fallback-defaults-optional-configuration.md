...
1. MAY: Modules MAY provide fallback defaults for optional configuration fields when validation passes but fields are absent

## Policy Block

- MAY Modules MAY provide fallback defaults for optional configuration fields when validation passes but fields are absent
