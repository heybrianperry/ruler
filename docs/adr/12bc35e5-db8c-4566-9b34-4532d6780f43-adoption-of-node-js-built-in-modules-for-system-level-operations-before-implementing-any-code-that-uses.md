...
1. MUST: Before implementing any code that uses a versioned dependency, the exact resolved version MUST be identified from the project's lock file or resolution artifact.

## Policy Block

- MUST Before implementing any code that uses a versioned dependency, the exact resolved version MUST be identified from the project's lock file or resolution artifact.
