# Standardize Structured Logging with Contextual Metadata: Log Messages Include
...
1. MUST: Log messages MUST include contextual metadata such as module name, operation type, and relevant identifiers to enable correlation and filtering

## Policy Block

- MUST Log messages MUST include contextual metadata such as module name, operation type, and relevant identifiers to enable correlation and filtering
