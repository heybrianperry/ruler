...
1. MUST_NOT: Logging implementations MUST NOT expose sensitive data such as credentials, tokens, or personally identifiable information (PII)

## Policy Block

- MUST_NOT Logging implementations MUST NOT expose sensitive data such as credentials, tokens, or personally identifiable information (PII)
