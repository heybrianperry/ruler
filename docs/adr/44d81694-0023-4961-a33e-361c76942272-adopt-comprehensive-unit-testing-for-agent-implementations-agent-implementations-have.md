# Adopt Comprehensive Unit Testing for Agent Implementations: Agent Implementations Have
...
1. MUST: All agent implementations MUST have corresponding unit test files following the naming convention `{AgentName}.test.ts`

## Policy Block

- MUST All agent implementations MUST have corresponding unit test files following the naming convention `{AgentName}.test.ts`
