...
1. MUST: MCP server configuration keys MUST be deduplicated using Set-based tracking before writing to agent-specific configuration files

## Policy Block

- MUST MCP server configuration keys MUST be deduplicated using Set-based tracking before writing to agent-specific configuration files
