...
1. MAY: Long-running integration tests MAY specify custom timeout values using the third parameter to it blocks

## Policy Block

- MAY Long-running integration tests MAY specify custom timeout values using the third parameter to it blocks
