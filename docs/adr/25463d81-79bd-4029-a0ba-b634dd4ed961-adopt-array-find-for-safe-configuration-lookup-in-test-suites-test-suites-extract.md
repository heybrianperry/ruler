...
1. MAY: Test suites MAY extract Array.find() results into named constants (e.g., existingServer, rootConfig) to improve readability and enable reuse across multiple assertions

## Policy Block

- MAY Test suites MAY extract Array.find() results into named constants (e.g., existingServer, rootConfig) to improve readability and enable reuse across multiple assertions
