...
1. SHOULD: Configuration directory resolution SHOULD occur during application initialization to fail fast if the environment is misconfigured

## Policy Block

- SHOULD Configuration directory resolution SHOULD occur during application initialization to fail fast if the environment is misconfigured
