...
1. MUST: Configuration processing MUST NOT proceed with unparsed or partially parsed JSON content

## Policy Block

- MUST Configuration processing MUST NOT proceed with unparsed or partially parsed JSON content
