...
1. MUST: Configuration discovery logic MUST read the XDG_CONFIG_HOME environment variable from process.env when determining global configuration directory paths

## Policy Block

- MUST Configuration discovery logic MUST read the XDG_CONFIG_HOME environment variable from process.env when determining global configuration directory paths
