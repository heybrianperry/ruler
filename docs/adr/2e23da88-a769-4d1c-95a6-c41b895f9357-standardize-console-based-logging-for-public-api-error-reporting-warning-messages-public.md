...
1. MUST: Warning messages in public APIs MUST use console.warn with consistent prefix formatting (e.g., '${prefix} ${message}')

## Policy Block

- MUST Warning messages in public APIs MUST use console.warn with consistent prefix formatting (e.g., '${prefix} ${message}')
