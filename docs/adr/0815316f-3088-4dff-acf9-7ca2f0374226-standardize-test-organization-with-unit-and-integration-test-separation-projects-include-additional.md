# Standardize Test Organization with Unit and Integration Test Separation: Projects Include Additional
...
1. MAY: Projects MAY include additional test categories (e.g., 'tests/e2e', 'tests/performance') as needed for specific testing requirements

## Policy Block

- MAY Projects MAY include additional test categories (e.g., 'tests/e2e', 'tests/performance') as needed for specific testing requirements
