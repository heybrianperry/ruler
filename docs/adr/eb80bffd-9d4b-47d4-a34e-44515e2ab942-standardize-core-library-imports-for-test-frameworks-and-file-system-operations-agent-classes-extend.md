...
1. SHOULD: Agent classes SHOULD extend base classes (AbstractAgent, AgentsMdAgent) to inherit common functionality rather than reimplementing patterns.

## Policy Block

- SHOULD Agent classes SHOULD extend base classes (AbstractAgent, AgentsMdAgent) to inherit common functionality rather than reimplementing patterns.
