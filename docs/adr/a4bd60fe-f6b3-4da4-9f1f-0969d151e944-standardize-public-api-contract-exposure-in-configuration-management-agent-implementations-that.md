# Standardize Public API Contract Exposure in Configuration Management: Agent Implementations That
...
1. MUST: Agent implementations that consume configuration MUST access configuration data exclusively through the defined public API contracts

## Policy Block

- MUST Agent implementations that consume configuration MUST access configuration data exclusively through the defined public API contracts
