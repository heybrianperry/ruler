...
1. MUST: Test code MUST parse JSON output from agent operations using JSON.parse() to verify configuration correctness, ensuring test assertions operate on validated data structures.

## Policy Block

- MUST Test code MUST parse JSON output from agent operations using JSON.parse() to verify configuration correctness, ensuring test assertions operate on validated data structures.
