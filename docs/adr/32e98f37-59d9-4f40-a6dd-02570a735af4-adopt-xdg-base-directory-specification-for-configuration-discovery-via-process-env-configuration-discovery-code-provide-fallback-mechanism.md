...
1. MUST: Configuration discovery code MUST provide a fallback mechanism when XDG_CONFIG_HOME is undefined or empty

## Policy Block

- MUST Configuration discovery code MUST provide a fallback mechanism when XDG_CONFIG_HOME is undefined or empty
