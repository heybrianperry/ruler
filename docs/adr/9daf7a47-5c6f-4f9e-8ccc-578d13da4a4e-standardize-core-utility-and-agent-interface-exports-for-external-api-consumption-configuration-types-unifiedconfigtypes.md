# Standardize Core Utility and Agent Interface Exports for External API Consumption: Configuration Types Unifiedconfigtypes
...
1. SHOULD: Configuration types (UnifiedConfigTypes) SHOULD be exported as readonly interfaces to prevent external mutation of internal state

## Policy Block

- SHOULD Configuration types (UnifiedConfigTypes) SHOULD be exported as readonly interfaces to prevent external mutation of internal state
