...
1. MUST_NOT: Core infrastructure components MUST NOT bypass the IAgent interface to directly couple with concrete agent implementation classes

## Policy Block

- MUST_NOT Core infrastructure components MUST NOT bypass the IAgent interface to directly couple with concrete agent implementation classes
