...
1. SHOULD: Configuration loaders SHOULD validate required environment variables at startup and fail fast with clear error messages if critical values are missing

## Policy Block

- SHOULD Configuration loaders SHOULD validate required environment variables at startup and fail fast with clear error messages if critical values are missing
