# Standardize Test Organization with Unit and Integration Test Separation: Integration Tests Validate
...
1. MUST: Integration tests MUST validate interactions between multiple components or systems with minimal mocking, focusing on end-to-end behavior

## Policy Block

- MUST Integration tests MUST validate interactions between multiple components or systems with minimal mocking, focusing on end-to-end behavior
