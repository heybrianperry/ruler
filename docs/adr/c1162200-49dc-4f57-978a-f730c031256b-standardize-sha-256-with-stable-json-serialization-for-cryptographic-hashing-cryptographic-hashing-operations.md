...
1. MUST: All cryptographic hashing operations MUST use SHA-256 via the Node.js crypto module's createHash function

## Policy Block

- MUST All cryptographic hashing operations MUST use SHA-256 via the Node.js crypto module's createHash function
