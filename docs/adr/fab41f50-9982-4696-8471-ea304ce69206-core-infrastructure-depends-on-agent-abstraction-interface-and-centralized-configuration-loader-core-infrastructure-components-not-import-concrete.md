...
1. MUST_NOT: Core infrastructure components MUST NOT import concrete agent implementation classes directly; all agent interactions MUST occur through the IAgent interface

## Policy Block

- MUST_NOT Core infrastructure components MUST NOT import concrete agent implementation classes directly; all agent interactions MUST occur through the IAgent interface
