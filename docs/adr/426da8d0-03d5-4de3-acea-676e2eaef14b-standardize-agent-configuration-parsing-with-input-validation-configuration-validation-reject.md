...
1. SHOULD: Configuration validation SHOULD reject unknown or unexpected fields to prevent configuration injection attacks

## Policy Block

- SHOULD Configuration validation SHOULD reject unknown or unexpected fields to prevent configuration injection attacks
