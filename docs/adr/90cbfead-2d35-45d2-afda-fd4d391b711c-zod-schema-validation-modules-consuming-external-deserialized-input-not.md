...
1. MUST_NOT: Modules consuming external deserialized input MUST NOT cast raw parsed structures directly to internal types without prior schema execution and validation.

## Policy Block

- MUST_NOT Modules consuming external deserialized input MUST NOT cast raw parsed structures directly to internal types without prior schema execution and validation.
