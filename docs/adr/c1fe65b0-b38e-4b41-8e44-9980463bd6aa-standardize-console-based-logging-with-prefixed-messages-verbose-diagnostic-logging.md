...
1. SHOULD: Verbose or diagnostic logging SHOULD use a `[ruler:verbose]` prefix to distinguish detailed operational output from standard messages

## Policy Block

- SHOULD Verbose or diagnostic logging SHOULD use a `[ruler:verbose]` prefix to distinguish detailed operational output from standard messages
