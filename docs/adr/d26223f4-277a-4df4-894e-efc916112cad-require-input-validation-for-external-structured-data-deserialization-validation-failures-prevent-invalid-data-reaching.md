...
1. MUST: Validation failures MUST prevent the invalid data from reaching application logic and MUST log the validation error with sufficient context for debugging

## Policy Block

- MUST Validation failures MUST prevent the invalid data from reaching application logic and MUST log the validation error with sufficient context for debugging
