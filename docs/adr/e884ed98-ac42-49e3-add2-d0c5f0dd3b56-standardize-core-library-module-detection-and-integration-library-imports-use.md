# Standardize Core Library Module Detection and Integration: Library Imports Use
...
1. MUST: Library imports MUST use consistent import syntax across the codebase (ES6 imports for TypeScript/modern JS, require for legacy Node.js modules)

## Policy Block

- MUST Library imports MUST use consistent import syntax across the codebase (ES6 imports for TypeScript/modern JS, require for legacy Node.js modules)
