...
1. MUST: After confirming a directory has not been visited, its real path MUST be added to the visited set using the add() method

## Policy Block

- MUST After confirming a directory has not been visited, its real path MUST be added to the visited set using the add() method
