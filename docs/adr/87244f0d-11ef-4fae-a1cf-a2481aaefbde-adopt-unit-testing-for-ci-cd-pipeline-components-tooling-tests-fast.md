# Adopt Unit Testing for CI/CD Pipeline Components: Tooling Tests Fast
...
1. SHOULD: CI/CD tooling tests SHOULD be fast-running and isolated, avoiding external dependencies to enable rapid feedback during development

## Policy Block

- SHOULD CI/CD tooling tests SHOULD be fast-running and isolated, avoiding external dependencies to enable rapid feedback during development
