...
1. MUST: Test assertions MUST explicitly check for undefined results from Array.find() before accessing properties on the returned object

## Policy Block

- MUST Test assertions MUST explicitly check for undefined results from Array.find() before accessing properties on the returned object
