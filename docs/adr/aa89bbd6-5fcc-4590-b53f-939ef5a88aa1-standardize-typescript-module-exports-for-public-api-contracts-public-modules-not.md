# Standardize TypeScript Module Exports for Public API Contracts: Public Modules Not
...
1. MUST_NOT: Public API modules MUST NOT export internal implementation details, private helper functions, or temporary data structures

## Policy Block

- MUST_NOT Public API modules MUST NOT export internal implementation details, private helper functions, or temporary data structures
