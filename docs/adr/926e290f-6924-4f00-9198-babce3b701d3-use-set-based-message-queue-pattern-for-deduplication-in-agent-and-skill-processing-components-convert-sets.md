...
1. MAY: Components MAY convert Sets to arrays when interfacing with APIs that require array parameters, using Array.from() or spread syntax

## Policy Block

- MAY Components MAY convert Sets to arrays when interfacing with APIs that require array parameters, using Array.from() or spread syntax
