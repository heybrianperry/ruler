...
1. MAY: Tests MAY validate that specific fields (such as type) are present or absent according to specification requirements

## Policy Block

- MAY Tests MAY validate that specific fields (such as type) are present or absent according to specification requirements
