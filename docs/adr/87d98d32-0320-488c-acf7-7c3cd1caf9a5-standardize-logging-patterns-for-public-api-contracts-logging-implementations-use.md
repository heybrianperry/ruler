# Standardize Logging Patterns for Public API Contracts: Logging Implementations Use
...
1. SHOULD: Logging implementations SHOULD use structured logging formats (JSON or key-value pairs) rather than unstructured string concatenation

## Policy Block

- SHOULD Logging implementations SHOULD use structured logging formats (JSON or key-value pairs) rather than unstructured string concatenation
