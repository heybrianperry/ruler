# Standardize TypeScript Type Definitions for Public API Contracts: Public Contracts Defined
...
1. MUST: All public API contracts MUST be defined using TypeScript interfaces or type aliases in dedicated type definition files (e.g., src/types.ts, src/core/UnifiedConfigTypes.ts)

## Policy Block

- MUST All public API contracts MUST be defined using TypeScript interfaces or type aliases in dedicated type definition files (e.g., src/types.ts, src/core/UnifiedConfigTypes.ts)
