...
1. MUST: Cryptographic hashing operations MUST use the Node.js crypto module's createHash API

## Policy Block

- MUST Cryptographic hashing operations MUST use the Node.js crypto module's createHash API
