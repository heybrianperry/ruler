# Standardize Public API Contract Definitions for External Integration: Breaking Changes Public
...
1. MUST: Breaking changes to public API contracts MUST follow semantic versioning principles and provide deprecation notices

## Policy Block

- MUST Breaking changes to public API contracts MUST follow semantic versioning principles and provide deprecation notices
