...
1. SHOULD: Test harness utilities SHOULD import 'os' for temporary directory creation using os.tmpdir().

## Policy Block

- SHOULD Test harness utilities SHOULD import 'os' for temporary directory creation using os.tmpdir().
