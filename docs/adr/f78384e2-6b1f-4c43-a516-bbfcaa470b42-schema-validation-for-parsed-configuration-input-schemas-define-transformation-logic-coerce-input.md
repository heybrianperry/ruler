...
1. MAY: Schemas MAY define transformation logic to coerce input types or apply default values for optional fields

## Policy Block

- MAY Schemas MAY define transformation logic to coerce input types or apply default values for optional fields
