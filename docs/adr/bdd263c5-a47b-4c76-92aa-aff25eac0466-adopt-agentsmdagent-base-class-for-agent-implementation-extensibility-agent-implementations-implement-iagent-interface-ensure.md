...
1. SHOULD: Agent implementations SHOULD implement the IAgent interface to ensure they fulfill the agent contract expected by the system.

## Policy Block

- SHOULD Agent implementations SHOULD implement the IAgent interface to ensure they fulfill the agent contract expected by the system.
