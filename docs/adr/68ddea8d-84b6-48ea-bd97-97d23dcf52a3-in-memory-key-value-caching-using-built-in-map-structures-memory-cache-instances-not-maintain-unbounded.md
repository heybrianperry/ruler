...
1. SHOULD_NOT: In-memory cache instances SHOULD_NOT maintain unbounded references across long-lived daemon processes without defining an explicit eviction or lifecycle reset boundary.

## Policy Block

- SHOULD_NOT In-memory cache instances SHOULD_NOT maintain unbounded references across long-lived daemon processes without defining an explicit eviction or lifecycle reset boundary.
