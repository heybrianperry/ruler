# Standardize Agent Architecture with External API Integration Pattern: Agent Implementations Provide
...
1. SHOULD: Agent implementations SHOULD provide clear interfaces that abstract external API details from consuming code

## Policy Block

- SHOULD Agent implementations SHOULD provide clear interfaces that abstract external API details from consuming code
