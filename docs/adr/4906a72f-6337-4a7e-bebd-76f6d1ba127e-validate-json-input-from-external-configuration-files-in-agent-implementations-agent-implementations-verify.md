...
1. MUST: Agent implementations MUST verify file existence and readability before attempting to parse JSON content

## Policy Block

- MUST Agent implementations MUST verify file existence and readability before attempting to parse JSON content
