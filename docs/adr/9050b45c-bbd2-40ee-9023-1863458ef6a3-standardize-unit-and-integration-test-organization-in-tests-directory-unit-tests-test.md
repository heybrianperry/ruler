# Standardize Unit and Integration Test Organization in tests/ Directory: Unit Tests Test
...
1. MUST: Unit tests MUST test isolated component behavior without external dependencies

## Policy Block

- MUST Unit tests MUST test isolated component behavior without external dependencies
