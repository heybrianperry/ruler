# Standardize Core Utility and Agent Interface Exports for External API Consumption: Public Modules Not
...
1. MUST_NOT: Public API modules MUST NOT expose internal implementation details, private helper functions, or framework-specific dependencies in their exported interfaces

## Policy Block

- MUST_NOT Public API modules MUST NOT expose internal implementation details, private helper functions, or framework-specific dependencies in their exported interfaces
