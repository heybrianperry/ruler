# Adopt Vitest as Standard Unit Testing Framework for TypeScript Agent Development: Unit Tests Typescript
...
1. MUST: All unit tests for TypeScript agent implementations MUST use Vitest as the testing framework

## Policy Block

- MUST All unit tests for TypeScript agent implementations MUST use Vitest as the testing framework
