# Adopt Async/Await Concurrency Model for External API Integration: External Calls Bound
...
1. MUST: All external API calls and I/O-bound operations MUST use async/await syntax rather than raw Promises or callbacks

## Policy Block

- MUST All external API calls and I/O-bound operations MUST use async/await syntax rather than raw Promises or callbacks
