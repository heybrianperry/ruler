...
1. SHOULD: Agent implementations SHOULD implement or extend common base interfaces (e.g., IAgent) to ensure consistent contract shapes across agent types

## Policy Block

- SHOULD Agent implementations SHOULD implement or extend common base interfaces (e.g., IAgent) to ensure consistent contract shapes across agent types
