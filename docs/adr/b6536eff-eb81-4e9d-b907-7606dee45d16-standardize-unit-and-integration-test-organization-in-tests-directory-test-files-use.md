# Standardize Unit and Integration Test Organization in tests/ Directory: Test Files Use
...
1. MUST: Test files MUST use the naming convention *.test.ts (or appropriate extension for the language)

## Policy Block

- MUST Test files MUST use the naming convention *.test.ts (or appropriate extension for the language)
