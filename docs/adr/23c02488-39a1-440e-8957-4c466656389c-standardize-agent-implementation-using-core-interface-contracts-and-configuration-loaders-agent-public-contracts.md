...
1. MUST: Agent public API contracts MUST be exported as named exports to establish clear integration boundaries

## Policy Block

- MUST Agent public API contracts MUST be exported as named exports to establish clear integration boundaries
