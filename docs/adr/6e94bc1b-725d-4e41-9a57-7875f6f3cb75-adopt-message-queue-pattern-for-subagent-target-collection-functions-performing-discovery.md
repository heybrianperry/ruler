...
1. SHOULD: Functions performing discovery (loadSubagentFile, discoverSubagents, listMarkdownFilesRecursive) SHOULD separate collection logic from validation and transformation logic

## Policy Block

- SHOULD Functions performing discovery (loadSubagentFile, discoverSubagents, listMarkdownFilesRecursive) SHOULD separate collection logic from validation and transformation logic
