# Adopt Async/Await Pattern for External API Integration: Implementations Use Async
...
1. MAY: Implementations MAY use async iterators (for await...of) for streaming or paginated API responses

## Policy Block

- MAY Implementations MAY use async iterators (for await...of) for streaming or paginated API responses
