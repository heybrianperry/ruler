# Standardize Environment Variable Access for Configuration Management: Components Document Their
...
1. SHOULD: Components SHOULD document their required and optional environment variables in README or configuration documentation

## Policy Block

- SHOULD Components SHOULD document their required and optional environment variables in README or configuration documentation
