...
1. MUST: Core infrastructure components requiring configuration access MUST use the ConfigLoader utility module

## Policy Block

- MUST Core infrastructure components requiring configuration access MUST use the ConfigLoader utility module
