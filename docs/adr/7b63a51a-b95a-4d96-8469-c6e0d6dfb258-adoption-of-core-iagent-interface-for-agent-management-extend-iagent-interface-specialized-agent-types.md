...
1. MAY: MAY extend the IAgent interface for specialized agent types, adhering to the established contract.

## Policy Block

- MAY MAY extend the IAgent interface for specialized agent types, adhering to the established contract.
