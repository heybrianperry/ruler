...
1. MUST: Error-level messages MUST use console.error for output to ensure proper stream routing

## Policy Block

- MUST Error-level messages MUST use console.error for output to ensure proper stream routing
