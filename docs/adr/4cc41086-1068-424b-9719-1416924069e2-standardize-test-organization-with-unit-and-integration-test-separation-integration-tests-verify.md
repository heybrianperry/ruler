# Standardize Test Organization with Unit and Integration Test Separation: Integration Tests Verify
...
1. MUST: Integration tests MUST verify interactions between multiple components or systems without excessive mocking

## Policy Block

- MUST Integration tests MUST verify interactions between multiple components or systems without excessive mocking
