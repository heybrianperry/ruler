...
1. MUST: TOML parsing MUST occur before validation logic to separate parsing concerns from schema validation

## Policy Block

- MUST TOML parsing MUST occur before validation logic to separate parsing concerns from schema validation
