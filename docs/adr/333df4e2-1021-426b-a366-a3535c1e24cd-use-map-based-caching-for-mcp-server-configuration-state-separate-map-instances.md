...
1. SHOULD: Separate Map instances SHOULD be maintained for each transport type (SSE, SHTTP, stdio) to isolate configuration domains

## Policy Block

- SHOULD Separate Map instances SHOULD be maintained for each transport type (SSE, SHTTP, stdio) to isolate configuration domains
