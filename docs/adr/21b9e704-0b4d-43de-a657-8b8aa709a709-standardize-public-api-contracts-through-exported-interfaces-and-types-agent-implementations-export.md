...
1. MUST: Agent implementations MUST export their class definition as the primary public contract (e.g., GeminiCliAgent, JulesAgent, KiroAgent).

## Policy Block

- MUST Agent implementations MUST export their class definition as the primary public contract (e.g., GeminiCliAgent, JulesAgent, KiroAgent).
