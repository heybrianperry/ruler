# Adoption of Node.js Core Modules and @iarna/toml for System Operations: Core Modules Requiring File System Interactions
...
1. MUST: Core modules requiring file system interactions MUST use the capabilities provided by the Node.js `fs` module, potentially abstracted through local utility modules.

## Policy Block

- MUST Core modules requiring file system interactions MUST use the capabilities provided by the Node.js `fs` module, potentially abstracted through local utility modules.
