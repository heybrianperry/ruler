...
1. SHOULD: TOML parsing SHOULD occur immediately after file content is read and before any business logic consumes the configuration data

## Policy Block

- SHOULD TOML parsing SHOULD occur immediately after file content is read and before any business logic consumes the configuration data
