# Standardize Public API Export Patterns for Agent Integration: Public Exports Use
...
1. MUST: Public API exports MUST use explicit named exports rather than default exports to improve IDE support and refactoring safety

## Policy Block

- MUST Public API exports MUST use explicit named exports rather than default exports to improve IDE support and refactoring safety
