...
1. SHOULD: Security-sensitive configuration paths SHOULD validate that resolved directories are not symbolic links when appropriate

## Policy Block

- SHOULD Security-sensitive configuration paths SHOULD validate that resolved directories are not symbolic links when appropriate
