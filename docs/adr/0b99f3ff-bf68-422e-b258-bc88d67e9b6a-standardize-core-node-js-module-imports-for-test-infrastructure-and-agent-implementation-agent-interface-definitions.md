...
1. MUST: Agent interface definitions (IAgent, IAgentConfig) MUST be imported from './IAgent' or '../types' to maintain contract consistency.

## Policy Block

- MUST Agent interface definitions (IAgent, IAgentConfig) MUST be imported from './IAgent' or '../types' to maintain contract consistency.
