...
1. MUST: MUST use the IAgent interface for defining any agent-related contract or functionality.

## Policy Block

- MUST MUST use the IAgent interface for defining any agent-related contract or functionality.
