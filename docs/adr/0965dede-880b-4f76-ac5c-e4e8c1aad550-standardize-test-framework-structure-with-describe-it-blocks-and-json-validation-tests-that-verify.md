...
1. SHOULD: Tests that verify file operations SHOULD use the test harness utilities (setupTestProject, teardownTestProject, runRuler) for consistent environment management

## Policy Block

- SHOULD Tests that verify file operations SHOULD use the test harness utilities (setupTestProject, teardownTestProject, runRuler) for consistent environment management
