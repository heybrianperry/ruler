...
1. MUST_NOT: Configuration loading code MUST NOT use eval() or other dynamic code execution methods to parse JSON data

## Policy Block

- MUST_NOT Configuration loading code MUST NOT use eval() or other dynamic code execution methods to parse JSON data
