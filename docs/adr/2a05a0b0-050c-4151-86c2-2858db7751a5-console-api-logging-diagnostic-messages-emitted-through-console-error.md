...
1. MUST: Diagnostic messages emitted through console error and warning methods MUST include structured context and sanitized error descriptions to prevent secret leakage.

## Policy Block

- MUST Diagnostic messages emitted through console error and warning methods MUST include structured context and sanitized error descriptions to prevent secret leakage.
