# Standardize Unit and Integration Test Organization in tests/ Directory: Integration Tests Test
...
1. MUST: Integration tests MUST test cross-component interactions and system-level behavior

## Policy Block

- MUST Integration tests MUST test cross-component interactions and system-level behavior
