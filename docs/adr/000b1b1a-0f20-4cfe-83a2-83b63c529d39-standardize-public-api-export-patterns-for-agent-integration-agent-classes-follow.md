# Standardize Public API Export Patterns for Agent Integration: Agent Classes Follow
...
1. SHOULD: Agent classes SHOULD follow a consistent naming convention ending with 'Agent' suffix

## Policy Block

- SHOULD Agent classes SHOULD follow a consistent naming convention ending with 'Agent' suffix
