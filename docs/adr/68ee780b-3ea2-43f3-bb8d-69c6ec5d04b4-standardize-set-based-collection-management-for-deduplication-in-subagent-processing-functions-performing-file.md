...
1. MUST: Functions performing file system discovery or configuration parsing (using path, fs/promises, js-yaml, @iarna/toml) MUST deduplicate results before returning collections to callers

## Policy Block

- MUST Functions performing file system discovery or configuration parsing (using path, fs/promises, js-yaml, @iarna/toml) MUST deduplicate results before returning collections to callers
