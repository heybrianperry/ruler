...
1. MUST_NOT: Configuration loading MUST NOT use synchronous filesystem operations (fs.readFileSync) in agent initialization paths

## Policy Block

- MUST_NOT Configuration loading MUST NOT use synchronous filesystem operations (fs.readFileSync) in agent initialization paths
