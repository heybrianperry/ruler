...
1. SHOULD: Configuration application SHOULD support both JSON and TOML formats using @iarna/toml for TOML parsing where applicable

## Policy Block

- SHOULD Configuration application SHOULD support both JSON and TOML formats using @iarna/toml for TOML parsing where applicable
