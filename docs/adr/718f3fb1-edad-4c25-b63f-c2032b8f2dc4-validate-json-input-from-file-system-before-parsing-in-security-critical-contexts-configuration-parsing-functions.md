...
1. SHOULD: Configuration parsing functions SHOULD return typed objects or throw descriptive errors rather than returning raw parsed data

## Policy Block

- SHOULD Configuration parsing functions SHOULD return typed objects or throw descriptive errors rather than returning raw parsed data
