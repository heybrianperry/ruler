...
1. SHOULD: Agent registry index exports and utility helper functions SHOULD accept and operate on IAgent contract types rather than concrete agent implementation classes.

## Policy Block

- SHOULD Agent registry index exports and utility helper functions SHOULD accept and operate on IAgent contract types rather than concrete agent implementation classes.
