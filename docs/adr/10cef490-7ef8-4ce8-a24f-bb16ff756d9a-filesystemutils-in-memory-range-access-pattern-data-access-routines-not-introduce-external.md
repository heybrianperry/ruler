...
1. MUST_NOT: Data access routines MUST_NOT introduce external indexing abstractions or caching layers for ephemeral, single-invocation utility range lookups.

## Policy Block

- MUST_NOT Data access routines MUST_NOT introduce external indexing abstractions or caching layers for ephemeral, single-invocation utility range lookups.
