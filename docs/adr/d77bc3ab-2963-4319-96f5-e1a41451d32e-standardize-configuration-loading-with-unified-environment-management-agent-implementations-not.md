# Standardize Configuration Loading with Unified Environment Management: Agent Implementations Not
...
1. MUST: Agent implementations MUST NOT directly access process.env or raw configuration files; they MUST use the configuration abstraction layer

## Policy Block

- MUST Agent implementations MUST NOT directly access process.env or raw configuration files; they MUST use the configuration abstraction layer
