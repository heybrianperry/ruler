# Standardize Test File Naming and Organization for CI/CD Integration: Test Files Use
...
1. MAY: Test files MAY use descriptive kebab-case names for multi-word components (e.g., mcp-backup-prevention.test.ts)

## Policy Block

- MAY Test files MAY use descriptive kebab-case names for multi-word components (e.g., mcp-backup-prevention.test.ts)
