...
1. SHOULD: Core infrastructure components SHOULD import agent-related utilities from the shared agent-utils module rather than implementing utility functions locally

## Policy Block

- SHOULD Core infrastructure components SHOULD import agent-related utilities from the shared agent-utils module rather than implementing utility functions locally
