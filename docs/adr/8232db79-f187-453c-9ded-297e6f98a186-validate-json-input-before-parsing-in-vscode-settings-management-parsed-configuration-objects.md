...
1. MUST: Parsed configuration objects MUST be validated against expected schemas (VSCodeSettings, AugmentMcpServer) before being stored in cache layers or used in application logic

## Policy Block

- MUST Parsed configuration objects MUST be validated against expected schemas (VSCodeSettings, AugmentMcpServer) before being stored in cache layers or used in application logic
