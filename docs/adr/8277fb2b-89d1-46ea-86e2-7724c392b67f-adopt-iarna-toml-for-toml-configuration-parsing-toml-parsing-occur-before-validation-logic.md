...
1. MUST: TOML parsing MUST occur before validation logic is applied to configuration objects

## Policy Block

- MUST TOML parsing MUST occur before validation logic is applied to configuration objects
