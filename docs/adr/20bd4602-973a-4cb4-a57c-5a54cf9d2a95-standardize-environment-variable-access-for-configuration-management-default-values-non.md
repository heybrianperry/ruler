# Standardize Environment Variable Access for Configuration Management: Default Values Non
...
1. SHOULD: Default values for non-critical configuration SHOULD be provided within the configuration loader to enable zero-configuration development environments

## Policy Block

- SHOULD Default values for non-critical configuration SHOULD be provided within the configuration loader to enable zero-configuration development environments
