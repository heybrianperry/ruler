# Adopt TypeScript Test Files with .test.ts Extension as Standard Testing Convention: End Tests Placed
...
1. SHOULD: End-to-end tests SHOULD be placed in tests/e2e/ directory and test complete user workflows

## Policy Block

- SHOULD End-to-end tests SHOULD be placed in tests/e2e/ directory and test complete user workflows
