...
1. MUST_NOT: Modules MUST NOT create circular dependencies; the relative path structure MUST enforce a directed acyclic graph of module dependencies

## Policy Block

- MUST_NOT Modules MUST NOT create circular dependencies; the relative path structure MUST enforce a directed acyclic graph of module dependencies
