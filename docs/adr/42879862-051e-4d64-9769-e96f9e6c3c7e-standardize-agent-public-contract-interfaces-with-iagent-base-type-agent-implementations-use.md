...
1. SHOULD: Agent implementations SHOULD use applyRulerConfig for consistent configuration application patterns where applicable

## Policy Block

- SHOULD Agent implementations SHOULD use applyRulerConfig for consistent configuration application patterns where applicable
