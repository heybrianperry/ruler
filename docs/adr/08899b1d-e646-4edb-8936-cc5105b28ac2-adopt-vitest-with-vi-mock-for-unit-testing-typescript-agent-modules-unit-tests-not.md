# Adopt Vitest with vi.mock() for Unit Testing TypeScript Agent Modules: Unit Tests Not
...
1. MUST_NOT: Unit tests MUST NOT depend on external services, file systems, or network resources without proper mocking

## Policy Block

- MUST_NOT Unit tests MUST NOT depend on external services, file systems, or network resources without proper mocking
