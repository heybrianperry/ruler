...
1. MUST: Cache population MUST occur immediately after parsing configuration files and before applying any modifications to ensure existing state is preserved

## Policy Block

- MUST Cache population MUST occur immediately after parsing configuration files and before applying any modifications to ensure existing state is preserved
