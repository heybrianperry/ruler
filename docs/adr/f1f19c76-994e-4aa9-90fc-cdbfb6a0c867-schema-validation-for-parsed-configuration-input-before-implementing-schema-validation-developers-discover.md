...
1. MUST: Before implementing schema validation, developers MUST discover the project's dependency lock file, resolve the exact installed version of the schema validation library, and consult that version's official documentation to verify API compatibility

## Policy Block

- MUST Before implementing schema validation, developers MUST discover the project's dependency lock file, resolve the exact installed version of the schema validation library, and consult that version's official documentation to verify API compatibility
