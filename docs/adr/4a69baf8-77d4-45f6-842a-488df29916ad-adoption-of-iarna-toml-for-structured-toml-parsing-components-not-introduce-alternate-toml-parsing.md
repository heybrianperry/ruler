...
1. MUST_NOT: Components MUST NOT introduce alternate TOML parsing libraries or implement ad-hoc custom TOML parsers.

## Policy Block

- MUST_NOT Components MUST NOT introduce alternate TOML parsing libraries or implement ad-hoc custom TOML parsers.
