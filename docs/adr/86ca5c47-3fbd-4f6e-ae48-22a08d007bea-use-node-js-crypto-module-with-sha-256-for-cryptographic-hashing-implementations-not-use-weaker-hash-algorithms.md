...
1. MUST_NOT: Implementations MUST NOT use weaker hash algorithms (MD5, SHA-1) for security-sensitive operations

## Policy Block

- MUST_NOT Implementations MUST NOT use weaker hash algorithms (MD5, SHA-1) for security-sensitive operations
