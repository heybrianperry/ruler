# Standardize Core Library Module Detection and Integration: Core Libraries Modules
...
1. MUST: All core libraries and modules MUST be explicitly declared in package.json or equivalent dependency manifest with pinned or semantically versioned constraints

## Policy Block

- MUST All core libraries and modules MUST be explicitly declared in package.json or equivalent dependency manifest with pinned or semantically versioned constraints
