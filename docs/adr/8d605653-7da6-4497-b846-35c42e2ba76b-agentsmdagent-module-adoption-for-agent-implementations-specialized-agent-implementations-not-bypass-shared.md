...
1. SHOULD_NOT: Specialized agent implementations SHOULD NOT bypass the shared validation and parsing routines provided by the core agent abstractions.

## Policy Block

- SHOULD_NOT Specialized agent implementations SHOULD NOT bypass the shared validation and parsing routines provided by the core agent abstractions.
