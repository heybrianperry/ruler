# Adopt Async/Await Concurrency Model for External API Interactions: Functions That Interact
...
1. MUST: All functions that interact with external APIs MUST be declared as async and return Promises

## Policy Block

- MUST All functions that interact with external APIs MUST be declared as async and return Promises
