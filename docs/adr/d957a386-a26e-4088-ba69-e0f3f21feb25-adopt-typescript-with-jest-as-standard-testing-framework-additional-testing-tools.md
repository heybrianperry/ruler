# Adopt TypeScript with Jest as Standard Testing Framework: Additional Testing Tools
...
1. MAY: Additional testing tools MAY be integrated with Jest for specialized testing needs (e.g., coverage tools, snapshot testing)

## Policy Block

- MAY Additional testing tools MAY be integrated with Jest for specialized testing needs (e.g., coverage tools, snapshot testing)
