...
1. MAY: Configuration loaders MAY support multiple sources (environment variables, config files, command-line arguments) with a defined precedence order

## Policy Block

- MAY Configuration loaders MAY support multiple sources (environment variables, config files, command-line arguments) with a defined precedence order
