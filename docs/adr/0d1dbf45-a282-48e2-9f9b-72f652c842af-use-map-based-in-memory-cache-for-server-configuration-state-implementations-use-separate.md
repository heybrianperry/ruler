...
1. MAY: Implementations MAY use separate Map instances for different server transport types (stdio, SSE, SHTTP)

## Policy Block

- MAY Implementations MAY use separate Map instances for different server transport types (stdio, SSE, SHTTP)
