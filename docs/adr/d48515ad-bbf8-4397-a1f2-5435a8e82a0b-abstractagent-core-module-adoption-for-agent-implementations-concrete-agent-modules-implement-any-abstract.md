...
1. MUST: Concrete agent modules MUST implement any abstract lifecycle and execution contracts declared by AbstractAgent rather than establishing divergent execution protocols.

## Policy Block

- MUST Concrete agent modules MUST implement any abstract lifecycle and execution contracts declared by AbstractAgent rather than establishing divergent execution protocols.
