...
1. SHOULD: Read operations (readVSCodeSettings) SHOULD access the Map cache rather than re-parsing filesystem data

## Policy Block

- SHOULD Read operations (readVSCodeSettings) SHOULD access the Map cache rather than re-parsing filesystem data
