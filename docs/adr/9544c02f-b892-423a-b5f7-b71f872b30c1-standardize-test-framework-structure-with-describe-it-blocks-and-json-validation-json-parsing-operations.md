...
1. MUST: All JSON parsing operations MUST use JSON.parse with explicit error handling to prevent unhandled exceptions from malformed input

## Policy Block

- MUST All JSON parsing operations MUST use JSON.parse with explicit error handling to prevent unhandled exceptions from malformed input
