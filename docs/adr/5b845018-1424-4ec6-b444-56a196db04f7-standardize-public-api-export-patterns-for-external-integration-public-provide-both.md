# Standardize Public API Export Patterns for External Integration: Public Provide Both
...
1. MAY: Public APIs MAY provide both synchronous and asynchronous variants of methods to accommodate different integration patterns

## Policy Block

- MAY Public APIs MAY provide both synchronous and asynchronous variants of methods to accommodate different integration patterns
