...
1. MUST: Dependencies from core infrastructure to agent abstractions MUST use relative imports that traverse upward to the agents module boundary

## Policy Block

- MUST Dependencies from core infrastructure to agent abstractions MUST use relative imports that traverse upward to the agents module boundary
