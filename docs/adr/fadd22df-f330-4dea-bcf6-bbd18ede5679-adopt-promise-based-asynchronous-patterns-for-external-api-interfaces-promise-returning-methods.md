# Adopt Promise-Based Asynchronous Patterns for External API Interfaces: Promise Returning Methods
...
1. MUST: All Promise-returning methods MUST properly propagate errors through Promise rejection or try-catch blocks in async functions

## Policy Block

- MUST All Promise-returning methods MUST properly propagate errors through Promise rejection or try-catch blocks in async functions
