...
1. MUST: Subagent loading workflows MUST use loadSubagentFile as the designated concurrency coordination point for file system access and parsing operations

## Policy Block

- MUST Subagent loading workflows MUST use loadSubagentFile as the designated concurrency coordination point for file system access and parsing operations
