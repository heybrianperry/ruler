...
1. MUST: Engineers MUST discover the project dependency manifest and resolved lock artifact to verify the exact resolved version of all supporting runtime dependencies before introducing or altering agent module dependencies.

## Policy Block

- MUST Engineers MUST discover the project dependency manifest and resolved lock artifact to verify the exact resolved version of all supporting runtime dependencies before introducing or altering agent module dependencies.
