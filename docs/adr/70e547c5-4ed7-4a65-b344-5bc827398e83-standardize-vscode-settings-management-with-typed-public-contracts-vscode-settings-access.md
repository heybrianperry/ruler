...
1. MUST: All VSCode settings access MUST use the exported public contracts (readVSCodeSettings, writeVSCodeSettings) rather than direct filesystem operations

## Policy Block

- MUST All VSCode settings access MUST use the exported public contracts (readVSCodeSettings, writeVSCodeSettings) rather than direct filesystem operations
