...
1. SHOULD: JSON parsing operations SHOULD be isolated in dedicated functions (e.g., readGeminiSettings) that encapsulate validation logic and provide typed return values.

## Policy Block

- SHOULD JSON parsing operations SHOULD be isolated in dedicated functions (e.g., readGeminiSettings) that encapsulate validation logic and provide typed return values.
