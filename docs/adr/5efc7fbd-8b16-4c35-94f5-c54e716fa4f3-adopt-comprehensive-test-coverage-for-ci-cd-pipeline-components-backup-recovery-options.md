# Adopt Comprehensive Test Coverage for CI/CD Pipeline Components: Backup Recovery Options
...
1. SHOULD: Backup and recovery options SHOULD be tested to ensure data safety during CI/CD operations

## Policy Block

- SHOULD Backup and recovery options SHOULD be tested to ensure data safety during CI/CD operations
