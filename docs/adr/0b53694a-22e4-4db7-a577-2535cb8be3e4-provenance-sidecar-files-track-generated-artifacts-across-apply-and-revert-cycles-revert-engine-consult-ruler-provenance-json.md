...
1. MUST: The revert engine MUST consult the .ruler-provenance.json sidecar, via isRulerGeneratedFile(), to determine artifact ownership before performing any cleanup or deletion, and MUST NOT rely solely on .ruler-managed.json for this determination.

## Policy Block

- MUST The revert engine MUST consult the .ruler-provenance.json sidecar, via isRulerGeneratedFile(), to determine artifact ownership before performing any cleanup or deletion, and MUST NOT rely solely on .ruler-managed.json for this determination.
