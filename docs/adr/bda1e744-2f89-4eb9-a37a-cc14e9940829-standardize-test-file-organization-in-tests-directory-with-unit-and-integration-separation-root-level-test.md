# Standardize Test File Organization in tests/ Directory with Unit and Integration Separation: Root Level Test
...
1. MAY: Root-level test files in tests/ directory MAY be used for cross-cutting concerns or special test scenarios that don't fit unit/integration categories

## Policy Block

- MAY Root-level test files in tests/ directory MAY be used for cross-cutting concerns or special test scenarios that don't fit unit/integration categories
