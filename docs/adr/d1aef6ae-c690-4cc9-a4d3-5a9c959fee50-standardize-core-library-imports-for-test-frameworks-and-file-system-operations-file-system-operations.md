...
1. MUST: All file system operations MUST use the fs/promises API (import fs from 'fs/promises') rather than callback-based or synchronous fs methods.

## Policy Block

- MUST All file system operations MUST use the fs/promises API (import fs from 'fs/promises') rather than callback-based or synchronous fs methods.
