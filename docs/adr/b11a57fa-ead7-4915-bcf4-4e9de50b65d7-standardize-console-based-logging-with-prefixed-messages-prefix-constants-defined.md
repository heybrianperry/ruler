...
1. SHOULD: Prefix constants SHOULD be defined in a central location (constants.ts) and exported for reuse across modules

## Policy Block

- SHOULD Prefix constants SHOULD be defined in a central location (constants.ts) and exported for reuse across modules
