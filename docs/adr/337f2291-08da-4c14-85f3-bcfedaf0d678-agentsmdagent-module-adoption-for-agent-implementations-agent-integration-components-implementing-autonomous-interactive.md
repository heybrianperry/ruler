...
1. MUST: Agent integration components implementing autonomous or interactive agent capabilities MUST conform to the IAgent contract when exposing public agent operational interfaces.

## Policy Block

- MUST Agent integration components implementing autonomous or interactive agent capabilities MUST conform to the IAgent contract when exposing public agent operational interfaces.
