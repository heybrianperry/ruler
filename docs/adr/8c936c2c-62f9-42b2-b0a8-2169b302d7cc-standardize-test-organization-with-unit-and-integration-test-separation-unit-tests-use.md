# Standardize Test Organization with Unit and Integration Test Separation: Unit Tests Use
...
1. MUST: Unit tests MUST use mocking to isolate the component under test from external dependencies including file systems, databases, network calls, and other modules

## Policy Block

- MUST Unit tests MUST use mocking to isolate the component under test from external dependencies including file systems, databases, network calls, and other modules
