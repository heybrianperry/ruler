# Standardize Test File Organization in tests/ Directory with Unit and Integration Separation: Agent Specific Tests
...
1. SHOULD: Agent-specific tests SHOULD be grouped under tests/unit/agents/ directory

## Policy Block

- SHOULD Agent-specific tests SHOULD be grouped under tests/unit/agents/ directory
