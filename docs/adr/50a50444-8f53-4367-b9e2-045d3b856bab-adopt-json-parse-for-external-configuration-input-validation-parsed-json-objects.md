...
1. MUST: Parsed JSON objects MUST be validated against expected schemas (using zod or type guards) before accessing nested properties

## Policy Block

- MUST Parsed JSON objects MUST be validated against expected schemas (using zod or type guards) before accessing nested properties
