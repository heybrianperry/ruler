...
1. SHOULD: Schema definitions SHOULD declare fallback structures and deprecation handling using optional schema fields to preserve backward compatibility during format transitions.

## Policy Block

- SHOULD Schema definitions SHOULD declare fallback structures and deprecation handling using optional schema fields to preserve backward compatibility during format transitions.
