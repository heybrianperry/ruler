...
1. SHOULD: After successful parsing, the system SHOULD validate the presence of expected top-level properties (e.g., mcpServers, servers) before accessing nested data

## Policy Block

- SHOULD After successful parsing, the system SHOULD validate the presence of expected top-level properties (e.g., mcpServers, servers) before accessing nested data
