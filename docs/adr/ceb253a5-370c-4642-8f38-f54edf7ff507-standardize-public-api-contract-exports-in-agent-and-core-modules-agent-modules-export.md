...
1. MUST: All agent modules MUST export a named class or interface representing their primary public contract (e.g., OpenCodeAgent, ZedAgent)

## Policy Block

- MUST All agent modules MUST export a named class or interface representing their primary public contract (e.g., OpenCodeAgent, ZedAgent)
