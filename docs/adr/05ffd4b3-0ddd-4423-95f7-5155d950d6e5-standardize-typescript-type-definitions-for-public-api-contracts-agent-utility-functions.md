# Standardize TypeScript Type Definitions for Public API Contracts: Agent Utility Functions
...
1. SHOULD: Agent utility functions that operate on public API types SHOULD use generic type parameters to maintain type safety across different agent implementations

## Policy Block

- SHOULD Agent utility functions that operate on public API types SHOULD use generic type parameters to maintain type safety across different agent implementations
