# Standardize Unit Testing for Agent Implementations: Test Files Use
...
1. MAY: Test files MAY use mocking frameworks to isolate units under test from external dependencies

## Policy Block

- MAY Test files MAY use mocking frameworks to isolate units under test from external dependencies
