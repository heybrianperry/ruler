...
1. SHOULD: Inline arrow function predicates SHOULD be used for simple single-condition lookups to maintain test readability

## Policy Block

- SHOULD Inline arrow function predicates SHOULD be used for simple single-condition lookups to maintain test readability
