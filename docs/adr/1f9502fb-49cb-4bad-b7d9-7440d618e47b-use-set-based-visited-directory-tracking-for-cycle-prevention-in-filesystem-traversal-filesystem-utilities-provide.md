...
1. SHOULD: Filesystem utilities SHOULD provide assertion functions like assertNotSymbolicLink and assertContainingDirectoryInsideRoot to validate path safety

## Policy Block

- SHOULD Filesystem utilities SHOULD provide assertion functions like assertNotSymbolicLink and assertContainingDirectoryInsideRoot to validate path safety
