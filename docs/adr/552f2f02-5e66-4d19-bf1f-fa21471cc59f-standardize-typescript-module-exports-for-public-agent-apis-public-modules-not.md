# Standardize TypeScript Module Exports for Public Agent APIs: Public Modules Not
...
1. MUST_NOT: Public API modules MUST NOT export internal implementation details, private helpers, or temporary utilities

## Policy Block

- MUST_NOT Public API modules MUST NOT export internal implementation details, private helpers, or temporary utilities
