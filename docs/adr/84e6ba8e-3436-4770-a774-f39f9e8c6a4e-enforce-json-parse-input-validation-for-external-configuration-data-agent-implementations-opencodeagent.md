...
1. MUST: Agent implementations (OpenCodeAgent, ZedAgent, GeminiCliAgent) MUST validate the structure of parsed JSON objects before accessing nested properties or applying configuration transformations.

## Policy Block

- MUST Agent implementations (OpenCodeAgent, ZedAgent, GeminiCliAgent) MUST validate the structure of parsed JSON objects before accessing nested properties or applying configuration transformations.
