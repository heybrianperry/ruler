...
1. SHOULD: Modules combining security operations (symbolic link checks, root containment) with environment access SHOULD separate credential retrieval from filesystem operations through abstraction layers

## Policy Block

- SHOULD Modules combining security operations (symbolic link checks, root containment) with environment access SHOULD separate credential retrieval from filesystem operations through abstraction layers
