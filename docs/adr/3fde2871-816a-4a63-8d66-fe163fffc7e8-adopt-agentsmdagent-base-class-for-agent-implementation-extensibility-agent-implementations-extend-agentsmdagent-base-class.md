...
1. MUST: All agent implementations MUST extend the AgentsMdAgent base class to inherit shared agent functionality and maintain architectural consistency.

## Policy Block

- MUST All agent implementations MUST extend the AgentsMdAgent base class to inherit shared agent functionality and maintain architectural consistency.
