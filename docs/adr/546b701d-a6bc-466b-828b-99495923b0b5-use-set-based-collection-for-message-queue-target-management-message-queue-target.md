...
1. MUST: All message queue target collections MUST use Set data structures to ensure uniqueness of targets and aliases

## Policy Block

- MUST All message queue target collections MUST use Set data structures to ensure uniqueness of targets and aliases
