...
1. MUST: Public API contracts (discoverSubagents, getSelectedSubagentTargets, getSubagentsGitignorePaths, propagateSubagentsForClaude, parseFrontmatter, validateFrontmatter, loadSubagentFile) MUST be exported and maintained for external consumers

## Policy Block

- MUST Public API contracts (discoverSubagents, getSelectedSubagentTargets, getSubagentsGitignorePaths, propagateSubagentsForClaude, parseFrontmatter, validateFrontmatter, loadSubagentFile) MUST be exported and maintained for external consumers
