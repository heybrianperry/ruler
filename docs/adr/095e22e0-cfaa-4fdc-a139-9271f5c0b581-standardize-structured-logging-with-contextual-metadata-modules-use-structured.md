# Standardize Structured Logging with Contextual Metadata: Modules Use Structured
...
1. MUST: All modules MUST use structured logging with consistent format and metadata fields rather than unstructured console output

## Policy Block

- MUST All modules MUST use structured logging with consistent format and metadata fields rather than unstructured console output
