...
1. MAY: Agent implementations MAY introduce additional coordination points for domain-specific initialization requirements beyond applyRulerConfig

## Policy Block

- MAY Agent implementations MAY introduce additional coordination points for domain-specific initialization requirements beyond applyRulerConfig
