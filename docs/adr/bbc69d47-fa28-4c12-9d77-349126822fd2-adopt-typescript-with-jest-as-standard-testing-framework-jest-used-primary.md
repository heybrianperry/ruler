# Adopt TypeScript with Jest as Standard Testing Framework: Jest Used Primary
...
1. MUST: Jest MUST be used as the primary testing framework for unit and integration tests

## Policy Block

- MUST Jest MUST be used as the primary testing framework for unit and integration tests
