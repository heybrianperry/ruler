...
1. MAY: Consumers of the ConfigLoader module MAY pass module-specific override parameters when initializing or querying configuration if permitted by the module interface.

## Policy Block

- MAY Consumers of the ConfigLoader module MAY pass module-specific override parameters when initializing or querying configuration if permitted by the module interface.
