...
1. MUST_NOT: Components MUST NOT introduce third-party filesystem libraries for basic file I/O operations that can be accomplished with Node.js core modules.

## Policy Block

- MUST_NOT Components MUST NOT introduce third-party filesystem libraries for basic file I/O operations that can be accomplished with Node.js core modules.
