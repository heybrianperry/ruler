# Adopt Structured Test Organization with Layered Test Suites: Pipelines Execute Test
...
1. SHOULD: CI/CD pipelines SHOULD execute test layers sequentially (unit → integration → e2e) with fast-fail behavior

## Policy Block

- SHOULD CI/CD pipelines SHOULD execute test layers sequentially (unit → integration → e2e) with fast-fail behavior
