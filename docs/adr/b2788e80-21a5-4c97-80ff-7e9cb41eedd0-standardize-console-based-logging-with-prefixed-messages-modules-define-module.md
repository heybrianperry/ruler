...
1. MAY: Modules MAY define module-specific prefixes to distinguish log sources within the application

## Policy Block

- MAY Modules MAY define module-specific prefixes to distinguish log sources within the application
