...
1. MUST: When external versioned dependencies are introduced for data access or storage, consumers MUST inspect the repository lock artifact and verify the exact resolved version against authorized API specifications prior to adoption.

## Policy Block

- MUST When external versioned dependencies are introduced for data access or storage, consumers MUST inspect the repository lock artifact and verify the exact resolved version against authorized API specifications prior to adoption.
