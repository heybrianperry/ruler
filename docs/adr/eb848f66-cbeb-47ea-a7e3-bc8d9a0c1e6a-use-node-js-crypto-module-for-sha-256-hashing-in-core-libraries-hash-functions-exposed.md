...
1. MUST: Hash functions exposed as public API contracts MUST include both sha256 and stableJson utilities

## Policy Block

- MUST Hash functions exposed as public API contracts MUST include both sha256 and stableJson utilities
