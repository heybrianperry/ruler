# Standardize Environment-Aware Configuration Loading with Unified Path Resolution: Agent Implementations Use
...
1. MUST: All agent implementations MUST use a centralized configuration loader (UnifiedConfigLoader or ConfigLoader) rather than implementing custom configuration loading logic

## Policy Block

- MUST All agent implementations MUST use a centralized configuration loader (UnifiedConfigLoader or ConfigLoader) rather than implementing custom configuration loading logic
