# Adopt Jest with TypeScript for Unit Testing in Developer Tooling: Test Files Located
...
1. MUST: Test files MUST be located in the tests/unit directory structure mirroring the source code organization

## Policy Block

- MUST Test files MUST be located in the tests/unit directory structure mirroring the source code organization
