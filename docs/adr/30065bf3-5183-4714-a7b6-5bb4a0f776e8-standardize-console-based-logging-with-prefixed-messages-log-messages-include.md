...
1. MUST: Log messages MUST include a prefix identifier (e.g., '[ruler]', '[ruler:verbose]', ERROR_PREFIX) to indicate the source and context of the message

## Policy Block

- MUST Log messages MUST include a prefix identifier (e.g., '[ruler]', '[ruler:verbose]', ERROR_PREFIX) to indicate the source and context of the message
