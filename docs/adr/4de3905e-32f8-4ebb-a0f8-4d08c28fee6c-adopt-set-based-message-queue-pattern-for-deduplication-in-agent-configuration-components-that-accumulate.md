...
1. MUST: All components that accumulate file paths, gitignore entries, or resource identifiers during agent configuration processing MUST use Set data structures for deduplication.

## Policy Block

- MUST All components that accumulate file paths, gitignore entries, or resource identifiers during agent configuration processing MUST use Set data structures for deduplication.
