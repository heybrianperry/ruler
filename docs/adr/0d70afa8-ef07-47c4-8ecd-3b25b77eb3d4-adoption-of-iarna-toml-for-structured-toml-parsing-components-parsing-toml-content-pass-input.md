...
1. MUST: Components parsing TOML content MUST pass input strings directly to the parseTOML function and handle parsing exceptions at the ingestion boundary.

## Policy Block

- MUST Components parsing TOML content MUST pass input strings directly to the parseTOML function and handle parsing exceptions at the ingestion boundary.
