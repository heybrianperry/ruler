# Standardize Logging Infrastructure with Structured Output: Components Not Bypass
...
1. MUST_NOT: Components MUST NOT bypass the centralized logging infrastructure for operational logging (debugging output during development is acceptable)

## Policy Block

- MUST_NOT Components MUST NOT bypass the centralized logging infrastructure for operational logging (debugging output during development is acceptable)
