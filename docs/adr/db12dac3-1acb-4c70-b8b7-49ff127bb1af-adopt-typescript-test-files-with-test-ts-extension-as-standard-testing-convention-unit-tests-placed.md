# Adopt TypeScript Test Files with .test.ts Extension as Standard Testing Convention: Unit Tests Placed
...
1. SHOULD: Unit tests SHOULD be placed in tests/unit/ directory and mirror the source code structure

## Policy Block

- SHOULD Unit tests SHOULD be placed in tests/unit/ directory and mirror the source code structure
