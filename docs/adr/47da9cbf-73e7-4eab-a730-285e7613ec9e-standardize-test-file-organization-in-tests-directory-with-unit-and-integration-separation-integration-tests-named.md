# Standardize Test File Organization in tests/ Directory with Unit and Integration Separation: Integration Tests Named
...
1. SHOULD: Integration tests SHOULD be named descriptively to indicate the integration scenario being tested (e.g., skills-mcp-agent-integration.test.ts, hierarchical-rules.test.ts)

## Policy Block

- SHOULD Integration tests SHOULD be named descriptively to indicate the integration scenario being tested (e.g., skills-mcp-agent-integration.test.ts, hierarchical-rules.test.ts)
