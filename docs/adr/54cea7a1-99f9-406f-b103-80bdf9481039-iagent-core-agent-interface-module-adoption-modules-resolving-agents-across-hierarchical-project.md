...
1. MUST: Modules resolving agents across hierarchical project structures MUST key and retrieve resolved IAgent instances by their respective configuration root directories.

## Policy Block

- MUST Modules resolving agents across hierarchical project structures MUST key and retrieve resolved IAgent instances by their respective configuration root directories.
