...
1. MAY: Implementations MAY use Map.has() for existence checks before conditional insertion to support merge semantics

## Policy Block

- MAY Implementations MAY use Map.has() for existence checks before conditional insertion to support merge semantics
