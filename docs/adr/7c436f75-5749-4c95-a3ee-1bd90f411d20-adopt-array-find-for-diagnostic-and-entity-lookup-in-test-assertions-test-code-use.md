...
1. MUST: Test code MUST use Array.find() when locating a single diagnostic or entity object from a collection for assertion purposes

## Policy Block

- MUST Test code MUST use Array.find() when locating a single diagnostic or entity object from a collection for assertion purposes
