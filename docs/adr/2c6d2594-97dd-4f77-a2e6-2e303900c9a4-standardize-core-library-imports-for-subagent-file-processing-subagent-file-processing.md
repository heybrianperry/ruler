...
1. MUST: All subagent file processing modules MUST use 'fs/promises' for asynchronous file system operations rather than synchronous fs methods

## Policy Block

- MUST All subagent file processing modules MUST use 'fs/promises' for asynchronous file system operations rather than synchronous fs methods
