# Standardize Test Organization with Unit and Integration Test Separation: Projects Define Additional
...
1. MAY: Projects MAY define additional test categories (e.g., tests/e2e/, tests/performance/) following the same organizational principles

## Policy Block

- MAY Projects MAY define additional test categories (e.g., tests/e2e/, tests/performance/) following the same organizational principles
