...
1. MUST: Agent implementations MUST export their class as the primary public contract (e.g., OpenCodeAgent, MistralVibeAgent, CodexCliAgent)

## Policy Block

- MUST Agent implementations MUST export their class as the primary public contract (e.g., OpenCodeAgent, MistralVibeAgent, CodexCliAgent)
