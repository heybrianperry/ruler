...
1. MAY: The configuration subsystem MAY support custom override flags or localized configuration scopes that bypass global configuration discovery when explicitly requested.

## Policy Block

- MAY The configuration subsystem MAY support custom override flags or localized configuration scopes that bypass global configuration discovery when explicitly requested.
