# Adopt Async/Await Pattern for External API Integration: Agent Implementations Use
...
1. SHOULD: Agent implementations SHOULD use async/await consistently throughout their lifecycle methods

## Policy Block

- SHOULD Agent implementations SHOULD use async/await consistently throughout their lifecycle methods
