...
1. SHOULD: Error creation functions (createRulerError) SHOULD be provided as part of the public API contract to standardize error handling

## Policy Block

- SHOULD Error creation functions (createRulerError) SHOULD be provided as part of the public API contract to standardize error handling
