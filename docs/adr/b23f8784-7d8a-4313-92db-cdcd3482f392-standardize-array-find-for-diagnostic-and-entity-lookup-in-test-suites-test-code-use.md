...
1. MUST: Test code MUST use Array.find() when locating a single entity by property match within a collection

## Policy Block

- MUST Test code MUST use Array.find() when locating a single entity by property match within a collection
