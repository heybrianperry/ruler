# Standardize Jest as Testing Framework for TypeScript Unit Tests: Teams Use Jest
...
1. MAY: Teams MAY use Jest's snapshot testing capabilities for UI components or complex data structure validation

## Policy Block

- MAY Teams MAY use Jest's snapshot testing capabilities for UI components or complex data structure validation
