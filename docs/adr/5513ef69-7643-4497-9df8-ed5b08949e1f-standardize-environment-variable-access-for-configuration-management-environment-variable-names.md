# Standardize Environment Variable Access for Configuration Management: Environment Variable Names
...
1. SHOULD: Environment variable names SHOULD follow a consistent naming convention with appropriate prefixes (e.g., API_KEY, SERVICE_ENDPOINT, FEATURE_FLAG_)

## Policy Block

- SHOULD Environment variable names SHOULD follow a consistent naming convention with appropriate prefixes (e.g., API_KEY, SERVICE_ENDPOINT, FEATURE_FLAG_)
