...
1. SHOULD: Complex schemas SHOULD be composed from smaller, reusable schema fragments to maintain consistency across validation boundaries

## Policy Block

- SHOULD Complex schemas SHOULD be composed from smaller, reusable schema fragments to maintain consistency across validation boundaries
