...
1. MUST: YAML parsing MUST be performed using the 'js-yaml' library for consistency across all subagent configuration files

## Policy Block

- MUST YAML parsing MUST be performed using the 'js-yaml' library for consistency across all subagent configuration files
