...
1. MUST: Agent implementations that perform file I/O MUST import either 'fs' or 'fs/promises' from Node.js core

## Policy Block

- MUST Agent implementations that perform file I/O MUST import either 'fs' or 'fs/promises' from Node.js core
