...
1. MAY: Implementation MAY use separate Map instances for different server types (existingStdioServers, existingSseServers, existingShttpServers) to enforce type safety and key uniqueness constraints

## Policy Block

- MAY Implementation MAY use separate Map instances for different server types (existingStdioServers, existingSseServers, existingShttpServers) to enforce type safety and key uniqueness constraints
