...
1. MUST_NOT: Specialized agent implementations MUST NOT bypass AbstractAgent by implementing standalone agent structures disconnected from the shared base contract.

## Policy Block

- MUST_NOT Specialized agent implementations MUST NOT bypass AbstractAgent by implementing standalone agent structures disconnected from the shared base contract.
