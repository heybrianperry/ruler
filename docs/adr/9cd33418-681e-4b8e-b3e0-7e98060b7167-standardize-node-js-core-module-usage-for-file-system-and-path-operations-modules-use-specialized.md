...
1. MAY: Modules MAY use specialized parsing libraries (@iarna/toml, zod) for non-JSON formats or validation, but file I/O MUST still use core modules.

## Policy Block

- MAY Modules MAY use specialized parsing libraries (@iarna/toml, zod) for non-JSON formats or validation, but file I/O MUST still use core modules.
