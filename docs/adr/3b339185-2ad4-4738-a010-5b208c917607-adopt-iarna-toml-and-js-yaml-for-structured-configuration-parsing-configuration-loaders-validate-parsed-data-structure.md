...
1. SHOULD: Configuration loaders SHOULD validate parsed data structure against expected schema after successful parsing

## Policy Block

- SHOULD Configuration loaders SHOULD validate parsed data structure against expected schema after successful parsing
