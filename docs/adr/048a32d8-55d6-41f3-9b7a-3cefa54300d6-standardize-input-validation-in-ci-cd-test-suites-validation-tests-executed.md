...
1. SHOULD: Validation tests SHOULD be executed early in the CI/CD pipeline to provide fast feedback on input handling issues

## Policy Block

- SHOULD Validation tests SHOULD be executed early in the CI/CD pipeline to provide fast feedback on input handling issues
