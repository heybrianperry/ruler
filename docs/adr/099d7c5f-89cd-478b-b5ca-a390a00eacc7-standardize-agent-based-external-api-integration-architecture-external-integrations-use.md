# Standardize Agent-Based External API Integration Architecture: External Integrations Use
...
1. MUST: External API integrations MUST use the unified configuration system (UnifiedConfigTypes) for managing API credentials, endpoints, and service-specific settings

## Policy Block

- MUST External API integrations MUST use the unified configuration system (UnifiedConfigTypes) for managing API credentials, endpoints, and service-specific settings
