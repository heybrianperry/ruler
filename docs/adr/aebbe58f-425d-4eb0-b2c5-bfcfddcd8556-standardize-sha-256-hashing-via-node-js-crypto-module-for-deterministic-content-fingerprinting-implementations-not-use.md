...
1. MUST_NOT: Implementations MUST NOT use alternative hash algorithms (MD5, SHA-1) for content fingerprinting due to known collision vulnerabilities

## Policy Block

- MUST_NOT Implementations MUST NOT use alternative hash algorithms (MD5, SHA-1) for content fingerprinting due to known collision vulnerabilities
