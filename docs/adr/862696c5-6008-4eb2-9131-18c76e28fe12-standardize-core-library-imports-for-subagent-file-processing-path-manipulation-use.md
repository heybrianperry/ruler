...
1. MUST: Path manipulation MUST use the 'path' module to ensure cross-platform compatibility

## Policy Block

- MUST Path manipulation MUST use the 'path' module to ensure cross-platform compatibility
