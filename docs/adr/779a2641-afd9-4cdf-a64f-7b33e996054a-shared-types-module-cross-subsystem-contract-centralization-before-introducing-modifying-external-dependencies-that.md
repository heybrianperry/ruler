...
1. MUST: Before introducing or modifying external dependencies that feed shared type definitions, the consumer MUST inspect the repository lock artifact to determine the exact resolved dependency version and verify API compatibility.

## Policy Block

- MUST Before introducing or modifying external dependencies that feed shared type definitions, the consumer MUST inspect the repository lock artifact to determine the exact resolved dependency version and verify API compatibility.
