# Standardize Test Organization with Unit and Integration Test Separation: Test Files Organized
...
1. MUST: Test files MUST be organized into separate 'tests/unit' and 'tests/integration' directories based on their scope and dependency requirements

## Policy Block

- MUST Test files MUST be organized into separate 'tests/unit' and 'tests/integration' directories based on their scope and dependency requirements
