...
1. SHOULD: The registry SHOULD be maintained in the library coordination layer to centralize agent resolution logic

## Policy Block

- SHOULD The registry SHOULD be maintained in the library coordination layer to centralize agent resolution logic
