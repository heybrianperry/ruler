...
1. MUST: Modules requiring file system access MUST utilize the Node.js `fs` module.

## Policy Block

- MUST Modules requiring file system access MUST utilize the Node.js `fs` module.
