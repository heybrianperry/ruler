# Standardize on Vitest for Unit Testing Agent Modules: Test Files Use
...
1. MUST: Test files MUST use TypeScript (.ts extension) to maintain type safety in test code

## Policy Block

- MUST Test files MUST use TypeScript (.ts extension) to maintain type safety in test code
