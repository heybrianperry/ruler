...
1. MAY: Internal subsystems MAY define module-local helper types within their own boundaries provided those types do not cross subsystem interfaces.

## Policy Block

- MAY Internal subsystems MAY define module-local helper types within their own boundaries provided those types do not cross subsystem interfaces.
