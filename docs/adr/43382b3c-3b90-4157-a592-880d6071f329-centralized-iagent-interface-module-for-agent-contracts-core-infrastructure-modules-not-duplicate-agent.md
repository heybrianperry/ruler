...
1. MUST_NOT: Core infrastructure modules MUST NOT duplicate agent interface definitions locally or depend directly on concrete agent implementation classes.

## Policy Block

- MUST_NOT Core infrastructure modules MUST NOT duplicate agent interface definitions locally or depend directly on concrete agent implementation classes.
