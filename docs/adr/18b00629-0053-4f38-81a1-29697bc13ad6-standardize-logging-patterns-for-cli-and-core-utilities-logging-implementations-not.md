# Standardize Logging Patterns for CLI and Core Utilities: Logging Implementations Not
...
1. MUST_NOT: Logging implementations MUST NOT expose sensitive information such as credentials, tokens, or personally identifiable information in log output

## Policy Block

- MUST_NOT Logging implementations MUST NOT expose sensitive information such as credentials, tokens, or personally identifiable information in log output
