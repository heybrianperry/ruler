...
1. MUST: All file system I/O operations in agent configuration and skill processing MUST use async/await with fs.promises or equivalent promise-based APIs

## Policy Block

- MUST All file system I/O operations in agent configuration and skill processing MUST use async/await with fs.promises or equivalent promise-based APIs
