...
1. SHOULD: Configuration validation SHOULD occur before any configuration data is used in business logic or passed to downstream components

## Policy Block

- SHOULD Configuration validation SHOULD occur before any configuration data is used in business logic or passed to downstream components
