...
1. MUST: The application MUST utilize the crypto module createHash function specifying sha256 for standard cryptographic digest computations.

## Policy Block

- MUST The application MUST utilize the crypto module createHash function specifying sha256 for standard cryptographic digest computations.
