# Standardize Environment Variable Access for Configuration Management: Agent Implementations Retrieve
...
1. MUST: Agent implementations MUST retrieve all runtime configuration through the configuration loader abstraction layer

## Policy Block

- MUST Agent implementations MUST retrieve all runtime configuration through the configuration loader abstraction layer
