...
1. SHOULD: Configuration resolution logic SHOULD be testable without requiring actual environment variables to be set

## Policy Block

- SHOULD Configuration resolution logic SHOULD be testable without requiring actual environment variables to be set
