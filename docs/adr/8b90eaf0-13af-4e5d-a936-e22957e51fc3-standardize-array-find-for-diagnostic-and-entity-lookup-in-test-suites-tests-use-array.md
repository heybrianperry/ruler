...
1. MAY: Tests MAY use Array.some() when only existence verification is needed without entity access

## Policy Block

- MAY Tests MAY use Array.some() when only existence verification is needed without entity access
