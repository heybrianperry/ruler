# Adopt Structured Test Organization with Layered Test Suites: Test Directory Structure
...
1. SHOULD: Test directory structure SHOULD mirror the source code structure within each test layer

## Policy Block

- SHOULD Test directory structure SHOULD mirror the source code structure within each test layer
