...
1. MUST_NOT: Agent implementations MUST NOT bypass AbstractAgent by implementing IAgent directly unless explicitly documented as an exception.

## Policy Block

- MUST_NOT Agent implementations MUST NOT bypass AbstractAgent by implementing IAgent directly unless explicitly documented as an exception.
