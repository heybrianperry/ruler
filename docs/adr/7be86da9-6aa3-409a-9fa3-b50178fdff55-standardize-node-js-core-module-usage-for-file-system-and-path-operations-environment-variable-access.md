...
1. MUST: Environment variable access for configuration paths (e.g., XDG_CONFIG_HOME) MUST use 'process.env' from Node.js runtime.

## Policy Block

- MUST Environment variable access for configuration paths (e.g., XDG_CONFIG_HOME) MUST use 'process.env' from Node.js runtime.
