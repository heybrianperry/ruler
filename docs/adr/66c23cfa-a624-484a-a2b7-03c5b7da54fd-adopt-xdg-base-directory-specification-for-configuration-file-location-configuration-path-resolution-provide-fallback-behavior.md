...
1. MUST: Configuration path resolution MUST provide fallback behavior when XDG_CONFIG_HOME is not set, following XDG Base Directory specification defaults

## Policy Block

- MUST Configuration path resolution MUST provide fallback behavior when XDG_CONFIG_HOME is not set, following XDG Base Directory specification defaults
