...
1. MUST: When referencing versioned external dependencies supporting module resolution, consumers MUST inspect the repository lock artifact to determine the exact resolved dependency version prior to implementation.

## Policy Block

- MUST When referencing versioned external dependencies supporting module resolution, consumers MUST inspect the repository lock artifact to determine the exact resolved dependency version prior to implementation.
