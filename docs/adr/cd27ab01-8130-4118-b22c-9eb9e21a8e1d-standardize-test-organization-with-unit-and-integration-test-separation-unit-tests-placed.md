# Standardize Test Organization with Unit and Integration Test Separation: Unit Tests Placed
...
1. MUST: All unit tests MUST be placed in the tests/unit/ directory hierarchy, mirroring the source code structure they test

## Policy Block

- MUST All unit tests MUST be placed in the tests/unit/ directory hierarchy, mirroring the source code structure they test
