...
1. MUST_NOT: Components MUST NOT pass unparsed or unvalidated string content directly to configuration application functions

## Policy Block

- MUST_NOT Components MUST NOT pass unparsed or unvalidated string content directly to configuration application functions
