...
1. MUST: Core infrastructure components MUST use the centralized ConfigLoader module for all configuration access rather than implementing independent configuration loading logic

## Policy Block

- MUST Core infrastructure components MUST use the centralized ConfigLoader module for all configuration access rather than implementing independent configuration loading logic
