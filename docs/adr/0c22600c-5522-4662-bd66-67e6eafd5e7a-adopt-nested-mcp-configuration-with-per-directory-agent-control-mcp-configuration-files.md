...
1. MUST: MCP configuration files MUST be valid JSON with either mcpServers or servers top-level keys containing server definitions

## Policy Block

- MUST MCP configuration files MUST be valid JSON with either mcpServers or servers top-level keys containing server definitions
