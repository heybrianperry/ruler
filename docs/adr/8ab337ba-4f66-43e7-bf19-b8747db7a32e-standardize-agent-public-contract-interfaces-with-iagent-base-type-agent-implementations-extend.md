...
1. MAY: Agent implementations MAY extend AgentsMdAgent or AbstractAgent based on their specific requirements

## Policy Block

- MAY Agent implementations MAY extend AgentsMdAgent or AbstractAgent based on their specific requirements
