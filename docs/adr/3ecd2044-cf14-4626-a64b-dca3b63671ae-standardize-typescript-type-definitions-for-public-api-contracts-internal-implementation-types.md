# Standardize TypeScript Type Definitions for Public API Contracts: Internal Implementation Types
...
1. MAY: Internal implementation types that are not part of the public API MAY be defined locally within agent implementation files

## Policy Block

- MAY Internal implementation types that are not part of the public API MAY be defined locally within agent implementation files
