...
1. MUST: JSON content parsed from filesystem MUST be validated through JSON.parse with appropriate error handling

## Policy Block

- MUST JSON content parsed from filesystem MUST be validated through JSON.parse with appropriate error handling
