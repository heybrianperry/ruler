# Standardize Jest as Testing Framework for TypeScript Unit Tests: Pipelines Execute Jest
...
1. MUST: CI/CD pipelines MUST execute Jest tests as a required quality gate before deployment or merge

## Policy Block

- MUST CI/CD pipelines MUST execute Jest tests as a required quality gate before deployment or merge
