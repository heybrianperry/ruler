...
1. MUST: Configuration file discovery MUST consult the XDG_CONFIG_HOME environment variable as the primary source for determining the user configuration directory location

## Policy Block

- MUST Configuration file discovery MUST consult the XDG_CONFIG_HOME environment variable as the primary source for determining the user configuration directory location
