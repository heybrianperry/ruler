...
1. MUST: All collection management operations that aggregate targets, aliases, or identifiers from multiple sources MUST use Set data structures to enforce uniqueness

## Policy Block

- MUST All collection management operations that aggregate targets, aliases, or identifiers from multiple sources MUST use Set data structures to enforce uniqueness
