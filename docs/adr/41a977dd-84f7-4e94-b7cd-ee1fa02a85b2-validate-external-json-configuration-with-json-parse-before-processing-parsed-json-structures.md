...
1. SHOULD: Parsed JSON structures SHOULD be type-checked or validated against expected schemas before extracting nested properties

## Policy Block

- SHOULD Parsed JSON structures SHOULD be type-checked or validated against expected schemas before extracting nested properties
