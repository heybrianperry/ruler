# Adopt Unified Configuration Loading with Input Validation: Configuration Schemas Defined
...
1. SHOULD: Configuration schemas SHOULD be defined declaratively and versioned to support backward compatibility

## Policy Block

- SHOULD Configuration schemas SHOULD be defined declaratively and versioned to support backward compatibility
