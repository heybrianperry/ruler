...
1. MAY: Parsed TOML objects MAY be validated using schema validation libraries before being consumed by application logic

## Policy Block

- MAY Parsed TOML objects MAY be validated using schema validation libraries before being consumed by application logic
