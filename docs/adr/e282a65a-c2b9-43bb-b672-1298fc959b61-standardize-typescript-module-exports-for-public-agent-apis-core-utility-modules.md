# Standardize TypeScript Module Exports for Public Agent APIs: Core Utility Modules
...
1. MUST: Core utility modules (hash, GitignoreUtils, merge) MUST maintain stable export signatures across versions to prevent breaking changes

## Policy Block

- MUST Core utility modules (hash, GitignoreUtils, merge) MUST maintain stable export signatures across versions to prevent breaking changes
