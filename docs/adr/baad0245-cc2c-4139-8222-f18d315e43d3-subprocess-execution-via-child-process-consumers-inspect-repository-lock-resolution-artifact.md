...
1. MUST: Consumers MUST inspect the repository lock or resolution artifact to determine the exact platform runtime and dependency versions before invoking version-dependent process execution behavior.

## Policy Block

- MUST Consumers MUST inspect the repository lock or resolution artifact to determine the exact platform runtime and dependency versions before invoking version-dependent process execution behavior.
