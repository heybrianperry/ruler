...
1. MUST_NOT: Alternative TOML parsing libraries MUST NOT be introduced without explicit architectural review and migration plan

## Policy Block

- MUST_NOT Alternative TOML parsing libraries MUST NOT be introduced without explicit architectural review and migration plan
