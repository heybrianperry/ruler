# Standardize Test File Organization in tests/ Directory with Unit and Integration Separation: Test Files Use
...
1. MUST: Test files MUST use the naming convention *.test.ts or *.test.js to be discoverable by test runners

## Policy Block

- MUST Test files MUST use the naming convention *.test.ts or *.test.js to be discoverable by test runners
