# Standardize Test File Naming and Organization for CI/CD Integration: Pipelines Configured Discover
...
1. MUST: CI/CD pipelines MUST be configured to discover and execute all files matching the **/*.test.ts glob pattern

## Policy Block

- MUST CI/CD pipelines MUST be configured to discover and execute all files matching the **/*.test.ts glob pattern
