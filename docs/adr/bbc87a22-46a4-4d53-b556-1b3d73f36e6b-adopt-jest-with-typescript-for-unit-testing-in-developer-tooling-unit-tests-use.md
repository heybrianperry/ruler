# Adopt Jest with TypeScript for Unit Testing in Developer Tooling: Unit Tests Use
...
1. MUST: Unit tests MUST use Jest as the testing framework with TypeScript support enabled

## Policy Block

- MUST Unit tests MUST use Jest as the testing framework with TypeScript support enabled
