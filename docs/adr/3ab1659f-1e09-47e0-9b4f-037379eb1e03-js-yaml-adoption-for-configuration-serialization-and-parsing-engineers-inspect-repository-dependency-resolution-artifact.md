...
1. MUST: Engineers MUST inspect the repository dependency resolution artifact to determine the exact locked version of the library and confirm compatibility before invoking parsing APIs.

## Policy Block

- MUST Engineers MUST inspect the repository dependency resolution artifact to determine the exact locked version of the library and confirm compatibility before invoking parsing APIs.
