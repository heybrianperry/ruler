# Adopt Async/Await Concurrency Model for External API Interactions: Client Wrappers Expose
...
1. SHOULD: API client wrappers SHOULD expose async interfaces even when wrapping synchronous operations to maintain consistency

## Policy Block

- SHOULD API client wrappers SHOULD expose async interfaces even when wrapping synchronous operations to maintain consistency
