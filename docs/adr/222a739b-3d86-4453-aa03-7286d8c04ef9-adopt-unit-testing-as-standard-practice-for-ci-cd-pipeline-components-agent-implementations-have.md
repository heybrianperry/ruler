# Adopt Unit Testing as Standard Practice for CI/CD Pipeline Components: Agent Implementations Have
...
1. MUST: Agent implementations MUST have unit tests covering their core behaviors, error handling, and interaction patterns

## Policy Block

- MUST Agent implementations MUST have unit tests covering their core behaviors, error handling, and interaction patterns
