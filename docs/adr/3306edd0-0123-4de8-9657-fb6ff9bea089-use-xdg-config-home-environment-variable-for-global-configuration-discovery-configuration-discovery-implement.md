...
1. MUST: Configuration discovery MUST implement error handling for cases where the global config directory is inaccessible or does not exist

## Policy Block

- MUST Configuration discovery MUST implement error handling for cases where the global config directory is inaccessible or does not exist
