# Adopt Vitest as Standard Unit Testing Framework for TypeScript Agent Development: Test Files Use
...
1. MUST: Test files MUST use the .test.ts extension to be recognized by the test runner

## Policy Block

- MUST Test files MUST use the .test.ts extension to be recognized by the test runner
