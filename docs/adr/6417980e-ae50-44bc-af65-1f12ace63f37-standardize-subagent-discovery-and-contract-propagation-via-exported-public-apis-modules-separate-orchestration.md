...
1. MUST: Modules MUST separate orchestration concerns (SubagentsProcessor) from parsing concerns (SubagentsUtils) to enable independent testing and evolution

## Policy Block

- MUST Modules MUST separate orchestration concerns (SubagentsProcessor) from parsing concerns (SubagentsUtils) to enable independent testing and evolution
