...
1. MUST: Configuration files MUST be parsed and validated (via JSON.parse or parseTOML) before populating cache structures

## Policy Block

- MUST Configuration files MUST be parsed and validated (via JSON.parse or parseTOML) before populating cache structures
