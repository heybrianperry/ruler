...
1. MUST: Utility modules that operate on agents (agent-utils, capabilities, config-utils) MUST depend on the IAgent interface contract rather than concrete agent implementations

## Policy Block

- MUST Utility modules that operate on agents (agent-utils, capabilities, config-utils) MUST depend on the IAgent interface contract rather than concrete agent implementations
