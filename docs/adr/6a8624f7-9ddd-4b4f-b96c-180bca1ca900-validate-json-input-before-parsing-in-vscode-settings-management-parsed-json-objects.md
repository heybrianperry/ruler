...
1. MUST: Parsed JSON objects MUST be validated against expected schema (VSCodeSettings, AugmentMcpServer types) before use

## Policy Block

- MUST Parsed JSON objects MUST be validated against expected schema (VSCodeSettings, AugmentMcpServer types) before use
