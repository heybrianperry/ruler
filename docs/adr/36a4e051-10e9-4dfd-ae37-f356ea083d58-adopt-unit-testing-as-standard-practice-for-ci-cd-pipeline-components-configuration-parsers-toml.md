# Adopt Unit Testing as Standard Practice for CI/CD Pipeline Components: Configuration Parsers Toml
...
1. MUST: Configuration parsers (TOML, JSON, MCP) MUST include tests for edge cases, invalid input handling, and warning/error scenarios

## Policy Block

- MUST Configuration parsers (TOML, JSON, MCP) MUST include tests for edge cases, invalid input handling, and warning/error scenarios
