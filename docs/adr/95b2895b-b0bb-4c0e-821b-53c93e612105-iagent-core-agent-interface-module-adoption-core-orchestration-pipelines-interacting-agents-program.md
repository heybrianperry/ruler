...
1. MUST: All core orchestration pipelines interacting with agents MUST program against the shared IAgent interface contract rather than concrete agent implementations.

## Policy Block

- MUST All core orchestration pipelines interacting with agents MUST program against the shared IAgent interface contract rather than concrete agent implementations.
