...
1. SHOULD: Map-based caches SHOULD be scoped to individual function invocations rather than persisted as module-level state, ensuring transactional isolation

## Policy Block

- SHOULD Map-based caches SHOULD be scoped to individual function invocations rather than persisted as module-level state, ensuring transactional isolation
