...
1. SHOULD: Parsing errors from @iarna/toml SHOULD be caught and wrapped with context about which configuration file failed to parse

## Policy Block

- SHOULD Parsing errors from @iarna/toml SHOULD be caught and wrapped with context about which configuration file failed to parse
