...
1. MAY: Implementations MAY support additional XDG Base Directory variables (XDG_DATA_HOME, XDG_CACHE_HOME) for other resource types beyond configuration

## Policy Block

- MAY Implementations MAY support additional XDG Base Directory variables (XDG_DATA_HOME, XDG_CACHE_HOME) for other resource types beyond configuration
