...
1. MUST_NOT: Cache entries MUST NOT be persisted without validation against the defined contracts (VSCodeSettings, AugmentMcpServer)

## Policy Block

- MUST_NOT Cache entries MUST NOT be persisted without validation against the defined contracts (VSCodeSettings, AugmentMcpServer)
