...
1. SHOULD: Complex data structures SHOULD be serialized using stable JSON serialization before hashing

## Policy Block

- SHOULD Complex data structures SHOULD be serialized using stable JSON serialization before hashing
