# Standardize Structured Logging with Contextual Metadata: Sensitive Information Credentials
...
1. MUST_NOT: Sensitive information (credentials, tokens, PII) MUST NOT be included in log output

## Policy Block

- MUST_NOT Sensitive information (credentials, tokens, PII) MUST NOT be included in log output
