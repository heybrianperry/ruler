...
1. MUST: New agent types MUST be added to the agents module index for centralized export and discovery.

## Policy Block

- MUST New agent types MUST be added to the agents module index for centralized export and discovery.
