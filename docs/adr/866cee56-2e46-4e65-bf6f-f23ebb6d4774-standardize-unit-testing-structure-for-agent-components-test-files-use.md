# Standardize Unit Testing Structure for Agent Components: Test Files Use
...
1. SHOULD: Test files SHOULD use TypeScript (.ts extension) to maintain type safety consistent with the main codebase

## Policy Block

- SHOULD Test files SHOULD use TypeScript (.ts extension) to maintain type safety consistent with the main codebase
