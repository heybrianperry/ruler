...
1. MUST: Configuration loaders and utility modules MUST export typed interfaces for options and return values (e.g., UnifiedLoadOptions, IAgentConfig, IAgent).

## Policy Block

- MUST Configuration loaders and utility modules MUST export typed interfaces for options and return values (e.g., UnifiedLoadOptions, IAgentConfig, IAgent).
