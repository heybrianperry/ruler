...
1. MUST: Consumer modules MUST resolve agent service instances per configuration directory scope using resolveSelectedAgents rather than instantiating service instances globally.

## Policy Block

- MUST Consumer modules MUST resolve agent service instances per configuration directory scope using resolveSelectedAgents rather than instantiating service instances globally.
