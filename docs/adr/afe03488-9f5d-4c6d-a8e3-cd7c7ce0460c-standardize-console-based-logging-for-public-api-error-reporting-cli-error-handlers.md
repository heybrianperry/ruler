...
1. MUST: CLI error handlers MUST format error messages through dedicated formatting functions (e.g., formatCliError) before console output

## Policy Block

- MUST CLI error handlers MUST format error messages through dedicated formatting functions (e.g., formatCliError) before console output
