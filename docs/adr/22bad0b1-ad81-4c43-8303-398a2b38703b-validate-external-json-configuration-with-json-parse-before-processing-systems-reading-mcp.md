...
1. SHOULD: Systems reading MCP server configurations SHOULD handle schema variations (mcpServers vs servers) through defensive property access

## Policy Block

- SHOULD Systems reading MCP server configurations SHOULD handle schema variations (mcpServers vs servers) through defensive property access
