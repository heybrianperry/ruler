...
1. MAY: The Map cache MAY be invalidated and rebuilt when filesystem changes are detected externally

## Policy Block

- MAY The Map cache MAY be invalidated and rebuilt when filesystem changes are detected externally
