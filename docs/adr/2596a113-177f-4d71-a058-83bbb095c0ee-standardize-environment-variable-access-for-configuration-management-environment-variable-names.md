...
1. SHOULD: Environment variable names SHOULD follow a consistent naming convention with appropriate prefixes to avoid collisions (e.g., APP_*, AGENT_*, MCP_*)

## Policy Block

- SHOULD Environment variable names SHOULD follow a consistent naming convention with appropriate prefixes to avoid collisions (e.g., APP_*, AGENT_*, MCP_*)
