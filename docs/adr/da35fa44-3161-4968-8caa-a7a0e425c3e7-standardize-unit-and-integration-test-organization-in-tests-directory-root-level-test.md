# Standardize Unit and Integration Test Organization in tests/ Directory: Root Level Test
...
1. MAY: Root-level test files in tests/ MAY be used for special cases like bug reproduction or regression tests

## Policy Block

- MAY Root-level test files in tests/ MAY be used for special cases like bug reproduction or regression tests
