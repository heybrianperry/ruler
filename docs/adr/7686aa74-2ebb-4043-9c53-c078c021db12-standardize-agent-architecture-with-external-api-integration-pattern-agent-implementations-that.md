# Standardize Agent Architecture with External API Integration Pattern: Agent Implementations That
...
1. MUST: All agent implementations that integrate with external APIs MUST follow the established agent architecture pattern as demonstrated in JulesAgent, JetBrainsAiAssistantAgent, FirebaseAgent, AntigravityAgent, KiloCodeAgent, AiderAgent, and JunieAgent

## Policy Block

- MUST All agent implementations that integrate with external APIs MUST follow the established agent architecture pattern as demonstrated in JulesAgent, JetBrainsAiAssistantAgent, FirebaseAgent, AntigravityAgent, KiloCodeAgent, AiderAgent, and JunieAgent
