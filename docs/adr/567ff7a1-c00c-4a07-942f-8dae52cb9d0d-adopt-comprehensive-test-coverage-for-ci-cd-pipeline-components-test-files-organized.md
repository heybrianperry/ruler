# Adopt Comprehensive Test Coverage for CI/CD Pipeline Components: Test Files Organized
...
1. SHOULD: Test files SHOULD be organized in parallel directory structures mirroring the source code (e.g., tests/unit/core/ for src/core/)

## Policy Block

- SHOULD Test files SHOULD be organized in parallel directory structures mirroring the source code (e.g., tests/unit/core/ for src/core/)
