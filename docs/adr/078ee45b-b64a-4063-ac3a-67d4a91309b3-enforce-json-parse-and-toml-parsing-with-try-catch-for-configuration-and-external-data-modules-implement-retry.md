...
1. MAY: Modules MAY implement retry logic or fallback parsing strategies (e.g., attempting to strip comments before JSON.parse) when appropriate for the use case

## Policy Block

- MAY Modules MAY implement retry logic or fallback parsing strategies (e.g., attempting to strip comments before JSON.parse) when appropriate for the use case
