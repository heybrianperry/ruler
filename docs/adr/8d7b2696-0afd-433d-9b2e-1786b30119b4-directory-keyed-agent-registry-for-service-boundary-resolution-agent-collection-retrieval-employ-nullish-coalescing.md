...
1. MUST: Agent collection retrieval MUST employ nullish coalescing to provide fallback behavior when a directory key has no registered agents

## Policy Block

- MUST Agent collection retrieval MUST employ nullish coalescing to provide fallback behavior when a directory key has no registered agents
