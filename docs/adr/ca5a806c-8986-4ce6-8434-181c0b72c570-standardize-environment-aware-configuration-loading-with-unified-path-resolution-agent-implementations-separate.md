# Standardize Environment-Aware Configuration Loading with Unified Path Resolution: Agent Implementations Separate
...
1. SHOULD: Agent implementations SHOULD separate configuration loading from business logic to enable independent testing and configuration validation

## Policy Block

- SHOULD Agent implementations SHOULD separate configuration loading from business logic to enable independent testing and configuration validation
