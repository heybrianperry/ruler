# Standardize Configuration Loading Through Unified Environment Management: Apply Engine Used
...
1. MUST: The apply-engine MUST be used to process and apply configuration to runtime environments

## Policy Block

- MUST The apply-engine MUST be used to process and apply configuration to runtime environments
