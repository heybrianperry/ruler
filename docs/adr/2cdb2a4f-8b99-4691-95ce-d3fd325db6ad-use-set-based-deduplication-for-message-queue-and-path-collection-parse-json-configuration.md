...
1. MUST: Parse JSON configuration files using JSON.parse() before merging or extracting server configurations

## Policy Block

- MUST Parse JSON configuration files using JSON.parse() before merging or extracting server configurations
