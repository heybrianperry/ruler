# Adopt Vitest as Standard Unit Testing Framework for TypeScript Agent Development: Test Files Placed
...
1. MUST: Test files MUST be placed in the tests/unit directory structure following the pattern tests/unit/{component}/{ComponentName}.test.ts

## Policy Block

- MUST Test files MUST be placed in the tests/unit directory structure following the pattern tests/unit/{component}/{ComponentName}.test.ts
