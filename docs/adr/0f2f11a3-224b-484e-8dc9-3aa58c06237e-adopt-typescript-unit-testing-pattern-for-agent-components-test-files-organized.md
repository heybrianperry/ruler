# Adopt TypeScript Unit Testing Pattern for Agent Components: Test Files Organized
...
1. MAY: Test files MAY be organized by functional area (agents/, cli/) to improve discoverability and maintenance

## Policy Block

- MAY Test files MAY be organized by functional area (agents/, cli/) to improve discoverability and maintenance
