# Adopt Unified Configuration Loading with Environment Variable Override Support: Configuration Precedence Follow
...
1. MUST: Configuration precedence MUST follow the order: programmatic options > environment variables > configuration files > defaults

## Policy Block

- MUST Configuration precedence MUST follow the order: programmatic options > environment variables > configuration files > defaults
