# Adopt Vitest with vi.mock() for Unit Testing TypeScript Agent Modules: Test Files Organize
...
1. SHOULD: Test files SHOULD organize tests using describe() blocks for logical grouping of related test cases

## Policy Block

- SHOULD Test files SHOULD organize tests using describe() blocks for logical grouping of related test cases
