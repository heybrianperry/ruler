# Adopt Structured Test Organization with Layered Test Suites: Integration Tests Verify
...
1. MUST: Integration tests MUST verify interactions between multiple components or with controlled external dependencies

## Policy Block

- MUST Integration tests MUST verify interactions between multiple components or with controlled external dependencies
