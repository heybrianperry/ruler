...
1. MAY: Implementations MAY extend the cache layer with additional Map instances for different entity types beyond servers

## Policy Block

- MAY Implementations MAY extend the cache layer with additional Map instances for different entity types beyond servers
