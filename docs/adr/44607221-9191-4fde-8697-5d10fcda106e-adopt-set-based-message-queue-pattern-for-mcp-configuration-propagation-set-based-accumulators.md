...
1. MUST: Set-based accumulators MUST be used when processing gitignore entries (expectedGitignoreEntries.add), MCP server keys (seen.add), and skill targets (targets.add)

## Policy Block

- MUST Set-based accumulators MUST be used when processing gitignore entries (expectedGitignoreEntries.add), MCP server keys (seen.add), and skill targets (targets.add)
