...
1. MAY: Agent implementations MAY extend specialized base classes (AbstractAgent, AgentsMdAgent) to inherit common functionality while maintaining contract compliance

## Policy Block

- MAY Agent implementations MAY extend specialized base classes (AbstractAgent, AgentsMdAgent) to inherit common functionality while maintaining contract compliance
