# IAgent Internal Interface Contract for Agent Integrations: Agent Integrations Not Expose Disparate Public
...
1. MUST_NOT: Agent integrations MUST_NOT expose disparate public lifecycle methods that bypass or conflict with the IAgent contract.

## Policy Block

- MUST_NOT Agent integrations MUST_NOT expose disparate public lifecycle methods that bypass or conflict with the IAgent contract.
