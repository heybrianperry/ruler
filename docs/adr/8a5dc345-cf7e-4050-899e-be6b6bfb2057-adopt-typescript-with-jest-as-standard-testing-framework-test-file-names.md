# Adopt TypeScript with Jest as Standard Testing Framework: Test File Names
...
1. SHOULD: Test file names SHOULD mirror the source file being tested (e.g., ClaudeAgent.ts → ClaudeAgent.test.ts)

## Policy Block

- SHOULD Test file names SHOULD mirror the source file being tested (e.g., ClaudeAgent.ts → ClaudeAgent.test.ts)
