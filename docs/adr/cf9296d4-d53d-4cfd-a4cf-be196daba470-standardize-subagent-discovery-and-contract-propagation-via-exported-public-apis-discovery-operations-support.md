...
1. SHOULD: Discovery operations SHOULD support recursive markdown file traversal (listMarkdownFilesRecursive) with gitignore-aware filtering to respect repository boundaries

## Policy Block

- SHOULD Discovery operations SHOULD support recursive markdown file traversal (listMarkdownFilesRecursive) with gitignore-aware filtering to respect repository boundaries
