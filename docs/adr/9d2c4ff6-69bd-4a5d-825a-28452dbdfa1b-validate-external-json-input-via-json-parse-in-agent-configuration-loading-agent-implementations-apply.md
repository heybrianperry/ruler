...
1. MUST: All agent implementations MUST apply JSON.parse to configuration file content loaded via fs.readFile or fs/promises before consuming the data

## Policy Block

- MUST All agent implementations MUST apply JSON.parse to configuration file content loaded via fs.readFile or fs/promises before consuming the data
