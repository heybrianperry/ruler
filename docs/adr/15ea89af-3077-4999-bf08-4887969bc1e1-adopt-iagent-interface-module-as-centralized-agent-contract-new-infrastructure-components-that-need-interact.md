...
1. SHOULD: New infrastructure components that need to interact with agents SHOULD follow the established import pattern observed in MCP capabilities, revert engine, config utilities, and agent selection modules.

## Policy Block

- SHOULD New infrastructure components that need to interact with agents SHOULD follow the established import pattern observed in MCP capabilities, revert engine, config utilities, and agent selection modules.
