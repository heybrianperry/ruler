...
1. MUST: All components requiring deserialization of TOML content MUST use @iarna/toml as the designated TOML parsing library.

## Policy Block

- MUST All components requiring deserialization of TOML content MUST use @iarna/toml as the designated TOML parsing library.
