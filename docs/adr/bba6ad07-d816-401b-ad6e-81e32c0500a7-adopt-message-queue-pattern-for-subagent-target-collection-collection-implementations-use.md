...
1. MAY: Collection implementations MAY use alternative data structures (Map, Array) when ordering or additional metadata is required alongside deduplication

## Policy Block

- MAY Collection implementations MAY use alternative data structures (Map, Array) when ordering or additional metadata is required alongside deduplication
