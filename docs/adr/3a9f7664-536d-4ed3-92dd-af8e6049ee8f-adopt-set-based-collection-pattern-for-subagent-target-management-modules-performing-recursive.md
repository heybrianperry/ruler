...
1. SHOULD: Modules performing recursive filesystem operations (listMarkdownFilesRecursive) SHOULD accumulate results into Set-based collections before conversion to arrays

## Policy Block

- SHOULD Modules performing recursive filesystem operations (listMarkdownFilesRecursive) SHOULD accumulate results into Set-based collections before conversion to arrays
