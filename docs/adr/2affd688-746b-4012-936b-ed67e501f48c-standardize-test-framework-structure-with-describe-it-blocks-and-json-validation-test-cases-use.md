...
1. MUST: All test cases MUST use it blocks with clear, behavior-focused descriptions that explain the expected outcome

## Policy Block

- MUST All test cases MUST use it blocks with clear, behavior-focused descriptions that explain the expected outcome
