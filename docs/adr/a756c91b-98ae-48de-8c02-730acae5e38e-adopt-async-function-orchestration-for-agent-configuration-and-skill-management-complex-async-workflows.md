...
1. MUST: Complex async workflows MUST be decomposed into named functions (e.g., loadExistingConfig, saveConfig, discoverSkills, propagateSkills) rather than inline promise chains

## Policy Block

- MUST Complex async workflows MUST be decomposed into named functions (e.g., loadExistingConfig, saveConfig, discoverSkills, propagateSkills) rather than inline promise chains
