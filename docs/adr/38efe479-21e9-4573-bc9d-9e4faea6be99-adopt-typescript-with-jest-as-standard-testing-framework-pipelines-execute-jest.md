# Adopt TypeScript with Jest as Standard Testing Framework: Pipelines Execute Jest
...
1. MUST: CI/CD pipelines MUST execute Jest tests as part of the build and deployment process

## Policy Block

- MUST CI/CD pipelines MUST execute Jest tests as part of the build and deployment process
