# Adopt Async/Await Pattern for External API Integration: External Calls Operations
...
1. MUST: All external API calls and I/O operations MUST use async/await syntax for asynchronous execution

## Policy Block

- MUST All external API calls and I/O operations MUST use async/await syntax for asynchronous execution
