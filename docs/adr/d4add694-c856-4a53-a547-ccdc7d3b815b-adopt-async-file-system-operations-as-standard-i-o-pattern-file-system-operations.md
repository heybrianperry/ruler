...
1. MUST: All file system operations MUST use async functions (readFile, writeFile, mkdir, stat, readdir) from 'fs/promises' or callback-based 'fs' module wrapped in promises

## Policy Block

- MUST All file system operations MUST use async functions (readFile, writeFile, mkdir, stat, readdir) from 'fs/promises' or callback-based 'fs' module wrapped in promises
