...
1. MUST: All agent service implementations MUST implement the IAgent contract to establish explicit service interface boundaries.

## Policy Block

- MUST All agent service implementations MUST implement the IAgent contract to establish explicit service interface boundaries.
