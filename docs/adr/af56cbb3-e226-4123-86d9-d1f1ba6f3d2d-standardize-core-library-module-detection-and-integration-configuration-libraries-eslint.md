# Standardize Core Library Module Detection and Integration: Configuration Libraries Eslint
...
1. SHOULD: Configuration libraries (ESLint, build tools) SHOULD be declared as devDependencies and separated from runtime dependencies

## Policy Block

- SHOULD Configuration libraries (ESLint, build tools) SHOULD be declared as devDependencies and separated from runtime dependencies
