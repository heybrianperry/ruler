...
1. SHOULD: Server registry implementations SHOULD validate input from filesystem sources before cache insertion to prevent invalid state propagation

## Policy Block

- SHOULD Server registry implementations SHOULD validate input from filesystem sources before cache insertion to prevent invalid state propagation
