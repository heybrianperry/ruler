# Standardize TypeScript Type Definitions for Public API Contracts: Breaking Changes Public
...
1. SHOULD: Breaking changes to public API types SHOULD be avoided; when necessary, they SHOULD follow semantic versioning principles and include deprecation warnings

## Policy Block

- SHOULD Breaking changes to public API types SHOULD be avoided; when necessary, they SHOULD follow semantic versioning principles and include deprecation warnings
