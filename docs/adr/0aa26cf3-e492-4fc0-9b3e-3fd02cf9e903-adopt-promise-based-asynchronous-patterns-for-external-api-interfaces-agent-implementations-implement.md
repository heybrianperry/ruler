# Adopt Promise-Based Asynchronous Patterns for External API Interfaces: Agent Implementations Implement
...
1. SHOULD: Agent implementations SHOULD implement consistent error handling patterns with typed error objects for Promise rejections

## Policy Block

- SHOULD Agent implementations SHOULD implement consistent error handling patterns with typed error objects for Promise rejections
