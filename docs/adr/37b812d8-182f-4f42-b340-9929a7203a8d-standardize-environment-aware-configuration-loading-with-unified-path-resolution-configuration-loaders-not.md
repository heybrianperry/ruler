# Standardize Environment-Aware Configuration Loading with Unified Path Resolution: Configuration Loaders Not
...
1. MUST_NOT: Configuration loaders MUST NOT hardcode absolute paths or environment-specific values that prevent portability across development, staging, and production environments

## Policy Block

- MUST_NOT Configuration loaders MUST NOT hardcode absolute paths or environment-specific values that prevent portability across development, staging, and production environments
