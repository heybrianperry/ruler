...
1. SHOULD: The IAgent interface SHOULD be used for type contracts where polymorphic agent handling is required outside the agents module.

## Policy Block

- SHOULD The IAgent interface SHOULD be used for type contracts where polymorphic agent handling is required outside the agents module.
