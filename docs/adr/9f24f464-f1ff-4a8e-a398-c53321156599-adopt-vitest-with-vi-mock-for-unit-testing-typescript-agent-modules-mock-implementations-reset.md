# Adopt Vitest with vi.mock() for Unit Testing TypeScript Agent Modules: Mock Implementations Reset
...
1. SHOULD: Mock implementations SHOULD be reset or cleared between test cases using beforeEach() hooks to prevent test pollution

## Policy Block

- SHOULD Mock implementations SHOULD be reset or cleared between test cases using beforeEach() hooks to prevent test pollution
