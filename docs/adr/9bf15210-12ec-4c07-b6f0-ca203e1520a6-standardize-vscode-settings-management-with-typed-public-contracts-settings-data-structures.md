...
1. MUST: Settings data structures MUST conform to the VSCodeSettings and AugmentMcpServer type definitions

## Policy Block

- MUST Settings data structures MUST conform to the VSCodeSettings and AugmentMcpServer type definitions
