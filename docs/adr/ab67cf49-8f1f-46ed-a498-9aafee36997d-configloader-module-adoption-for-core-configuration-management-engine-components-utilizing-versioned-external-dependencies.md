...
1. MUST: Engine components utilizing versioned external dependencies MUST discover the project resolution artifact and verify the exact locked dependency version before invoking external APIs.

## Policy Block

- MUST Engine components utilizing versioned external dependencies MUST discover the project resolution artifact and verify the exact locked dependency version before invoking external APIs.
