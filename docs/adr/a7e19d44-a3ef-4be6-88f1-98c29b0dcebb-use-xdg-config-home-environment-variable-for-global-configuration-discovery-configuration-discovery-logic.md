...
1. MUST_NOT: Configuration discovery logic MUST NOT hardcode absolute paths to global configuration directories

## Policy Block

- MUST_NOT Configuration discovery logic MUST NOT hardcode absolute paths to global configuration directories
