# Adopt TypeScript-based Unit Testing Framework for Agent and CLI Components: Unit Tests Written
...
1. MUST: All unit tests MUST be written in TypeScript with the .test.ts file extension.

## Policy Block

- MUST All unit tests MUST be written in TypeScript with the .test.ts file extension.
