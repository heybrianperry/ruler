...
1. SHOULD: Modules SHOULD group related contracts (types, interfaces, classes) together and export them from a single module to establish clear API boundaries.

## Policy Block

- SHOULD Modules SHOULD group related contracts (types, interfaces, classes) together and export them from a single module to establish clear API boundaries.
