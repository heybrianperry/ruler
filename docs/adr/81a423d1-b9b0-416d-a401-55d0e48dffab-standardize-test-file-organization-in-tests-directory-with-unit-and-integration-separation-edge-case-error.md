# Standardize Test File Organization in tests/ Directory with Unit and Integration Separation: Edge Case Error
...
1. SHOULD: Edge case and error scenario tests SHOULD use descriptive file names indicating the scenario being tested

## Policy Block

- SHOULD Edge case and error scenario tests SHOULD use descriptive file names indicating the scenario being tested
