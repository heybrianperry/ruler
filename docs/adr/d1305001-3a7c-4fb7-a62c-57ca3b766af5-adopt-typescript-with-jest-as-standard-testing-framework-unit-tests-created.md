# Adopt TypeScript with Jest as Standard Testing Framework: Unit Tests Created
...
1. SHOULD: Unit tests SHOULD be created for all agent implementations and core functionality modules

## Policy Block

- SHOULD Unit tests SHOULD be created for all agent implementations and core functionality modules
