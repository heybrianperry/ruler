...
1. SHOULD: Functions that return deduplicated collections SHOULD convert Sets to Arrays only at API boundaries to preserve type safety.

## Policy Block

- SHOULD Functions that return deduplicated collections SHOULD convert Sets to Arrays only at API boundaries to preserve type safety.
