# Adopt TypeScript Unit Testing Pattern for Agent Components: Invalid Error Scenarios
...
1. MUST: Invalid or error scenarios MUST be tested separately in dedicated test files (e.g., invalid-agent.test.ts)

## Policy Block

- MUST Invalid or error scenarios MUST be tested separately in dedicated test files (e.g., invalid-agent.test.ts)
