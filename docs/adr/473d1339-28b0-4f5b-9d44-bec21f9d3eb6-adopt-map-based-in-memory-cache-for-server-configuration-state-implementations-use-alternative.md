...
1. MAY: Implementations MAY use alternative key-value data structures if they provide equivalent O(1) lookup and automatic deduplication semantics

## Policy Block

- MAY Implementations MAY use alternative key-value data structures if they provide equivalent O(1) lookup and automatic deduplication semantics
