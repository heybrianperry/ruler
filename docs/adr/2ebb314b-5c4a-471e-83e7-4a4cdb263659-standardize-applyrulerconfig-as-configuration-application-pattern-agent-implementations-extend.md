...
1. MAY: Agent implementations MAY extend the base applyRulerConfig pattern with agent-specific configuration logic while maintaining the core interface contract

## Policy Block

- MAY Agent implementations MAY extend the base applyRulerConfig pattern with agent-specific configuration logic while maintaining the core interface contract
