...
1. SHOULD_NOT: Test suites SHOULD NOT use direct array indexing (e.g., array[0]) to access parsed configuration entries unless array order is explicitly guaranteed by specification

## Policy Block

- SHOULD_NOT Test suites SHOULD NOT use direct array indexing (e.g., array[0]) to access parsed configuration entries unless array order is explicitly guaranteed by specification
