...
1. SHOULD: Public functions that perform asynchronous operations SHOULD be explicitly typed with their return types and parameter interfaces.

## Policy Block

- SHOULD Public functions that perform asynchronous operations SHOULD be explicitly typed with their return types and parameter interfaces.
