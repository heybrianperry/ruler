...
1. SHOULD: Configuration loading logic SHOULD implement fallback behavior when XDG_CONFIG_HOME is not set, following XDG Base Directory specification defaults

## Policy Block

- SHOULD Configuration loading logic SHOULD implement fallback behavior when XDG_CONFIG_HOME is not set, following XDG Base Directory specification defaults
