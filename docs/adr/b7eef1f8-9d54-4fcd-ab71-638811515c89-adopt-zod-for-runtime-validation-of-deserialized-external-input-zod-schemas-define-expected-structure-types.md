...
1. MUST: Zod schemas MUST define the expected structure, types, and constraints for all deserialized data, including required fields, optional fields, enums, and nested objects

## Policy Block

- MUST Zod schemas MUST define the expected structure, types, and constraints for all deserialized data, including required fields, optional fields, enums, and nested objects
