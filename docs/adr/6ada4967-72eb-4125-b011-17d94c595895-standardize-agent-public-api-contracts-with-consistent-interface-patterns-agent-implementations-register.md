# Standardize Agent Public API Contracts with Consistent Interface Patterns: Agent Implementations Register
...
1. MUST: Agent implementations MUST register their capabilities and skills through the centralized SkillsUtils module to enable discovery and orchestration

## Policy Block

- MUST Agent implementations MUST register their capabilities and skills through the centralized SkillsUtils module to enable discovery and orchestration
