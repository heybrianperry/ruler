...
1. MUST_NOT: Modules MUST NOT export internal implementation details, helper functions, or types that are not intended for external consumption

## Policy Block

- MUST_NOT Modules MUST NOT export internal implementation details, helper functions, or types that are not intended for external consumption
