# Standardize Test File Naming and Organization for CI/CD Integration: Test File Names
...
1. MUST: Test file names MUST clearly indicate the component or feature being tested, following the pattern [component-name].test.ts or [feature-name].test.ts

## Policy Block

- MUST Test file names MUST clearly indicate the component or feature being tested, following the pattern [component-name].test.ts or [feature-name].test.ts
