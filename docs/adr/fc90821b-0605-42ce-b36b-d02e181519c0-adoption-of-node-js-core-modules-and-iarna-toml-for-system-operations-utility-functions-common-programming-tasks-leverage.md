# Adoption of Node.js Core Modules and @iarna/toml for System Operations: Utility Functions Common Programming Tasks Leverage
...
1. MUST: Utility functions for common programming tasks MUST leverage the Node.js `util` module where applicable.

## Policy Block

- MUST Utility functions for common programming tasks MUST leverage the Node.js `util` module where applicable.
