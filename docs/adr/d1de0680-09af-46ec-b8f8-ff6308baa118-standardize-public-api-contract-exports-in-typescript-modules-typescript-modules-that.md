...
1. MUST: All TypeScript modules that define public API contracts MUST use explicit named exports rather than default exports

## Policy Block

- MUST All TypeScript modules that define public API contracts MUST use explicit named exports rather than default exports
