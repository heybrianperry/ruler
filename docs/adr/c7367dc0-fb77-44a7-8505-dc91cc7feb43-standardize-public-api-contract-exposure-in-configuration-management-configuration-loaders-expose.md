# Standardize Public API Contract Exposure in Configuration Management: Configuration Loaders Expose
...
1. MUST: Configuration loaders MUST expose a consistent interface for retrieving environment-specific settings regardless of the underlying configuration source

## Policy Block

- MUST Configuration loaders MUST expose a consistent interface for retrieving environment-specific settings regardless of the underlying configuration source
