# Adopt Promise-Based Asynchronous Patterns for External API Interfaces: Public Methods Not
...
1. MUST_NOT: Public API methods MUST NOT perform blocking synchronous operations that could be implemented asynchronously

## Policy Block

- MUST_NOT Public API methods MUST NOT perform blocking synchronous operations that could be implemented asynchronously
