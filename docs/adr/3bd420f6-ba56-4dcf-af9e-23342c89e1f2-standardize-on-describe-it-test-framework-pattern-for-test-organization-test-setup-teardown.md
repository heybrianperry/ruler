...
1. MUST: Test setup and teardown logic MUST use beforeEach and afterEach lifecycle hooks when state needs to be initialized or cleaned up between tests

## Policy Block

- MUST Test setup and teardown logic MUST use beforeEach and afterEach lifecycle hooks when state needs to be initialized or cleaned up between tests
