# Adopt TypeScript Unit Testing Pattern for Agent Components: Unit Tests Use
...
1. MUST: Unit tests MUST use TypeScript (.test.ts extension) to maintain type safety and consistency with the main codebase

## Policy Block

- MUST Unit tests MUST use TypeScript (.test.ts extension) to maintain type safety and consistency with the main codebase
