# Standardize Agent-Based External API Integration Architecture: Agent Implementations Cache
...
1. MAY: Agent implementations MAY cache API responses when appropriate to reduce external API calls and improve performance

## Policy Block

- MAY Agent implementations MAY cache API responses when appropriate to reduce external API calls and improve performance
