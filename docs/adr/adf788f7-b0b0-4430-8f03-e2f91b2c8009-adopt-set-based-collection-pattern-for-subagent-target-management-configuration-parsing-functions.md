...
1. SHOULD: Configuration parsing functions (parseFrontmatter, loadSubagentFile) SHOULD validate uniqueness constraints at the point of collection insertion

## Policy Block

- SHOULD Configuration parsing functions (parseFrontmatter, loadSubagentFile) SHOULD validate uniqueness constraints at the point of collection insertion
