...
1. MUST: MUST discover the project's lock file and resolve the exact locked version of any external parsing library before implementing code that uses it.

## Policy Block

- MUST MUST discover the project's lock file and resolve the exact locked version of any external parsing library before implementing code that uses it.
