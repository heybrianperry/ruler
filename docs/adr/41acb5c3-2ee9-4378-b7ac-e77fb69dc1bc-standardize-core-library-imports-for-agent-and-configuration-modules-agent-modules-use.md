...
1. MUST: Agent modules MUST use native Node.js modules (fs, fs/promises, path) for filesystem operations rather than third-party alternatives

## Policy Block

- MUST Agent modules MUST use native Node.js modules (fs, fs/promises, path) for filesystem operations rather than third-party alternatives
