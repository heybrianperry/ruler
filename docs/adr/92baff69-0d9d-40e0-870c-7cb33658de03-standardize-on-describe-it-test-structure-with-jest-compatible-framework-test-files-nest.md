...
1. SHOULD: Test files SHOULD nest describe blocks to create hierarchical test organization when testing multiple aspects of a component

## Policy Block

- SHOULD Test files SHOULD nest describe blocks to create hierarchical test organization when testing multiple aspects of a component
