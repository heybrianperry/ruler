...
1. MUST_NOT: Modules MUST NOT introduce alternative TOML parsing libraries for configuration file processing

## Policy Block

- MUST_NOT Modules MUST NOT introduce alternative TOML parsing libraries for configuration file processing
