...
1. MAY: Use relative path normalization when adding configuration artifacts to version control ignore files to ensure cross-platform compatibility

## Policy Block

- MAY Use relative path normalization when adding configuration artifacts to version control ignore files to ensure cross-platform compatibility
