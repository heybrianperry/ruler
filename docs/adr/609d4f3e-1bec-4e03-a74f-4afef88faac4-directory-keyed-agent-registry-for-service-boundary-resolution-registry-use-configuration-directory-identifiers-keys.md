...
1. MUST: The registry MUST use configuration directory identifiers as keys for agent collection lookup

## Policy Block

- MUST The registry MUST use configuration directory identifiers as keys for agent collection lookup
