...
1. MUST: All agent integration modules in the agent subsystem MUST implement or consume the IAgent contract as their primary interface boundary.

## Policy Block

- MUST All agent integration modules in the agent subsystem MUST implement or consume the IAgent contract as their primary interface boundary.
