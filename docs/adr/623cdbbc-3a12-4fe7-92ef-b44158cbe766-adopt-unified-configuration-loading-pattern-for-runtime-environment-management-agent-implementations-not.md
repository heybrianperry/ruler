# Adopt Unified Configuration Loading Pattern for Runtime Environment Management: Agent Implementations Not
...
1. MUST_NOT: Agent implementations MUST NOT directly access environment variables or configuration sources; all access MUST go through the unified configuration loader

## Policy Block

- MUST_NOT Agent implementations MUST NOT directly access environment variables or configuration sources; all access MUST go through the unified configuration loader
