# Standardize Public API Export Patterns for Agent Integration: Integration Modules Mcp
...
1. SHOULD: Integration modules (e.g., MCP merge utilities) SHOULD expose composable functions that can be combined for complex workflows

## Policy Block

- SHOULD Integration modules (e.g., MCP merge utilities) SHOULD expose composable functions that can be combined for complex workflows
