...
1. MUST: All VSCode settings access MUST use the typed public contracts (VSCodeSettings, AugmentMcpServer) defined in src/vscode/settings.ts rather than direct filesystem operations

## Policy Block

- MUST All VSCode settings access MUST use the typed public contracts (VSCodeSettings, AugmentMcpServer) defined in src/vscode/settings.ts rather than direct filesystem operations
