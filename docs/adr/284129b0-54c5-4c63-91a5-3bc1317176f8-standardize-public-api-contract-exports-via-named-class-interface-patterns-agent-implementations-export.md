...
1. MUST: Agent implementations MUST export a named class (e.g., FirebenderAgent, MistralVibeAgent, GeminiCliAgent) that implements the IAgent interface contract.

## Policy Block

- MUST Agent implementations MUST export a named class (e.g., FirebenderAgent, MistralVibeAgent, GeminiCliAgent) that implements the IAgent interface contract.
