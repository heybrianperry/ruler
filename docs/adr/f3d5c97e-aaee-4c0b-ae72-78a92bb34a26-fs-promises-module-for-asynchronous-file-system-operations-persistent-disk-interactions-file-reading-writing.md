...
1. MUST: All persistent disk interactions, file reading, and file writing MUST use the promise-based fs/promises module rather than blocking synchronous APIs or legacy callback interfaces.

## Policy Block

- MUST All persistent disk interactions, file reading, and file writing MUST use the promise-based fs/promises module rather than blocking synchronous APIs or legacy callback interfaces.
