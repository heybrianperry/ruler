...
1. MUST: Fatal errors, user-facing errors, and critical failures MUST use console.error() to signal severity

## Policy Block

- MUST Fatal errors, user-facing errors, and critical failures MUST use console.error() to signal severity
