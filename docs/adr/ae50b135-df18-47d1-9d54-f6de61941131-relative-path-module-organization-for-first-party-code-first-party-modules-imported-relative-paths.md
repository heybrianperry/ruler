...
1. MUST: First-party modules MUST be imported using relative paths that explicitly traverse the directory structure from the importing module to the target module

## Policy Block

- MUST First-party modules MUST be imported using relative paths that explicitly traverse the directory structure from the importing module to the target module
