...
1. SHOULD: Agent resolution logic SHOULD isolate agent lifecycle initialization from downstream operation invocation.

## Policy Block

- SHOULD Agent resolution logic SHOULD isolate agent lifecycle initialization from downstream operation invocation.
