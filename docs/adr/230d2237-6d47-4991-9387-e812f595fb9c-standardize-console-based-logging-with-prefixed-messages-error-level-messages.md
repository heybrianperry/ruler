...
1. MUST: Error-level messages MUST use console.error with a descriptive prefix indicating the component or severity (e.g., `[ruler]`, `${ERROR_PREFIX}`)

## Policy Block

- MUST Error-level messages MUST use console.error with a descriptive prefix indicating the component or severity (e.g., `[ruler]`, `${ERROR_PREFIX}`)
