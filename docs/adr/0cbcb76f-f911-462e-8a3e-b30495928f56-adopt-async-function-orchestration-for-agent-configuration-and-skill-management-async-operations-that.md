...
1. MUST: Async operations that modify shared state (e.g., Set.add for deduplication) MUST complete sequentially within their workflow to prevent race conditions

## Policy Block

- MUST Async operations that modify shared state (e.g., Set.add for deduplication) MUST complete sequentially within their workflow to prevent race conditions
