...
1. SHOULD: Cache key selection SHOULD use stable identifiers (name for stdio, url for SSE/HTTP) that uniquely identify server instances

## Policy Block

- SHOULD Cache key selection SHOULD use stable identifiers (name for stdio, url for SSE/HTTP) that uniquely identify server instances
