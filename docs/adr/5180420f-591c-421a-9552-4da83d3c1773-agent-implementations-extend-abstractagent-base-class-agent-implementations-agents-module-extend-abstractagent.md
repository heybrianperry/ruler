...
1. MUST: All agent implementations in the agents module MUST extend the AbstractAgent base class to inherit shared behavior and maintain polymorphic compatibility.

## Policy Block

- MUST All agent implementations in the agents module MUST extend the AbstractAgent base class to inherit shared behavior and maintain polymorphic compatibility.
