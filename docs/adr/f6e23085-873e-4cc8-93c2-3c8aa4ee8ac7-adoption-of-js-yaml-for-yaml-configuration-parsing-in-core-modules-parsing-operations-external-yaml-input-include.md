...
1. MUST: All parsing operations on external YAML input using `js-yaml` MUST include input validation.

## Policy Block

- MUST All parsing operations on external YAML input using `js-yaml` MUST include input validation.
