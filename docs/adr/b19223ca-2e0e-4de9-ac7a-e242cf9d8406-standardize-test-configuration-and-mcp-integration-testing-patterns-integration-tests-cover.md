# Standardize Test Configuration and MCP Integration Testing Patterns: Integration Tests Cover
...
1. MUST: Integration tests MUST cover real-world scenarios including skills-mcp integration and duplication detection

## Policy Block

- MUST Integration tests MUST cover real-world scenarios including skills-mcp integration and duplication detection
