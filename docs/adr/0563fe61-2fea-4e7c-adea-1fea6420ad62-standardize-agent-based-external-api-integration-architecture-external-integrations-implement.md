# Standardize Agent-Based External API Integration Architecture: External Integrations Implement
...
1. SHOULD: External API integrations SHOULD implement retry logic with exponential backoff for transient failures

## Policy Block

- SHOULD External API integrations SHOULD implement retry logic with exponential backoff for transient failures
