# Adopt TypeScript-based Unit Testing Framework for Agent and CLI Components: Unit Test Files
...
1. MUST: Unit test files MUST be organized under the tests/unit/ directory structure, mirroring the source code organization.

## Policy Block

- MUST Unit test files MUST be organized under the tests/unit/ directory structure, mirroring the source code organization.
