# Standardize Unit and Integration Test Organization in tests/ Directory: Unit Tests Organized
...
1. SHOULD: Unit tests SHOULD be organized into subdirectories matching the source code structure (e.g., tests/unit/agents/, tests/unit/core/)

## Policy Block

- SHOULD Unit tests SHOULD be organized into subdirectories matching the source code structure (e.g., tests/unit/agents/, tests/unit/core/)
