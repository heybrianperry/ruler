...
1. MUST: Before implementing any code that uses a versioned library, the consumer MUST discover the ecosystem's lock file, identify the build tool, inspect the repository lock or resolution artifact to determine the exact resolved version, and consult version-specific documentation to confirm API existence and behavior.

## Policy Block

- MUST Before implementing any code that uses a versioned library, the consumer MUST discover the ecosystem's lock file, identify the build tool, inspect the repository lock or resolution artifact to determine the exact resolved version, and consult version-specific documentation to confirm API existence and behavior.
