...
1. MAY: Configuration handlers MAY combine JSON.parse with additional schema validation for complex configuration objects containing server definitions, command arrays, or URL specifications

## Policy Block

- MAY Configuration handlers MAY combine JSON.parse with additional schema validation for complex configuration objects containing server definitions, command arrays, or URL specifications
