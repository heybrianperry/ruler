...
1. MUST: Warning-level messages MUST use console.warn with a prefix indicating the message source

## Policy Block

- MUST Warning-level messages MUST use console.warn with a prefix indicating the message source
