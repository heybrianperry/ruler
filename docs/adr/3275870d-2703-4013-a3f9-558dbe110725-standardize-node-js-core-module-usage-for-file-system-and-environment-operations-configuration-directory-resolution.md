...
1. MUST: Configuration directory resolution MUST check process.env.XDG_CONFIG_HOME as the primary source for user configuration directory location

## Policy Block

- MUST Configuration directory resolution MUST check process.env.XDG_CONFIG_HOME as the primary source for user configuration directory location
