...
1. MUST: YAML frontmatter parsing MUST use the 'js-yaml' library as the standard parser

## Policy Block

- MUST YAML frontmatter parsing MUST use the 'js-yaml' library as the standard parser
