...
1. MUST: All JSON configuration file content MUST be deserialized using JSON.parse() after reading from the filesystem

## Policy Block

- MUST All JSON configuration file content MUST be deserialized using JSON.parse() after reading from the filesystem
