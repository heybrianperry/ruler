# Adopt Unified Configuration Loading Pattern for Runtime Environment Management: Agent Implementations Use
...
1. MUST: All agent implementations MUST use the UnifiedConfigLoader component for loading configuration data rather than implementing custom configuration loading logic

## Policy Block

- MUST All agent implementations MUST use the UnifiedConfigLoader component for loading configuration data rather than implementing custom configuration loading logic
