...
1. SHOULD: Public API contracts that expose server configuration operations (readVSCodeSettings, writeVSCodeSettings, propagateMcpToOpenHands) SHOULD populate and maintain Map-based caches to ensure consistency

## Policy Block

- SHOULD Public API contracts that expose server configuration operations (readVSCodeSettings, writeVSCodeSettings, propagateMcpToOpenHands) SHOULD populate and maintain Map-based caches to ensure consistency
