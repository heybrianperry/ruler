...
1. MUST: Use Map data structures to cache MCP server registry state indexed by server name or URL

## Policy Block

- MUST Use Map data structures to cache MCP server registry state indexed by server name or URL
