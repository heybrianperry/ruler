...
1. MUST: YAML parsing operations MUST invoke the parse function from js-yaml with file content as input

## Policy Block

- MUST YAML parsing operations MUST invoke the parse function from js-yaml with file content as input
