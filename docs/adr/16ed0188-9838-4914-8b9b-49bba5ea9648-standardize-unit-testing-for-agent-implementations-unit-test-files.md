# Standardize Unit Testing for Agent Implementations: Unit Test Files
...
1. MUST: Unit test files MUST use the .test.ts extension to ensure proper test discovery by the testing framework

## Policy Block

- MUST Unit test files MUST use the .test.ts extension to ensure proper test discovery by the testing framework
