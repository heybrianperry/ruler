# Standardize Unit Testing for Agent Implementations: Every Agent Implementation
...
1. MUST: Every agent implementation MUST have a corresponding unit test file following the naming pattern tests/unit/agents/{AgentName}.test.ts

## Policy Block

- MUST Every agent implementation MUST have a corresponding unit test file following the naming pattern tests/unit/agents/{AgentName}.test.ts
