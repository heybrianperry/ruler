# Standardize Core Library Module Detection and Integration: Test Infrastructure Libraries
...
1. SHOULD: Test infrastructure libraries (Jest, testing utilities) SHOULD be isolated to test configuration files and test suites, not imported in production code

## Policy Block

- SHOULD Test infrastructure libraries (Jest, testing utilities) SHOULD be isolated to test configuration files and test suites, not imported in production code
