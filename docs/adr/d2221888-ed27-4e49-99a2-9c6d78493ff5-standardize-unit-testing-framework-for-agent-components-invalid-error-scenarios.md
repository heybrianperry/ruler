# Standardize Unit Testing Framework for Agent Components: Invalid Error Scenarios
...
1. MUST: Invalid or error scenarios MUST be tested explicitly, as evidenced by `invalid-agent.test.ts`

## Policy Block

- MUST Invalid or error scenarios MUST be tested explicitly, as evidenced by `invalid-agent.test.ts`
