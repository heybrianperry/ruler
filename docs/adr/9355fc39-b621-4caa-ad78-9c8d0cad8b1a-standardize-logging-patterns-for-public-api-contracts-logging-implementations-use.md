...
1. SHOULD: Logging implementations SHOULD use structured logging formats (JSON) to enable automated log parsing and analysis

## Policy Block

- SHOULD Logging implementations SHOULD use structured logging formats (JSON) to enable automated log parsing and analysis
