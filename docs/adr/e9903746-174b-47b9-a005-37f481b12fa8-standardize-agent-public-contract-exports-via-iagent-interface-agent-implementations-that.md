...
1. MUST: Agent implementations that parse external configuration MUST implement security.input_validation using standard parsers (JSON.parse, parseTOML) with error handling

## Policy Block

- MUST Agent implementations that parse external configuration MUST implement security.input_validation using standard parsers (JSON.parse, parseTOML) with error handling
