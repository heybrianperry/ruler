...
1. MAY: Implementations MAY use separate Map instances for different transport types (existingSseServers, existingShttpServers, existingStdioServers) to enforce type-specific keying strategies

## Policy Block

- MAY Implementations MAY use separate Map instances for different transport types (existingSseServers, existingShttpServers, existingStdioServers) to enforce type-specific keying strategies
