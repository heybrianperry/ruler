...
1. SHOULD: CLI integration tests SHOULD import 'child_process' for spawning Ruler CLI commands with inherited or captured stdio.

## Policy Block

- SHOULD CLI integration tests SHOULD import 'child_process' for spawning Ruler CLI commands with inherited or captured stdio.
