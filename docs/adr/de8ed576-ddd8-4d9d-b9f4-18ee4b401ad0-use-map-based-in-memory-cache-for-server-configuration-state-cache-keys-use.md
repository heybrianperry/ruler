...
1. MUST: Cache keys MUST use server.name for stdio-based servers and url for SSE/SHTTP-based servers

## Policy Block

- MUST Cache keys MUST use server.name for stdio-based servers and url for SSE/SHTTP-based servers
