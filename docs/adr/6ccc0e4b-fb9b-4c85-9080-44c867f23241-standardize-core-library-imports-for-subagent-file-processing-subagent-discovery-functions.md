...
1. SHOULD: Subagent discovery functions (discoverSubagents, listMarkdownFilesRecursive) SHOULD be centralized in SubagentsProcessor to avoid duplication

## Policy Block

- SHOULD Subagent discovery functions (discoverSubagents, listMarkdownFilesRecursive) SHOULD be centralized in SubagentsProcessor to avoid duplication
