...
1. MAY: Test files MAY use beforeAll and afterAll hooks for expensive setup operations that can be shared across all tests in a suite

## Policy Block

- MAY Test files MAY use beforeAll and afterAll hooks for expensive setup operations that can be shared across all tests in a suite
