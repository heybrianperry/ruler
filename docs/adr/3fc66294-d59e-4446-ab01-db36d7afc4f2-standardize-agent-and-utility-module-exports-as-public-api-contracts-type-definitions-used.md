...
1. SHOULD: Type definitions used across multiple modules (ParsedFrontmatter, CopilotToolMapping) SHOULD be exported from a single authoritative module to prevent duplication

## Policy Block

- SHOULD Type definitions used across multiple modules (ParsedFrontmatter, CopilotToolMapping) SHOULD be exported from a single authoritative module to prevent duplication
