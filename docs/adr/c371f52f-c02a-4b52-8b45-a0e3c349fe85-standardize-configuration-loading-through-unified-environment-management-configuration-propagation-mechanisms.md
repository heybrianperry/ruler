# Standardize Configuration Loading Through Unified Environment Management: Configuration Propagation Mechanisms
...
1. SHOULD: Configuration propagation mechanisms (MCP propagation) SHOULD be used to share configuration across process boundaries and execution contexts

## Policy Block

- SHOULD Configuration propagation mechanisms (MCP propagation) SHOULD be used to share configuration across process boundaries and execution contexts
