...
1. SHOULD: Recursive file discovery operations SHOULD be encapsulated in dedicated functions (listMarkdownFilesRecursive) to maintain separation of concerns

## Policy Block

- SHOULD Recursive file discovery operations SHOULD be encapsulated in dedicated functions (listMarkdownFilesRecursive) to maintain separation of concerns
