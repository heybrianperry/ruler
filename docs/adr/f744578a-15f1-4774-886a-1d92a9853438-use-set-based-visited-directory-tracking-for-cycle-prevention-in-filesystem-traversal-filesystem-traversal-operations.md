...
1. MUST: Filesystem traversal operations MUST maintain a Set data structure containing visited directory paths to detect cycles

## Policy Block

- MUST Filesystem traversal operations MUST maintain a Set data structure containing visited directory paths to detect cycles
