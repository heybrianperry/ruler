...
1. MUST: SHA-256 MUST be the standard hashing algorithm for data integrity and content addressing

## Policy Block

- MUST SHA-256 MUST be the standard hashing algorithm for data integrity and content addressing
