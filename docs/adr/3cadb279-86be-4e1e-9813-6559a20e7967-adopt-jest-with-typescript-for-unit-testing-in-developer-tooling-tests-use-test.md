# Adopt Jest with TypeScript for Unit Testing in Developer Tooling: Tests Use Test
...
1. MAY: Tests MAY use test fixtures and factory patterns to reduce test setup boilerplate

## Policy Block

- MAY Tests MAY use test fixtures and factory patterns to reduce test setup boilerplate
