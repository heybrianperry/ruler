...
1. SHOULD: Configuration loaders SHOULD provide fallback behavior when XDG_CONFIG_HOME is not set in the environment

## Policy Block

- SHOULD Configuration loaders SHOULD provide fallback behavior when XDG_CONFIG_HOME is not set in the environment
