# Standardize Unit Testing Framework for Agent Components: Cli Handlers Command
...
1. SHOULD: CLI handlers and command-line interface components SHOULD have dedicated unit tests in `tests/unit/cli/` subdirectory

## Policy Block

- SHOULD CLI handlers and command-line interface components SHOULD have dedicated unit tests in `tests/unit/cli/` subdirectory
