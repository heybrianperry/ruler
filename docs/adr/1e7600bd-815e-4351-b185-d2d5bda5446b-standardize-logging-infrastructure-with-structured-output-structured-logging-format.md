# Standardize Logging Infrastructure with Structured Output: Structured Logging Format
...
1. SHOULD: Structured logging format SHOULD be used to enable machine-readable log parsing and aggregation

## Policy Block

- SHOULD Structured logging format SHOULD be used to enable machine-readable log parsing and aggregation
