...
1. MUST: Cache retrieval MUST use the get method with the identifier as key, checking for existence before performing expensive operations

## Policy Block

- MUST Cache retrieval MUST use the get method with the identifier as key, checking for existence before performing expensive operations
