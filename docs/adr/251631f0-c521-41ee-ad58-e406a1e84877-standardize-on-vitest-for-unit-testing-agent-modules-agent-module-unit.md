# Standardize on Vitest for Unit Testing Agent Modules: Agent Module Unit
...
1. MUST: All agent module unit tests MUST use Vitest as the testing framework

## Policy Block

- MUST All agent module unit tests MUST use Vitest as the testing framework
