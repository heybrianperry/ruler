...
1. MUST: Warning-level messages MUST use console.warn for appropriate severity signaling

## Policy Block

- MUST Warning-level messages MUST use console.warn for appropriate severity signaling
