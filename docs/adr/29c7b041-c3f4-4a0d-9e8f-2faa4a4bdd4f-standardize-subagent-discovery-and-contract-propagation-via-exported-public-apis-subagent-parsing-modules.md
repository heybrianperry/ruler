...
1. MUST: Subagent parsing modules MUST export parseFrontmatter, validateFrontmatter, and loadSubagentFile functions to enforce consistent metadata extraction from markdown files using js-yaml and @iarna/toml

## Policy Block

- MUST Subagent parsing modules MUST export parseFrontmatter, validateFrontmatter, and loadSubagentFile functions to enforce consistent metadata extraction from markdown files using js-yaml and @iarna/toml
