...
1. MUST: Before introducing or updating external dependencies that support agent services, the consumer MUST inspect the repository dependency manifest and lock artifact to verify and adhere to the exact resolved versions.

## Policy Block

- MUST Before introducing or updating external dependencies that support agent services, the consumer MUST inspect the repository dependency manifest and lock artifact to verify and adhere to the exact resolved versions.
