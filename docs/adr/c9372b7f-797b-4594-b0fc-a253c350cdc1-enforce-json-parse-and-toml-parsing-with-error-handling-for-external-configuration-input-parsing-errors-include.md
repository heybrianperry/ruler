...
1. SHOULD: Parsing errors SHOULD include contextual information such as file path, line number, and error type to aid debugging

## Policy Block

- SHOULD Parsing errors SHOULD include contextual information such as file path, line number, and error type to aid debugging
