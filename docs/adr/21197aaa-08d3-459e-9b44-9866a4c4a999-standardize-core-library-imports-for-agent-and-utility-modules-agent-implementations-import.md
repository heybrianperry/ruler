...
1. MUST: Agent implementations MUST import and implement either './IAgent' interface or extend './AbstractAgent' or './AgentsMdAgent' base classes

## Policy Block

- MUST Agent implementations MUST import and implement either './IAgent' interface or extend './AbstractAgent' or './AgentsMdAgent' base classes
