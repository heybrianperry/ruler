# Adopt Async/Await Pattern for External API Integration: Functions That Perform
...
1. MUST: Functions that perform external API calls MUST be declared as async and return Promise types

## Policy Block

- MUST Functions that perform external API calls MUST be declared as async and return Promise types
