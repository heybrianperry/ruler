...
1. MUST: Set-based deduplication MUST be applied before writing to gitignore files, MCP configuration files, or skill manifest files to ensure idempotent operations.

## Policy Block

- MUST Set-based deduplication MUST be applied before writing to gitignore files, MCP configuration files, or skill manifest files to ensure idempotent operations.
