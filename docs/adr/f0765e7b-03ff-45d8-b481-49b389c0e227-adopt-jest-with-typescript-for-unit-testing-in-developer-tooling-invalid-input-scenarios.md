# Adopt Jest with TypeScript for Unit Testing in Developer Tooling: Invalid Input Scenarios
...
1. SHOULD: Invalid input scenarios SHOULD be tested explicitly with dedicated test cases

## Policy Block

- SHOULD Invalid input scenarios SHOULD be tested explicitly with dedicated test cases
