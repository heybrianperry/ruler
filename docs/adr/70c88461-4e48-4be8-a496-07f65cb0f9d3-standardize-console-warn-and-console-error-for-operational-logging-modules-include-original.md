...
1. MAY: Modules MAY include the original error object or stack trace in console output when debugging information aids user troubleshooting

## Policy Block

- MAY Modules MAY include the original error object or stack trace in console output when debugging information aids user troubleshooting
