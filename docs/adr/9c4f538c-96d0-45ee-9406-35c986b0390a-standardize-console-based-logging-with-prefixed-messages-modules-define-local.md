...
1. MAY: Modules MAY define local prefix constants (e.g., ERROR_PREFIX) for consistent message formatting within their scope

## Policy Block

- MAY Modules MAY define local prefix constants (e.g., ERROR_PREFIX) for consistent message formatting within their scope
