...
1. MUST_NOT: Infrastructure components MUST NOT import concrete agent implementation classes for type declarations; they MUST depend only on the IAgent interface contract.

## Policy Block

- MUST_NOT Infrastructure components MUST NOT import concrete agent implementation classes for type declarations; they MUST depend only on the IAgent interface contract.
