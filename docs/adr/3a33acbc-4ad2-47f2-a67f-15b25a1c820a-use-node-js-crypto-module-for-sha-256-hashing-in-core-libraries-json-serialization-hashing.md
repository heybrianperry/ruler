...
1. MUST: JSON serialization for hashing MUST use stable ordering to ensure deterministic hash outputs

## Policy Block

- MUST JSON serialization for hashing MUST use stable ordering to ensure deterministic hash outputs
