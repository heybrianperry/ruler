...
1. MUST: The consumer MUST discover the ecosystem's lock file and resolve the exact locked version of any versioned dependency before implementation.

## Policy Block

- MUST The consumer MUST discover the ecosystem's lock file and resolve the exact locked version of any versioned dependency before implementation.
