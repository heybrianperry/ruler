# Standardize Environment Variable Configuration Management Across Agent Implementations: Agent Implementations Not
...
1. MUST_NOT: Agent implementations MUST NOT directly access process.env or equivalent environment variable APIs; all access MUST go through the configuration management layer

## Policy Block

- MUST_NOT Agent implementations MUST NOT directly access process.env or equivalent environment variable APIs; all access MUST go through the configuration management layer
