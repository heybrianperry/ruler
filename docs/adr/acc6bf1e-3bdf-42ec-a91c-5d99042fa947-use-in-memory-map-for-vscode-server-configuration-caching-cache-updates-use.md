...
1. MUST: Cache updates MUST use Map.set() operations with server.name as the key and server object as the value

## Policy Block

- MUST Cache updates MUST use Map.set() operations with server.name as the key and server object as the value
