...
1. MUST: MUST use parseTOML() when deserializing TOML content from external sources.

## Policy Block

- MUST MUST use parseTOML() when deserializing TOML content from external sources.
