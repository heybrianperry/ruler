# Adopt TypeScript with Jest/Vitest for Unit Testing Framework: Negative Test Cases
...
1. SHOULD: Negative test cases (testing invalid inputs or error conditions) SHOULD be included alongside positive test cases to ensure comprehensive coverage.

## Policy Block

- SHOULD Negative test cases (testing invalid inputs or error conditions) SHOULD be included alongside positive test cases to ensure comprehensive coverage.
