...
1. MUST: Implementations MUST discover the exact resolved version of @iarna/toml from the project's dependency lock file before writing code that uses the library

## Policy Block

- MUST Implementations MUST discover the exact resolved version of @iarna/toml from the project's dependency lock file before writing code that uses the library
