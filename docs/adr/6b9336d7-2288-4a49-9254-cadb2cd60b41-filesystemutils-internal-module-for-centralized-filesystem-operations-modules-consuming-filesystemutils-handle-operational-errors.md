...
1. MUST: Modules consuming FileSystemUtils MUST handle operational errors, including missing targets and parsing failures, cleanly without terminating the surrounding execution context.

## Policy Block

- MUST Modules consuming FileSystemUtils MUST handle operational errors, including missing targets and parsing failures, cleanly without terminating the surrounding execution context.
