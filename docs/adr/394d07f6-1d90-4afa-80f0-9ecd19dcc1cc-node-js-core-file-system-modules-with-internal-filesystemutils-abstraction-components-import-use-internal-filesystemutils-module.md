...
1. MUST: Components MUST import and use the internal FileSystemUtils module for shared file system operations that have been abstracted into that module.

## Policy Block

- MUST Components MUST import and use the internal FileSystemUtils module for shared file system operations that have been abstracted into that module.
