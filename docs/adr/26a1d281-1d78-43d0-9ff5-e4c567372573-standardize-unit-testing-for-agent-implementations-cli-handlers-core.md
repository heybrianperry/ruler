# Standardize Unit Testing for Agent Implementations: Cli Handlers Core
...
1. MUST: CLI handlers and core functionality MUST have dedicated unit test files in tests/unit/cli/ and tests/unit/ directories respectively

## Policy Block

- MUST CLI handlers and core functionality MUST have dedicated unit test files in tests/unit/cli/ and tests/unit/ directories respectively
