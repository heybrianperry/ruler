...
1. SHOULD: Configuration loaders SHOULD allow JSON.parse to throw SyntaxError exceptions for malformed JSON, propagating parse failures to calling code for appropriate error handling

## Policy Block

- SHOULD Configuration loaders SHOULD allow JSON.parse to throw SyntaxError exceptions for malformed JSON, propagating parse failures to calling code for appropriate error handling
