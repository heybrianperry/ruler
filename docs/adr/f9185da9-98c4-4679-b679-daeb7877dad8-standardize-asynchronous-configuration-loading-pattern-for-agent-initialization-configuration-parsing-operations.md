...
1. MUST: Configuration parsing operations (JSON.parse, js-yaml, @iarna/toml) MUST occur after awaiting filesystem read operations

## Policy Block

- MUST Configuration parsing operations (JSON.parse, js-yaml, @iarna/toml) MUST occur after awaiting filesystem read operations
