# Standardize Public API Export Patterns for External Integration: Public Use Explicit
...
1. SHOULD: Public APIs SHOULD use explicit export statements to clearly document the intended public interface surface

## Policy Block

- SHOULD Public APIs SHOULD use explicit export statements to clearly document the intended public interface surface
