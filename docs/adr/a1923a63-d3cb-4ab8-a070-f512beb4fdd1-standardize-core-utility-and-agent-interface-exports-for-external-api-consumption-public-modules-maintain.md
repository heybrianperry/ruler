# Standardize Core Utility and Agent Interface Exports for External API Consumption: Public Modules Maintain
...
1. MUST: Public API modules MUST maintain semantic versioning and provide deprecation notices at least one major version before removing functionality

## Policy Block

- MUST Public API modules MUST maintain semantic versioning and provide deprecation notices at least one major version before removing functionality
