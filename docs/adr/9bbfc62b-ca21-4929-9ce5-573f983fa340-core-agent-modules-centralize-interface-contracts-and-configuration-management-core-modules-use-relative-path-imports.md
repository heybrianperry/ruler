...
1. SHOULD: Core modules SHOULD use relative path imports to establish explicit dependency relationships between components

## Policy Block

- SHOULD Core modules SHOULD use relative path imports to establish explicit dependency relationships between components
