...
1. SHOULD: Configuration file parsing SHOULD separate file reading (using core modules) from format-specific parsing (using appropriate parser libraries) to maintain clear separation of concerns

## Policy Block

- SHOULD Configuration file parsing SHOULD separate file reading (using core modules) from format-specific parsing (using appropriate parser libraries) to maintain clear separation of concerns
