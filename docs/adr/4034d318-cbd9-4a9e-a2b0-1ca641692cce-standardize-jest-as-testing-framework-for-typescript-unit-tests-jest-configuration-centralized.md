# Standardize Jest as Testing Framework for TypeScript Unit Tests: Jest Configuration Centralized
...
1. SHOULD: Jest configuration SHOULD be centralized in a jest.config.js or jest.config.ts file at the project root

## Policy Block

- SHOULD Jest configuration SHOULD be centralized in a jest.config.js or jest.config.ts file at the project root
