...
1. MUST: Collection operations MUST occur during file parsing and discovery phases before propagation to downstream consumers

## Policy Block

- MUST Collection operations MUST occur during file parsing and discovery phases before propagation to downstream consumers
