# Standardize Agent Architecture with External API Integration Pattern: Agent Implementations Extend
...
1. MAY: Agent implementations MAY extend or compose shared base agent functionality for common patterns

## Policy Block

- MAY Agent implementations MAY extend or compose shared base agent functionality for common patterns
