...
1. MUST: The sha256 and stableJson functions MUST be exposed as public API contracts in core library

## Policy Block

- MUST The sha256 and stableJson functions MUST be exposed as public API contracts in core library
