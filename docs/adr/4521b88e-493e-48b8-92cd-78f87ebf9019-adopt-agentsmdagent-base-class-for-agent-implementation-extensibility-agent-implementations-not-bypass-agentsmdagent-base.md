...
1. MUST_NOT: Agent implementations MUST NOT bypass the AgentsMdAgent base class by implementing agents from scratch, as this breaks architectural consistency and duplicates shared functionality.

## Policy Block

- MUST_NOT Agent implementations MUST NOT bypass the AgentsMdAgent base class by implementing agents from scratch, as this breaks architectural consistency and duplicates shared functionality.
