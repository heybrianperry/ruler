...
1. SHOULD: File system utility functions SHOULD be centralized in dedicated modules (FileSystemUtils, SkillsUtils) and exported as public contracts for reuse across agents

## Policy Block

- SHOULD File system utility functions SHOULD be centralized in dedicated modules (FileSystemUtils, SkillsUtils) and exported as public contracts for reuse across agents
