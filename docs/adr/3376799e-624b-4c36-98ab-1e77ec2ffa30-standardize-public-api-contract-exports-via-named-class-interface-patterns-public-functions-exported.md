...
1. SHOULD: Public API functions SHOULD be exported as named exports rather than default exports to improve discoverability and refactoring safety.

## Policy Block

- SHOULD Public API functions SHOULD be exported as named exports rather than default exports to improve discoverability and refactoring safety.
