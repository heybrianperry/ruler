...
1. MUST: File system operations MUST use the 'fs' or 'fs/promises' core modules for all file and directory access, including reading, writing, and metadata operations

## Policy Block

- MUST File system operations MUST use the 'fs' or 'fs/promises' core modules for all file and directory access, including reading, writing, and metadata operations
