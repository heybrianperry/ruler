...
1. MAY: Components MAY extend Set-based boundaries to other processing workflows where deduplication and idempotency are required

## Policy Block

- MAY Components MAY extend Set-based boundaries to other processing workflows where deduplication and idempotency are required
