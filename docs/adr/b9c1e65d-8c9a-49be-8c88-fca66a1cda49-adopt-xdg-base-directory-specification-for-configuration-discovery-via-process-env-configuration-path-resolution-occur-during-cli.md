...
1. SHOULD: Configuration path resolution SHOULD occur during CLI handler initialization before command processing begins

## Policy Block

- SHOULD Configuration path resolution SHOULD occur during CLI handler initialization before command processing begins
