# Standardize TypeScript Type Definitions for Public API Contracts: Agent Implementations Implement
...
1. MUST: Agent implementations MUST implement or extend the standardized type definitions from core type files rather than defining ad-hoc interfaces

## Policy Block

- MUST Agent implementations MUST implement or extend the standardized type definitions from core type files rather than defining ad-hoc interfaces
