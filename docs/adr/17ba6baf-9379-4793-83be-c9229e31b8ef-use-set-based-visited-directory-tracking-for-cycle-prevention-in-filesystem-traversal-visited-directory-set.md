...
1. MAY: The visited directory set MAY be scoped to individual traversal operations or shared across related operations depending on use case requirements

## Policy Block

- MAY The visited directory set MAY be scoped to individual traversal operations or shared across related operations depending on use case requirements
