...
1. SHOULD: Diagnostic and configuration result lookups SHOULD use Array.find() with code or identifier matching patterns

## Policy Block

- SHOULD Diagnostic and configuration result lookups SHOULD use Array.find() with code or identifier matching patterns
