# Adopt TypeScript-based Unit Testing Framework for Agent and CLI Components: Each Agent Implementation
...
1. MUST: Each agent implementation MUST have a corresponding unit test file in tests/unit/agents/ following the naming pattern {AgentName}.test.ts.

## Policy Block

- MUST Each agent implementation MUST have a corresponding unit test file in tests/unit/agents/ following the naming pattern {AgentName}.test.ts.
