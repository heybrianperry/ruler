...
1. MUST: Public API contracts MUST include VSCodeSettings, AugmentMcpServer types and readVSCodeSettings, writeVSCodeSettings functions

## Policy Block

- MUST Public API contracts MUST include VSCodeSettings, AugmentMcpServer types and readVSCodeSettings, writeVSCodeSettings functions
