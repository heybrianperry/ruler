# Adopt TypeScript Test Files with .test.ts Extension as Standard Testing Convention: Test File Names
...
1. MUST: Test file names MUST clearly indicate the module or component under test (e.g., agent-utils.test.ts for agent-utils module)

## Policy Block

- MUST Test file names MUST clearly indicate the module or component under test (e.g., agent-utils.test.ts for agent-utils module)
