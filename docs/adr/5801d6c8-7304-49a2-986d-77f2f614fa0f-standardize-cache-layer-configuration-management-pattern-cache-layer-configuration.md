...
1. SHOULD: Cache layer configuration SHOULD be validated at initialization time to detect misconfigurations early

## Policy Block

- SHOULD Cache layer configuration SHOULD be validated at initialization time to detect misconfigurations early
