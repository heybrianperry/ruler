...
1. SHOULD: Use server name as the Map key for STDIO transports and URL as the key for SSE/SHTTP transports

## Policy Block

- SHOULD Use server name as the Map key for STDIO transports and URL as the key for SSE/SHTTP transports
