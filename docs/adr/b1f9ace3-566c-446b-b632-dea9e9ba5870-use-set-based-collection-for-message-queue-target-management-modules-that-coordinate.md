...
1. SHOULD: Modules that coordinate subagent processing SHOULD separate concerns between discovery (SubagentsProcessor) and utility operations (SubagentsUtils)

## Policy Block

- SHOULD Modules that coordinate subagent processing SHOULD separate concerns between discovery (SubagentsProcessor) and utility operations (SubagentsUtils)
