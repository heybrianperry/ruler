...
1. MUST: Path manipulation operations MUST use the 'path' core module to ensure cross-platform compatibility

## Policy Block

- MUST Path manipulation operations MUST use the 'path' core module to ensure cross-platform compatibility
