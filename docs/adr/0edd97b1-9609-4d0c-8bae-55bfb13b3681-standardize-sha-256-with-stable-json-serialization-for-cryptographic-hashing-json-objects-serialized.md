...
1. MUST: All JSON objects MUST be serialized using stable JSON serialization (deterministic property ordering) before hashing

## Policy Block

- MUST All JSON objects MUST be serialized using stable JSON serialization (deterministic property ordering) before hashing
