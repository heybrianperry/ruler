...
1. MUST: Before implementing changes involving versioned configuration parsing or schema validation libraries, the consumer MUST inspect the repository lock artifact to determine the exact resolved dependency versions and verify API compatibility against official documentation.

## Policy Block

- MUST Before implementing changes involving versioned configuration parsing or schema validation libraries, the consumer MUST inspect the repository lock artifact to determine the exact resolved dependency versions and verify API compatibility against official documentation.
