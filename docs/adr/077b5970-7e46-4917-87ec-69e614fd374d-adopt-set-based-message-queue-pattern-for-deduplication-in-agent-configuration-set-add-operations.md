...
1. SHOULD: Set.add() operations SHOULD occur immediately upon path or identifier discovery to minimize the window for duplicate processing.

## Policy Block

- SHOULD Set.add() operations SHOULD occur immediately upon path or identifier discovery to minimize the window for duplicate processing.
