...
1. MUST_NOT: Operational code MUST NOT emit unformatted, unstructured raw objects to standard console streams where downstream consumers expect clean command output.

## Policy Block

- MUST_NOT Operational code MUST NOT emit unformatted, unstructured raw objects to standard console streams where downstream consumers expect clean command output.
