...
1. MUST: Agent implementations MUST import core dependencies (path, fs, fs/promises) for file system operations rather than implementing custom file handling

## Policy Block

- MUST Agent implementations MUST import core dependencies (path, fs, fs/promises) for file system operations rather than implementing custom file handling
