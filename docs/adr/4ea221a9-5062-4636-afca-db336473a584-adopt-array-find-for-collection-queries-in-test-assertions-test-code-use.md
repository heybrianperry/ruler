...
1. MUST: Test code MUST use Array.find() with predicate functions when querying collections to locate a single matching entity

## Policy Block

- MUST Test code MUST use Array.find() with predicate functions when querying collections to locate a single matching entity
