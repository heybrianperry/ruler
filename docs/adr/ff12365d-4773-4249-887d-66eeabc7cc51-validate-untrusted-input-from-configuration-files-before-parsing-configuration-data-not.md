...
1. MUST_NOT: Configuration data MUST NOT be passed to downstream APIs or stored in cache layers without successful validation

## Policy Block

- MUST_NOT Configuration data MUST NOT be passed to downstream APIs or stored in cache layers without successful validation
