...
1. MUST: Configuration loaders MUST support multiple configuration sources with a defined precedence order: CLI arguments > environment variables > TOML configuration files > defaults

## Policy Block

- MUST Configuration loaders MUST support multiple configuration sources with a defined precedence order: CLI arguments > environment variables > TOML configuration files > defaults
