# Standardize Test Configuration and MCP Integration Testing Patterns: Core Engine Components
...
1. MUST: Core engine components (e.g., apply-engine) MUST have comprehensive unit test coverage

## Policy Block

- MUST Core engine components (e.g., apply-engine) MUST have comprehensive unit test coverage
