...
1. MUST_NOT: Configuration application functions MUST NOT allow duplicate MCP server keys within a single agent's configuration scope

## Policy Block

- MUST_NOT Configuration application functions MUST NOT allow duplicate MCP server keys within a single agent's configuration scope
