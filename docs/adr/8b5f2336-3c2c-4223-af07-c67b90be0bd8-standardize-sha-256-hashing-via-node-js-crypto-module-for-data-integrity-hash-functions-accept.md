...
1. MUST: Hash functions MUST accept input data in a normalized form to ensure deterministic output

## Policy Block

- MUST Hash functions MUST accept input data in a normalized form to ensure deterministic output
