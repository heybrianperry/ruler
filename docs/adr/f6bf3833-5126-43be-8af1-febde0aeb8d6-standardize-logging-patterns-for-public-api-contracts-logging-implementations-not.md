# Standardize Logging Patterns for Public API Contracts: Logging Implementations Not
...
1. MUST_NOT: Logging implementations MUST NOT include sensitive information such as credentials, tokens, or personally identifiable information (PII) in log output

## Policy Block

- MUST_NOT Logging implementations MUST NOT include sensitive information such as credentials, tokens, or personally identifiable information (PII) in log output
