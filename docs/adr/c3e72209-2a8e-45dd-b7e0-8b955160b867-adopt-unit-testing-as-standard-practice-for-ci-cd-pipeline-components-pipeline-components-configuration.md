# Adopt Unit Testing as Standard Practice for CI/CD Pipeline Components: Pipeline Components Configuration
...
1. MUST: All CI/CD pipeline components, configuration parsers, and agent implementations MUST have corresponding unit tests

## Policy Block

- MUST All CI/CD pipeline components, configuration parsers, and agent implementations MUST have corresponding unit tests
