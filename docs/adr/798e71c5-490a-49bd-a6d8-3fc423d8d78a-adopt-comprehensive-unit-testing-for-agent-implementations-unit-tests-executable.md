# Adopt Comprehensive Unit Testing for Agent Implementations: Unit Tests Executable
...
1. MUST: All unit tests MUST be executable independently without requiring external dependencies or services

## Policy Block

- MUST All unit tests MUST be executable independently without requiring external dependencies or services
