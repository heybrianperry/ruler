...
1. SHOULD: Zod schemas SHOULD be colocated with the modules that consume the validated data, maintaining clear ownership and discoverability

## Policy Block

- SHOULD Zod schemas SHOULD be colocated with the modules that consume the validated data, maintaining clear ownership and discoverability
