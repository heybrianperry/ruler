# Adopt TypeScript-based Unit Testing Framework for Agent and CLI Components: Tests Leverage Typescript
...
1. SHOULD: Tests SHOULD leverage TypeScript's type system to catch type-related errors at test development time.

## Policy Block

- SHOULD Tests SHOULD leverage TypeScript's type system to catch type-related errors at test development time.
