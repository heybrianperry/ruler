...
1. SHOULD: Agent implementations SHOULD import core dependencies (path, fs, fs/promises) through explicit module declarations

## Policy Block

- SHOULD Agent implementations SHOULD import core dependencies (path, fs, fs/promises) through explicit module declarations
