...
1. MUST: All path construction, resolution, and manipulation operations MUST use the 'path' core module to ensure cross-platform compatibility.

## Policy Block

- MUST All path construction, resolution, and manipulation operations MUST use the 'path' core module to ensure cross-platform compatibility.
