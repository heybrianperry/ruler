...
1. SHOULD: Cache instances SHOULD be scoped to the function execution context and not persisted beyond the configuration operation lifecycle

## Policy Block

- SHOULD Cache instances SHOULD be scoped to the function execution context and not persisted beyond the configuration operation lifecycle
