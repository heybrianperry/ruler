...
1. MUST: Agent modules MUST use console.warn to log configuration file read or parse errors that do not prevent agent initialization

## Policy Block

- MUST Agent modules MUST use console.warn to log configuration file read or parse errors that do not prevent agent initialization
