# Standardize Unit Testing for Agent Implementations: Cli Handler Modules
...
1. MUST: CLI handler modules MUST have corresponding unit test files located in tests/unit/cli/ following the naming pattern {module}.test.ts

## Policy Block

- MUST CLI handler modules MUST have corresponding unit test files located in tests/unit/cli/ following the naming pattern {module}.test.ts
