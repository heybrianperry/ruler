...
1. MUST: All critical errors that prevent CLI command execution or agent initialization MUST be reported using console.error with a user-facing error message

## Policy Block

- MUST All critical errors that prevent CLI command execution or agent initialization MUST be reported using console.error with a user-facing error message
