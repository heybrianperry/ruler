...
1. MUST: New agent types added to the agents subsystem MUST conform to the interface contract established by AgentsMdAgent.

## Policy Block

- MUST New agent types added to the agents subsystem MUST conform to the interface contract established by AgentsMdAgent.
