...
1. MUST: All modules that locate configuration files MUST use a consistent XDG-aware path resolution mechanism rather than hardcoded paths

## Policy Block

- MUST All modules that locate configuration files MUST use a consistent XDG-aware path resolution mechanism rather than hardcoded paths
