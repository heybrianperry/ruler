...
1. SHOULD: Test descriptions in describe and it blocks SHOULD use natural language that describes behavior rather than implementation details

## Policy Block

- SHOULD Test descriptions in describe and it blocks SHOULD use natural language that describes behavior rather than implementation details
