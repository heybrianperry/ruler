...
1. SHOULD: Agent implementations SHOULD import from AgentsMdAgent when extending base agent functionality

## Policy Block

- SHOULD Agent implementations SHOULD import from AgentsMdAgent when extending base agent functionality
