...
1. SHOULD: Recursive directory operations (walk, copyRecursive) SHOULD use async iteration patterns to avoid blocking the event loop during deep traversals

## Policy Block

- SHOULD Recursive directory operations (walk, copyRecursive) SHOULD use async iteration patterns to avoid blocking the event loop during deep traversals
