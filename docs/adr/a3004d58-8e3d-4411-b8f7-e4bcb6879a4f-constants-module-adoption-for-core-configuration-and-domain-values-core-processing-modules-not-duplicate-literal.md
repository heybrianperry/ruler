...
1. MUST_NOT: Core processing modules MUST NOT duplicate literal values for system-wide configuration keys, environment variable references, or default operational thresholds across module boundaries.

## Policy Block

- MUST_NOT Core processing modules MUST NOT duplicate literal values for system-wide configuration keys, environment variable references, or default operational thresholds across module boundaries.
