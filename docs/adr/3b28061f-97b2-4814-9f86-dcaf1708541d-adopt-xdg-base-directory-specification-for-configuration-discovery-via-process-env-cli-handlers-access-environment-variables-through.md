...
1. MUST: CLI handlers MUST access environment variables through the Node.js process.env API rather than alternative configuration sources

## Policy Block

- MUST CLI handlers MUST access environment variables through the Node.js process.env API rather than alternative configuration sources
