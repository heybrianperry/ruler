# Standardize Environment-Aware Configuration Loading with Unified Path Resolution: Configuration Sources Prioritized
...
1. MUST: Configuration sources MUST be prioritized in a consistent order: explicit parameters > environment variables > config files > defaults

## Policy Block

- MUST Configuration sources MUST be prioritized in a consistent order: explicit parameters > environment variables > config files > defaults
