...
1. SHOULD: Implementations SHOULD utilize linear collection scanning exclusively for bounded collections where linear traversal overhead is negligible.

## Policy Block

- SHOULD Implementations SHOULD utilize linear collection scanning exclusively for bounded collections where linear traversal overhead is negligible.
