# Standardize Logging Infrastructure with Structured Output: Logging Infrastructure Support
...
1. SHOULD: Logging infrastructure SHOULD support structured logging formats (JSON or similar) to enable automated log parsing and analysis

## Policy Block

- SHOULD Logging infrastructure SHOULD support structured logging formats (JSON or similar) to enable automated log parsing and analysis
