# Standardize Jest as Testing Framework for TypeScript Unit Tests: Typescript Unit Test
...
1. MUST: All TypeScript unit test files MUST use Jest as the testing framework and follow the .test.ts naming convention

## Policy Block

- MUST All TypeScript unit test files MUST use Jest as the testing framework and follow the .test.ts naming convention
