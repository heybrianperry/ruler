...
1. SHOULD: When logging caught exceptions, the error object SHOULD be passed as an additional argument to console methods for stack trace preservation

## Policy Block

- SHOULD When logging caught exceptions, the error object SHOULD be passed as an additional argument to console methods for stack trace preservation
