# Adopt TypeScript with Jest/Vitest for Unit Testing Framework: Unit Test Files
...
1. MUST: All unit test files MUST use the .test.ts extension to enable automatic test discovery and execution by the test runner.

## Policy Block

- MUST All unit test files MUST use the .test.ts extension to enable automatic test discovery and execution by the test runner.
