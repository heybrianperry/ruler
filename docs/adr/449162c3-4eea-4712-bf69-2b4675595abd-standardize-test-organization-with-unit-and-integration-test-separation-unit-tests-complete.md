# Standardize Test Organization with Unit and Integration Test Separation: Unit Tests Complete
...
1. SHOULD: Unit tests SHOULD complete execution in milliseconds, while integration tests MAY take seconds

## Policy Block

- SHOULD Unit tests SHOULD complete execution in milliseconds, while integration tests MAY take seconds
