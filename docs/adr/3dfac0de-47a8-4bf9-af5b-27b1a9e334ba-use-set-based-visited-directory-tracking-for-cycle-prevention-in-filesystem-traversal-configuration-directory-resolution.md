...
1. SHOULD: Configuration directory resolution SHOULD check environment variables like XDG_CONFIG_HOME before falling back to default paths

## Policy Block

- SHOULD Configuration directory resolution SHOULD check environment variables like XDG_CONFIG_HOME before falling back to default paths
