...
1. SHOULD: New infrastructure components that interact with agents SHOULD follow the established pattern of co-importing IAgent alongside related infrastructure modules such as configuration loaders and utility functions.

## Policy Block

- SHOULD New infrastructure components that interact with agents SHOULD follow the established pattern of co-importing IAgent alongside related infrastructure modules such as configuration loaders and utility functions.
