...
1. MUST_NOT: Console logging MUST NOT be used for high-frequency operations or performance-critical paths where output volume would degrade system performance

## Policy Block

- MUST_NOT Console logging MUST NOT be used for high-frequency operations or performance-critical paths where output volume would degrade system performance
