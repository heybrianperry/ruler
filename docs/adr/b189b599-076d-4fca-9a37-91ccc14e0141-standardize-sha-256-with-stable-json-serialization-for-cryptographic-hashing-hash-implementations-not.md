...
1. MUST_NOT: Hash implementations MUST NOT use weaker algorithms (MD5, SHA-1) for cryptographic purposes

## Policy Block

- MUST_NOT Hash implementations MUST NOT use weaker algorithms (MD5, SHA-1) for cryptographic purposes
