# Standardize Test File Naming and Organization for CI/CD Integration: Integration Tests Include
...
1. SHOULD: Integration tests SHOULD include the suffix .integration.test.ts to distinguish them from unit tests when both exist for the same component

## Policy Block

- SHOULD Integration tests SHOULD include the suffix .integration.test.ts to distinguish them from unit tests when both exist for the same component
