# Standardize Structured Logging with Consistent Format and Levels: Logging Implementations Not
...
1. MUST_NOT: Logging implementations MUST NOT log sensitive information such as credentials, tokens, or personally identifiable information (PII)

## Policy Block

- MUST_NOT Logging implementations MUST NOT log sensitive information such as credentials, tokens, or personally identifiable information (PII)
