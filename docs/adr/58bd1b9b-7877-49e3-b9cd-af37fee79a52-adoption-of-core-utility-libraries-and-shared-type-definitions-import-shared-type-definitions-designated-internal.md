...
1. MUST: MUST import shared type definitions from the designated internal module to ensure type consistency across the codebase.

## Policy Block

- MUST MUST import shared type definitions from the designated internal module to ensure type consistency across the codebase.
