# Standardize on Vitest for Unit Testing Agent Modules: Agent Tests Use
...
1. MAY: Agent tests MAY use Vitest's snapshot testing features for complex output validation

## Policy Block

- MAY Agent tests MAY use Vitest's snapshot testing features for complex output validation
