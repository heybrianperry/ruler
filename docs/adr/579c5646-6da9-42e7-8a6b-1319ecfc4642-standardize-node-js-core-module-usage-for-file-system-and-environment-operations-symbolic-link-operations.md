...
1. MUST: Symbolic link operations MUST be explicitly handled with checks to prevent directory traversal vulnerabilities and ensure containment within expected root directories

## Policy Block

- MUST Symbolic link operations MUST be explicitly handled with checks to prevent directory traversal vulnerabilities and ensure containment within expected root directories
