...
1. MUST: JSON parsing of file contents MUST use native JSON.parse() after reading file content as text.

## Policy Block

- MUST JSON parsing of file contents MUST use native JSON.parse() after reading file content as text.
