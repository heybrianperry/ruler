...
1. MUST: Set-based collections MUST be used at boundaries where multiple sources contribute to a single collection (e.g., configuration keys, skill targets, file paths)

## Policy Block

- MUST Set-based collections MUST be used at boundaries where multiple sources contribute to a single collection (e.g., configuration keys, skill targets, file paths)
