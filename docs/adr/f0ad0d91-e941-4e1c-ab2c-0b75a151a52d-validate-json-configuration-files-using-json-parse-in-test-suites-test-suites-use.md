...
1. MUST: Test suites MUST use JSON.parse to validate JSON configuration files read from the filesystem before making assertions on their content

## Policy Block

- MUST Test suites MUST use JSON.parse to validate JSON configuration files read from the filesystem before making assertions on their content
