...
1. MUST: Configuration discovery logic MUST read process.env.XDG_CONFIG_HOME as the primary source for user-level configuration directory paths

## Policy Block

- MUST Configuration discovery logic MUST read process.env.XDG_CONFIG_HOME as the primary source for user-level configuration directory paths
