# Standardize TypeScript Module Exports for Public Agent APIs: Agent Implementations Export
...
1. MUST: All agent implementations MUST export their primary class as a named export from their module file

## Policy Block

- MUST All agent implementations MUST export their primary class as a named export from their module file
