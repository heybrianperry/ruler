# Adopt Unit Testing for CI/CD Pipeline Components: Changes Components Not
...
1. MUST: Changes to CI/CD components MUST NOT be merged without passing unit tests to prevent pipeline regressions

## Policy Block

- MUST Changes to CI/CD components MUST NOT be merged without passing unit tests to prevent pipeline regressions
