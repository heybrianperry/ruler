...
1. MUST: Test assertions MUST use the expect API with appropriate matchers (toBe, toEqual, toContain, toBeDefined, etc.) for clear failure messages

## Policy Block

- MUST Test assertions MUST use the expect API with appropriate matchers (toBe, toEqual, toContain, toBeDefined, etc.) for clear failure messages
