...
1. SHOULD: Components SHOULD use descriptive Set variable names (seen, targets) that clearly indicate the boundary purpose and scope

## Policy Block

- SHOULD Components SHOULD use descriptive Set variable names (seen, targets) that clearly indicate the boundary purpose and scope
