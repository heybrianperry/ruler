...
1. MUST: Parsing functions MUST be invoked immediately after reading file content and before any find(), filter(), or property access operations

## Policy Block

- MUST Parsing functions MUST be invoked immediately after reading file content and before any find(), filter(), or property access operations
