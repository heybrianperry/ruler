...
1. MUST: The sha256 and stableJson functions MUST be exposed as public API contracts from src/core/hash.ts

## Policy Block

- MUST The sha256 and stableJson functions MUST be exposed as public API contracts from src/core/hash.ts
