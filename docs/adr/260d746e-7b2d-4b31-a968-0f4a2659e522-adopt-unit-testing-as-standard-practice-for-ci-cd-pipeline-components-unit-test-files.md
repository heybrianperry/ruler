# Adopt Unit Testing as Standard Practice for CI/CD Pipeline Components: Unit Test Files
...
1. MUST: Unit test files MUST follow the naming convention *.test.ts and be placed in the tests/unit/ or tests/integration/ directories based on their scope

## Policy Block

- MUST Unit test files MUST follow the naming convention *.test.ts and be placed in the tests/unit/ or tests/integration/ directories based on their scope
