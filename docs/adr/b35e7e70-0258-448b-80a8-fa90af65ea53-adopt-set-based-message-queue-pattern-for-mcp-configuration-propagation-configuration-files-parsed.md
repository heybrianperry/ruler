...
1. MUST: Configuration files MUST be parsed using JSON.parse before extracting existing server definitions or configuration state

## Policy Block

- MUST Configuration files MUST be parsed using JSON.parse before extracting existing server definitions or configuration state
