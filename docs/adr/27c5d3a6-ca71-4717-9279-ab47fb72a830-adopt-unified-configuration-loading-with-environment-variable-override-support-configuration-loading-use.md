# Adopt Unified Configuration Loading with Environment Variable Override Support: Configuration Loading Use
...
1. MUST: All configuration loading MUST use a unified configuration loader that supports multiple input sources (TOML files, environment variables, programmatic options)

## Policy Block

- MUST All configuration loading MUST use a unified configuration loader that supports multiple input sources (TOML files, environment variables, programmatic options)
