...
1. MUST: Before implementing any code that invokes parsing library APIs, developers MUST discover the project's dependency lock artifact, resolve the exact installed version of each parsing library, and verify API compatibility against that version's official documentation

## Policy Block

- MUST Before implementing any code that invokes parsing library APIs, developers MUST discover the project's dependency lock artifact, resolve the exact installed version of each parsing library, and verify API compatibility against that version's official documentation
