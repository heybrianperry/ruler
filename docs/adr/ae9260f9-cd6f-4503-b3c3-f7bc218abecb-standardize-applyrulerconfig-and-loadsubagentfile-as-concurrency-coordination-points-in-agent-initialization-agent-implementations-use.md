...
1. MUST: Agent implementations MUST use applyRulerConfig as the designated concurrency coordination point for applying rule-based configuration during initialization

## Policy Block

- MUST Agent implementations MUST use applyRulerConfig as the designated concurrency coordination point for applying rule-based configuration during initialization
