# Standardize Structured Logging with Contextual Metadata: Modules Extend Base
...
1. MAY: Modules MAY extend the base logging schema with domain-specific metadata fields relevant to their operational context

## Policy Block

- MAY Modules MAY extend the base logging schema with domain-specific metadata fields relevant to their operational context
