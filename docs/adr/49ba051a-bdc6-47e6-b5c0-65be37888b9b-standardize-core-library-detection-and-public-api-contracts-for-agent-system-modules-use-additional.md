...
1. MAY: Modules MAY use additional libraries (e.g., @iarna/toml for TOML parsing) when required for specific format support, provided they expose consistent public contracts

## Policy Block

- MAY Modules MAY use additional libraries (e.g., @iarna/toml for TOML parsing) when required for specific format support, provided they expose consistent public contracts
