# Standardize Logging Patterns for Public API Contracts: File System Operations
...
1. MUST: File system operations MUST log errors with full path context, operation type, and error details to support troubleshooting

## Policy Block

- MUST File system operations MUST log errors with full path context, operation type, and error details to support troubleshooting
