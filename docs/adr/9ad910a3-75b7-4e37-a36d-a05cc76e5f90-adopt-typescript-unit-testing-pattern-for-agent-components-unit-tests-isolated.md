# Adopt TypeScript Unit Testing Pattern for Agent Components: Unit Tests Isolated
...
1. MUST: Unit tests MUST be isolated from integration tests and placed in the tests/unit/ directory hierarchy

## Policy Block

- MUST Unit tests MUST be isolated from integration tests and placed in the tests/unit/ directory hierarchy
