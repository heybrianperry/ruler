# Standardize Test Organization with Unit and Integration Test Separation: Pipelines Run Unit
...
1. SHOULD: CI/CD pipelines SHOULD run unit tests before integration tests to provide faster feedback on basic functionality failures

## Policy Block

- SHOULD CI/CD pipelines SHOULD run unit tests before integration tests to provide faster feedback on basic functionality failures
