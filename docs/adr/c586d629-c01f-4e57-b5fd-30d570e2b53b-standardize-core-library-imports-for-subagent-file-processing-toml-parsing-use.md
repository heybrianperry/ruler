...
1. MUST: TOML parsing MUST use the '@iarna/toml' library when processing TOML-formatted subagent configurations

## Policy Block

- MUST TOML parsing MUST use the '@iarna/toml' library when processing TOML-formatted subagent configurations
