...
1. MUST: Implement a Map-based cache indexed by ruler directory paths at the service boundary between configuration loading and agent resolution subsystems

## Policy Block

- MUST Implement a Map-based cache indexed by ruler directory paths at the service boundary between configuration loading and agent resolution subsystems
