...
1. MUST: Agent utility functions MUST accept IAgent interface types rather than concrete implementations to maintain polymorphism

## Policy Block

- MUST Agent utility functions MUST accept IAgent interface types rather than concrete implementations to maintain polymorphism
