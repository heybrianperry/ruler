...
1. MAY: Agent implementations MAY export additional helper functions or types specific to their domain

## Policy Block

- MAY Agent implementations MAY export additional helper functions or types specific to their domain
