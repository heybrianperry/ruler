...
1. SHOULD: Public contracts that expose target collections SHOULD return immutable views or copies to prevent external mutation

## Policy Block

- SHOULD Public contracts that expose target collections SHOULD return immutable views or copies to prevent external mutation
