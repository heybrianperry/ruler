# Standardize Public API Export Patterns for Agent Integration: Agent Implementations Export
...
1. MUST: All agent implementations MUST export a primary class or interface that implements a common agent contract

## Policy Block

- MUST All agent implementations MUST export a primary class or interface that implements a common agent contract
