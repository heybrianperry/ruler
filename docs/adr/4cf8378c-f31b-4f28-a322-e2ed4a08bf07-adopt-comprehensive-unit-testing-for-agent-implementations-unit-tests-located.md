# Adopt Comprehensive Unit Testing for Agent Implementations: Unit Tests Located
...
1. MUST: Unit tests MUST be located in the `tests/unit/agents/` directory for agent implementations and `tests/unit/cli/` for CLI handlers

## Policy Block

- MUST Unit tests MUST be located in the `tests/unit/agents/` directory for agent implementations and `tests/unit/cli/` for CLI handlers
