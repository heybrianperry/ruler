# Standardize Logging Infrastructure with Structured Output: Modules Use Centralized
...
1. MUST: All modules MUST use a centralized logging infrastructure rather than direct console output or custom logging implementations

## Policy Block

- MUST All modules MUST use a centralized logging infrastructure rather than direct console output or custom logging implementations
