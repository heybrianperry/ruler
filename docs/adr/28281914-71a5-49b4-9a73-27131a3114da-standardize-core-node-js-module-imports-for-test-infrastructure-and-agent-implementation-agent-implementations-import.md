...
1. MUST: Agent implementations MUST import core modules ('path', 'fs') when implementing applyRulerConfig or configuration management methods.

## Policy Block

- MUST Agent implementations MUST import core modules ('path', 'fs') when implementing applyRulerConfig or configuration management methods.
