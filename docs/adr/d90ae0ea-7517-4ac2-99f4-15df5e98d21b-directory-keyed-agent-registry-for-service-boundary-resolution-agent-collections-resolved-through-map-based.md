...
1. MUST: Agent collections MUST be resolved through a Map-based registry that associates configuration directory identifiers with selected agent collections

## Policy Block

- MUST Agent collections MUST be resolved through a Map-based registry that associates configuration directory identifiers with selected agent collections
