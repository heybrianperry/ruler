...
1. MAY: Configuration modules MAY implement caching to avoid repeated process.env lookups for the same variable

## Policy Block

- MAY Configuration modules MAY implement caching to avoid repeated process.env lookups for the same variable
