...
1. MUST: TOML parsing operations MUST use the @iarna/toml library via parseTOML function calls

## Policy Block

- MUST TOML parsing operations MUST use the @iarna/toml library via parseTOML function calls
