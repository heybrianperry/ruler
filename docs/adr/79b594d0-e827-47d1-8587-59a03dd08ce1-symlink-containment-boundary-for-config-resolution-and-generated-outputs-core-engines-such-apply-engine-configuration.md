...
1. MUST_NOT: Core engines (such as apply-engine) and configuration loaders MUST NOT bypass FileSystemUtils containment guards to perform unconstrained path traversals.

## Policy Block

- MUST_NOT Core engines (such as apply-engine) and configuration loaders MUST NOT bypass FileSystemUtils containment guards to perform unconstrained path traversals.
