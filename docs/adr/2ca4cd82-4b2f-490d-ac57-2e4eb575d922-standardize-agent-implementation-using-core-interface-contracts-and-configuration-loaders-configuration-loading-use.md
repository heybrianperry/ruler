...
1. MUST: Configuration loading MUST use UnifiedConfigLoader with appropriate parsers (JSON.parse for JSON, parseTOML from @iarna/toml for TOML) to ensure consistent validation

## Policy Block

- MUST Configuration loading MUST use UnifiedConfigLoader with appropriate parsers (JSON.parse for JSON, parseTOML from @iarna/toml for TOML) to ensure consistent validation
