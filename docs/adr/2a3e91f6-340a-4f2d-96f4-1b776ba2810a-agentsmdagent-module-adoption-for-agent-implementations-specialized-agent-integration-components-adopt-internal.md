...
1. MUST: All specialized agent integration components MUST adopt the internal AgentsMdAgent module as their core base implementation for managing agent configuration documents and operational workflows.

## Policy Block

- MUST All specialized agent integration components MUST adopt the internal AgentsMdAgent module as their core base implementation for managing agent configuration documents and operational workflows.
