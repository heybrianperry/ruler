...
1. MAY: Components MAY employ asynchronous stream interfaces when streaming file contents that exceed standard memory buffer limits.

## Policy Block

- MAY Components MAY employ asynchronous stream interfaces when streaming file contents that exceed standard memory buffer limits.
