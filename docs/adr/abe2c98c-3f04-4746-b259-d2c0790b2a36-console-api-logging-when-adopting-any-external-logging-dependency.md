...
1. MUST: When adopting any external logging dependency or versioned telemetry library, the consumer MUST inspect the repository lock or resolution artifact to determine the exact resolved version before implementation.

## Policy Block

- MUST When adopting any external logging dependency or versioned telemetry library, the consumer MUST inspect the repository lock or resolution artifact to determine the exact resolved version before implementation.
