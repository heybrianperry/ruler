...
1. MUST: Subagent target and alias collection MUST use Set-based accumulation patterns (e.g., mapped.add(alias), targets.add(target)) to ensure deduplication

## Policy Block

- MUST Subagent target and alias collection MUST use Set-based accumulation patterns (e.g., mapped.add(alias), targets.add(target)) to ensure deduplication
