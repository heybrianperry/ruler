# Standardize Agent-Based External API Integration Architecture: External Calls Processed
...
1. MUST: All external API calls MUST be processed through the RuleProcessor to ensure consistent validation, rate limiting, and policy enforcement

## Policy Block

- MUST All external API calls MUST be processed through the RuleProcessor to ensure consistent validation, rate limiting, and policy enforcement
