...
1. MUST: Array.find() predicates MUST compare against stable identifiers such as name, rulerDir, or path rather than array indices

## Policy Block

- MUST Array.find() predicates MUST compare against stable identifiers such as name, rulerDir, or path rather than array indices
