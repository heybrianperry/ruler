# Enforce Input Validation in CI/CD Test Suites: Integration Tests Verify
...
1. MUST: Integration tests MUST verify that remote configuration sources are validated before being applied to the system

## Policy Block

- MUST Integration tests MUST verify that remote configuration sources are validated before being applied to the system
