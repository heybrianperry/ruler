...
1. SHOULD: Configuration modules SHOULD use fs/promises or fs for file I/O operations to maintain consistency with the async/sync patterns in readVSCodeSettings and propagateMcpToOpenHands

## Policy Block

- SHOULD Configuration modules SHOULD use fs/promises or fs for file I/O operations to maintain consistency with the async/sync patterns in readVSCodeSettings and propagateMcpToOpenHands
