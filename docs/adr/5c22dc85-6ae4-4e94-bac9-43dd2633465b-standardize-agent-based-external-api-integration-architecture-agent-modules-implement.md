# Standardize Agent-Based External API Integration Architecture: Agent Modules Implement
...
1. MUST: Agent modules MUST implement capability detection through the MCP capabilities layer to expose available features and API compatibility

## Policy Block

- MUST Agent modules MUST implement capability detection through the MCP capabilities layer to expose available features and API compatibility
