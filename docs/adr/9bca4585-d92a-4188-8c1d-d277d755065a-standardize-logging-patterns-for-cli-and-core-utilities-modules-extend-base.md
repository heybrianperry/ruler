# Standardize Logging Patterns for CLI and Core Utilities: Modules Extend Base
...
1. MAY: Modules MAY extend the base logging pattern with domain-specific context as needed for their operational requirements

## Policy Block

- MAY Modules MAY extend the base logging pattern with domain-specific context as needed for their operational requirements
