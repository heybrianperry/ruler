# Adopt Vitest as Standard Unit Testing Framework for TypeScript Agent Development: Agent Test Files
...
1. MUST: All agent test files MUST include tests for core agent functionality including initialization, message handling, and error scenarios

## Policy Block

- MUST All agent test files MUST include tests for core agent functionality including initialization, message handling, and error scenarios
