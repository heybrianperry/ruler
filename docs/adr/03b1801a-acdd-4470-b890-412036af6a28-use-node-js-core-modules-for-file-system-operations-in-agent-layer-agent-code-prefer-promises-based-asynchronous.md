...
1. SHOULD: Agent code SHOULD prefer the promises-based API for asynchronous file operations to maintain consistency with async/await patterns

## Policy Block

- SHOULD Agent code SHOULD prefer the promises-based API for asynchronous file operations to maintain consistency with async/await patterns
