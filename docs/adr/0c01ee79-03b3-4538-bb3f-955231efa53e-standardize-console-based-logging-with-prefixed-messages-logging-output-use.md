...
1. MUST: All logging output MUST use console methods (console.error, console.warn, console.log) as the primary logging mechanism

## Policy Block

- MUST All logging output MUST use console methods (console.error, console.warn, console.log) as the primary logging mechanism
