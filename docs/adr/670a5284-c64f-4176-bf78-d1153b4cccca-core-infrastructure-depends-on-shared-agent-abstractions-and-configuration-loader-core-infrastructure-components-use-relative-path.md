...
1. MUST: Core infrastructure components MUST use relative path imports to reference shared internal modules from the agents and core packages

## Policy Block

- MUST Core infrastructure components MUST use relative path imports to reference shared internal modules from the agents and core packages
