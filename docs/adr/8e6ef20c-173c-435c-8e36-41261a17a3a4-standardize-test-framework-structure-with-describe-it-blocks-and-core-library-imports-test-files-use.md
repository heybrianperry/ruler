...
1. MAY: Test files MAY use child_process imports when testing CLI command execution with inherited stdio

## Policy Block

- MAY Test files MAY use child_process imports when testing CLI command execution with inherited stdio
