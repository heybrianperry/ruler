...
1. MUST_NOT: Core libraries MUST NOT implement custom cryptographic hash algorithms

## Policy Block

- MUST_NOT Core libraries MUST NOT implement custom cryptographic hash algorithms
