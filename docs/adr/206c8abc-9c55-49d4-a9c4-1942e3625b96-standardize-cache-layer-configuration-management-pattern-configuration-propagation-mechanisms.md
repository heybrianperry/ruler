# Standardize Cache Layer Configuration Management Pattern: Configuration Propagation Mechanisms
...
1. MUST: Configuration propagation mechanisms MUST ensure cache settings are synchronized across MCP servers, VSCode extensions, and other runtime environments

## Policy Block

- MUST Configuration propagation mechanisms MUST ensure cache settings are synchronized across MCP servers, VSCode extensions, and other runtime environments
