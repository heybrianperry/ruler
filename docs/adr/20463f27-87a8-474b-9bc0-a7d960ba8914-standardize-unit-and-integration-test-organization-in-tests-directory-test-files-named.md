# Standardize Unit and Integration Test Organization in tests/ Directory: Test Files Named
...
1. SHOULD: Test files SHOULD be named to match the module they test (e.g., GitignoreUtils.test.ts for GitignoreUtils.ts)

## Policy Block

- SHOULD Test files SHOULD be named to match the module they test (e.g., GitignoreUtils.test.ts for GitignoreUtils.ts)
