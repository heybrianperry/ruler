...
1. MUST_NOT: Components MUST NOT introduce third-party file system libraries as dependencies unless a specific capability gap in Node.js core modules is documented and approved.

## Policy Block

- MUST_NOT Components MUST NOT introduce third-party file system libraries as dependencies unless a specific capability gap in Node.js core modules is documented and approved.
