...
1. MUST: Subagent propagation to external systems MUST use atomic write operations (writeAgentsDirectoryAtomic) and expose propagateSubagentsForClaude as the public integration contract

## Policy Block

- MUST Subagent propagation to external systems MUST use atomic write operations (writeAgentsDirectoryAtomic) and expose propagateSubagentsForClaude as the public integration contract
