...
1. MUST: The consumer MUST inspect repository lock and resolution artifacts to confirm the exact resolved versions of all runtime filesystem and serialization dependencies before introducing or altering filesystem utility calls.

## Policy Block

- MUST The consumer MUST inspect repository lock and resolution artifacts to confirm the exact resolved versions of all runtime filesystem and serialization dependencies before introducing or altering filesystem utility calls.
