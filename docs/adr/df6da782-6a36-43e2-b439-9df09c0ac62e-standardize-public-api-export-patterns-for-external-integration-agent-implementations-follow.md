# Standardize Public API Export Patterns for External Integration: Agent Implementations Follow
...
1. MUST: Agent implementations MUST follow the standardized public API pattern detected across CursorAgent, AmpAgent, AgentsMdAgent, FactoryDroidAgent, FirebaseAgent, AiderAgent, and KiloCodeAgent

## Policy Block

- MUST Agent implementations MUST follow the standardized public API pattern detected across CursorAgent, AmpAgent, AgentsMdAgent, FactoryDroidAgent, FirebaseAgent, AiderAgent, and KiloCodeAgent
