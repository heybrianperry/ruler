...
1. MUST: Core operational modules MUST import system configuration keys, default values, and operational limits from the centralized constants module rather than declaring local literal values.

## Policy Block

- MUST Core operational modules MUST import system configuration keys, default values, and operational limits from the centralized constants module rather than declaring local literal values.
