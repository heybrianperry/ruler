# Standardize Structured Logging with Consistent Format and Levels: Log Messages Include
...
1. MUST: Log messages MUST include appropriate severity levels (ERROR, WARN, INFO, DEBUG) based on the operational impact of the event

## Policy Block

- MUST Log messages MUST include appropriate severity levels (ERROR, WARN, INFO, DEBUG) based on the operational impact of the event
