...
1. MUST: All modules performing path operations MUST import and use the 'path' module for cross-platform path manipulation.

## Policy Block

- MUST All modules performing path operations MUST import and use the 'path' module for cross-platform path manipulation.
