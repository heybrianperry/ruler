...
1. MAY: Configuration modules MAY implement caching to avoid repeated process.env lookups

## Policy Block

- MAY Configuration modules MAY implement caching to avoid repeated process.env lookups
