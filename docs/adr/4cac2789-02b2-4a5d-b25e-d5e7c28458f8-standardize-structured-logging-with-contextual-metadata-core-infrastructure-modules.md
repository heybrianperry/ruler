# Standardize Structured Logging with Contextual Metadata: Core Infrastructure Modules
...
1. SHOULD: Core infrastructure modules (FileSystemUtils, constants, handlers) SHOULD serve as reference implementations for logging patterns

## Policy Block

- SHOULD Core infrastructure modules (FileSystemUtils, constants, handlers) SHOULD serve as reference implementations for logging patterns
