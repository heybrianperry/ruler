# Enforce Input Validation in CI/CD Test Suites: Security Sensitive Inputs
...
1. MUST: Security-sensitive inputs (API keys, credentials, HTTP types) MUST be validated in dedicated test cases

## Policy Block

- MUST Security-sensitive inputs (API keys, credentials, HTTP types) MUST be validated in dedicated test cases
