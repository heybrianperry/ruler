...
1. SHOULD: Error logs SHOULD include the original error object or message to preserve stack traces and diagnostic information

## Policy Block

- SHOULD Error logs SHOULD include the original error object or message to preserve stack traces and diagnostic information
