...
1. MUST_NOT: Synchronization passes MUST NOT overwrite, unlink, or delete native or third-party skill definitions during apply or teardown phases.

## Policy Block

- MUST_NOT Synchronization passes MUST NOT overwrite, unlink, or delete native or third-party skill definitions during apply or teardown phases.
