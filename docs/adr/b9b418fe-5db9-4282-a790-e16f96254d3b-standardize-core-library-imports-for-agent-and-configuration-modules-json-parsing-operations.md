...
1. MUST: JSON parsing operations MUST use native JSON.parse for configuration and data deserialization

## Policy Block

- MUST JSON parsing operations MUST use native JSON.parse for configuration and data deserialization
