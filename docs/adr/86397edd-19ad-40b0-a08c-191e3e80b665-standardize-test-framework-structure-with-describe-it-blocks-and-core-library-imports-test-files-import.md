...
1. MUST: Test files MUST import core Node.js libraries ('fs/promises', 'path', 'os') when performing filesystem or environment operations

## Policy Block

- MUST Test files MUST import core Node.js libraries ('fs/promises', 'path', 'os') when performing filesystem or environment operations
