...
1. SHOULD: Configuration loaders and filesystem utilities SHOULD handle errors during directory inspection gracefully, emitting contextual diagnostic messages when the resolved global configuration directory cannot be accessed.

## Policy Block

- SHOULD Configuration loaders and filesystem utilities SHOULD handle errors during directory inspection gracefully, emitting contextual diagnostic messages when the resolved global configuration directory cannot be accessed.
