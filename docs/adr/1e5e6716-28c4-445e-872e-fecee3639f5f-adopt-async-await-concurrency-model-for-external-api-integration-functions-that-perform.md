# Adopt Async/Await Concurrency Model for External API Integration: Functions That Perform
...
1. MUST: Functions that perform asynchronous operations MUST be declared with the async keyword and return Promise types

## Policy Block

- MUST Functions that perform asynchronous operations MUST be declared with the async keyword and return Promise types
