...
1. MUST: Resolved agent collections MUST be cached and keyed by directory path within selectedAgentsByRulerDir to prevent redundant resolution across identical configuration boundaries.

## Policy Block

- MUST Resolved agent collections MUST be cached and keyed by directory path within selectedAgentsByRulerDir to prevent redundant resolution across identical configuration boundaries.
