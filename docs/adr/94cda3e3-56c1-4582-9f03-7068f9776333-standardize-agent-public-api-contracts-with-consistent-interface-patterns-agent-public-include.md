# Standardize Agent Public API Contracts with Consistent Interface Patterns: Agent Public Include
...
1. MUST: Agent public APIs MUST include explicit type definitions or interface declarations that document input parameters, return types, and error conditions

## Policy Block

- MUST Agent public APIs MUST include explicit type definitions or interface declarations that document input parameters, return types, and error conditions
