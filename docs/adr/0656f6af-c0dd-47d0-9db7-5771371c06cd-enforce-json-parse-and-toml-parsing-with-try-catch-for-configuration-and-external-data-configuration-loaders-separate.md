...
1. SHOULD: Configuration loaders SHOULD separate parse error handling from schema validation error handling to provide distinct error messages for syntax errors versus semantic errors

## Policy Block

- SHOULD Configuration loaders SHOULD separate parse error handling from schema validation error handling to provide distinct error messages for syntax errors versus semantic errors
