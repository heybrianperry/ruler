...
1. SHOULD: Transport-specific server registries SHOULD maintain separate Map instances (existingSseServers, existingShttpServers, existingStdioServers) to isolate transport concerns

## Policy Block

- SHOULD Transport-specific server registries SHOULD maintain separate Map instances (existingSseServers, existingShttpServers, existingStdioServers) to isolate transport concerns
