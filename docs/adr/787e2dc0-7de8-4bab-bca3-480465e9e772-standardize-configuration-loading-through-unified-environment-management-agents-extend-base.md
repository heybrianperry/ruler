# Standardize Configuration Loading Through Unified Environment Management: Agents Extend Base
...
1. MAY: Agents MAY extend the base configuration schema with agent-specific fields

## Policy Block

- MAY Agents MAY extend the base configuration schema with agent-specific fields
