...
1. MUST: All JSON content read from filesystem MUST be validated before parsing to ensure well-formed structure

## Policy Block

- MUST All JSON content read from filesystem MUST be validated before parsing to ensure well-formed structure
