...
1. MUST: Subagent discovery modules MUST export public contracts for discoverSubagents, getSelectedSubagentTargets, and getSubagentsGitignorePaths to enable coordinated filesystem traversal and filtering

## Policy Block

- MUST Subagent discovery modules MUST export public contracts for discoverSubagents, getSelectedSubagentTargets, and getSubagentsGitignorePaths to enable coordinated filesystem traversal and filtering
