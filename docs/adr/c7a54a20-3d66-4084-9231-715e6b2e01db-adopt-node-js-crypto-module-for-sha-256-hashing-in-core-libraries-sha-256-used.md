...
1. MUST: SHA-256 MUST be used as the standard hash algorithm via crypto.createHash('sha256')

## Policy Block

- MUST SHA-256 MUST be used as the standard hash algorithm via crypto.createHash('sha256')
