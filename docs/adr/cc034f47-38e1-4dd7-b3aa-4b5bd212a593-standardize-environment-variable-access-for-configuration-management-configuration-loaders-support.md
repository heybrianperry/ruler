# Standardize Environment Variable Access for Configuration Management: Configuration Loaders Support
...
1. MAY: Configuration loaders MAY support multiple configuration sources (environment variables, config files, VSCode settings) with a defined precedence order

## Policy Block

- MAY Configuration loaders MAY support multiple configuration sources (environment variables, config files, VSCode settings) with a defined precedence order
