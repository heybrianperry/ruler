...
1. MUST: Class-based API contracts (e.g., OpenCodeAgent, ZedAgent, WarpAgent) MUST be exported as named classes with PascalCase naming

## Policy Block

- MUST Class-based API contracts (e.g., OpenCodeAgent, ZedAgent, WarpAgent) MUST be exported as named classes with PascalCase naming
