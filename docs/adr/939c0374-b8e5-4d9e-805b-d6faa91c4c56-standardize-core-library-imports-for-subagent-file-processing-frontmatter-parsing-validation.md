...
1. MUST: Frontmatter parsing and validation functions (parseFrontmatter, validateFrontmatter) MUST be exported from SubagentsUtils and reused across modules

## Policy Block

- MUST Frontmatter parsing and validation functions (parseFrontmatter, validateFrontmatter) MUST be exported from SubagentsUtils and reused across modules
