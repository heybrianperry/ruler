...
1. MUST: Tests MUST read configuration files using fs.readFile or fs/promises with utf8 encoding before parsing

## Policy Block

- MUST Tests MUST read configuration files using fs.readFile or fs/promises with utf8 encoding before parsing
