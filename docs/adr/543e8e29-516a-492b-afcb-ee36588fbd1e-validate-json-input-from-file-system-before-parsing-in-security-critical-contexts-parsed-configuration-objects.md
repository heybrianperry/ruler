...
1. MUST: Parsed configuration objects MUST be validated for expected structure (presence of required keys like mcpServers, servers, contextFileName) before use

## Policy Block

- MUST Parsed configuration objects MUST be validated for expected structure (presence of required keys like mcpServers, servers, contextFileName) before use
