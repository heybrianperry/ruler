# Adopt Unified Configuration Loading with Environment Variable Override Support: Agent Implementations Not
...
1. MUST_NOT: Agent implementations MUST NOT implement custom configuration loading logic that bypasses the unified configuration loader

## Policy Block

- MUST_NOT Agent implementations MUST NOT implement custom configuration loading logic that bypasses the unified configuration loader
