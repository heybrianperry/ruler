...
1. SHOULD: Utility modules providing cross-cutting concerns SHOULD export named functions as public contracts (e.g., parseFrontmatter, validateFrontmatter, loadSubagentFile, discoverSubagents)

## Policy Block

- SHOULD Utility modules providing cross-cutting concerns SHOULD export named functions as public contracts (e.g., parseFrontmatter, validateFrontmatter, loadSubagentFile, discoverSubagents)
