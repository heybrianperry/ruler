# Adopt TypeScript-based Unit Testing Framework for Agent and CLI Components: Cli Handler Components
...
1. MUST: CLI handler components MUST have unit tests located in tests/unit/cli/ directory.

## Policy Block

- MUST CLI handler components MUST have unit tests located in tests/unit/cli/ directory.
