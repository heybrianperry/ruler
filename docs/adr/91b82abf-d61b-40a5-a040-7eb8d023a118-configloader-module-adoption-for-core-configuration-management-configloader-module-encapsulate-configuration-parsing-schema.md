...
1. SHOULD: The ConfigLoader module SHOULD encapsulate configuration parsing, schema validation, and fallback resolution for all core consumers.

## Policy Block

- SHOULD The ConfigLoader module SHOULD encapsulate configuration parsing, schema validation, and fallback resolution for all core consumers.
