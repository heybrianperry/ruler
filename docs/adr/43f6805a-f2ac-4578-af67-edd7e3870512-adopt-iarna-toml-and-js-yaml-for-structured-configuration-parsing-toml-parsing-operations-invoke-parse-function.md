...
1. MUST: TOML parsing operations MUST invoke the parse function from @iarna/toml with file content as input

## Policy Block

- MUST TOML parsing operations MUST invoke the parse function from @iarna/toml with file content as input
