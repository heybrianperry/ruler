...
1. MUST: Core infrastructure modules that coordinate agent behavior MUST import the centralized IAgent interface module to establish type contracts.

## Policy Block

- MUST Core infrastructure modules that coordinate agent behavior MUST import the centralized IAgent interface module to establish type contracts.
