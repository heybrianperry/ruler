...
1. SHOULD: Consuming modules SHOULD restrict imports from the shared types module exclusively to type definitions and interface declarations, avoiding execution-time side effects.

## Policy Block

- SHOULD Consuming modules SHOULD restrict imports from the shared types module exclusively to type definitions and interface declarations, avoiding execution-time side effects.
