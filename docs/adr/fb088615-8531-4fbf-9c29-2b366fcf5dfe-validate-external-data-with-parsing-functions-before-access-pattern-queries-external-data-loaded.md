...
1. MUST: All external data loaded from files MUST be parsed through a validation function (parseTOML, JSON.parse, or equivalent) before applying data access patterns

## Policy Block

- MUST All external data loaded from files MUST be parsed through a validation function (parseTOML, JSON.parse, or equivalent) before applying data access patterns
