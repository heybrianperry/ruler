# Adopt Comprehensive Test Coverage for CI/CD Pipeline Components: Teams Implement Additional
...
1. MAY: Teams MAY implement additional test types (e.g., end-to-end, performance) based on component criticality

## Policy Block

- MAY Teams MAY implement additional test types (e.g., end-to-end, performance) based on component criticality
