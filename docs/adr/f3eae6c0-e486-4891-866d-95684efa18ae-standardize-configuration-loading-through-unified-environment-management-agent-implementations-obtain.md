# Standardize Configuration Loading Through Unified Environment Management: Agent Implementations Obtain
...
1. MUST: Agent implementations MUST obtain their configuration through the standardized configuration loading mechanism during initialization

## Policy Block

- MUST Agent implementations MUST obtain their configuration through the standardized configuration loading mechanism during initialization
