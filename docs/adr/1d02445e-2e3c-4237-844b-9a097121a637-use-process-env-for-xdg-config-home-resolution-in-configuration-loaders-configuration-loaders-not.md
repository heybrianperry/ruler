...
1. MUST_NOT: Configuration loaders MUST NOT cache process.env.XDG_CONFIG_HOME values across multiple configuration load operations unless explicitly designed for immutable environments

## Policy Block

- MUST_NOT Configuration loaders MUST NOT cache process.env.XDG_CONFIG_HOME values across multiple configuration load operations unless explicitly designed for immutable environments
