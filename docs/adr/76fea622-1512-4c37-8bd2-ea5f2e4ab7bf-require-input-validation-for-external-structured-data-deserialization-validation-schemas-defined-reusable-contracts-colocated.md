...
1. SHOULD: Validation schemas SHOULD be defined as reusable contracts colocated with the modules that consume the data

## Policy Block

- SHOULD Validation schemas SHOULD be defined as reusable contracts colocated with the modules that consume the data
