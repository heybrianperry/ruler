# Standardize Structured Logging with Consistent Format and Levels: Log Messages Not
...
1. MUST_NOT: Log messages MUST NOT contain sensitive information (credentials, PII, secrets) without proper redaction

## Policy Block

- MUST_NOT Log messages MUST NOT contain sensitive information (credentials, PII, secrets) without proper redaction
