...
1. SHOULD: Error messages SHOULD include actionable context such as file paths, error messages from underlying operations, or configuration keys to facilitate debugging

## Policy Block

- SHOULD Error messages SHOULD include actionable context such as file paths, error messages from underlying operations, or configuration keys to facilitate debugging
