...
1. MAY: Schemas MAY use Zod's transformation and refinement capabilities to normalize or sanitize input during validation

## Policy Block

- MAY Schemas MAY use Zod's transformation and refinement capabilities to normalize or sanitize input during validation
