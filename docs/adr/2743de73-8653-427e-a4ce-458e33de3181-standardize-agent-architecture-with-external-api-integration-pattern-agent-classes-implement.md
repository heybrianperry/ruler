# Standardize Agent Architecture with External API Integration Pattern: Agent Classes Implement
...
1. SHOULD: Agent classes SHOULD implement consistent error handling and retry logic for external API calls

## Policy Block

- SHOULD Agent classes SHOULD implement consistent error handling and retry logic for external API calls
