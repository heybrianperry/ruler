# Adopt TypeScript Test Files with .test.ts Extension as Standard Testing Convention: Test Files Include
...
1. MAY: Test files MAY include descriptive suffixes beyond the module name to indicate specific test scenarios (e.g., mcp-invalid-fields.test.ts)

## Policy Block

- MAY Test files MAY include descriptive suffixes beyond the module name to indicate specific test scenarios (e.g., mcp-invalid-fields.test.ts)
