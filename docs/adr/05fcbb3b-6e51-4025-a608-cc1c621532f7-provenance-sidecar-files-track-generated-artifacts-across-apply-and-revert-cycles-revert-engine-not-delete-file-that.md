...
1. MUST_NOT: The revert engine MUST NOT delete a file that lacks a .ruler-provenance.json sidecar solely on the basis of its presence in .ruler-managed.json, without additional confirmation, to prevent accidental destruction of user files.

## Policy Block

- MUST_NOT The revert engine MUST NOT delete a file that lacks a .ruler-provenance.json sidecar solely on the basis of its presence in .ruler-managed.json, without additional confirmation, to prevent accidental destruction of user files.
