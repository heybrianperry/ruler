...
1. SHOULD: Specialized agent implementations SHOULD isolate target-specific protocol serialization from core agent behavior by delegating document normalization directly to AgentsMdAgent.

## Policy Block

- SHOULD Specialized agent implementations SHOULD isolate target-specific protocol serialization from core agent behavior by delegating document normalization directly to AgentsMdAgent.
