...
1. SHOULD: Modules that coordinate agent lifecycle (discovery, selection, propagation) SHOULD export functions with clear, action-oriented names that describe their purpose (e.g., discoverSubagents, resolveSelectedAgents, getSelectedSubagentTargets)

## Policy Block

- SHOULD Modules that coordinate agent lifecycle (discovery, selection, propagation) SHOULD export functions with clear, action-oriented names that describe their purpose (e.g., discoverSubagents, resolveSelectedAgents, getSelectedSubagentTargets)
