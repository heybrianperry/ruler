...
1. MAY: Modules MAY utilize synchronous process execution methods during initialization phases where asynchronous event loops are not yet established.

## Policy Block

- MAY Modules MAY utilize synchronous process execution methods during initialization phases where asynchronous event loops are not yet established.
