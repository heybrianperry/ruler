...
1. MUST: Revert-engine MUST use generatedPaths as the primary source of truth for identifying artifacts to clean up.

## Policy Block

- MUST Revert-engine MUST use generatedPaths as the primary source of truth for identifying artifacts to clean up.
