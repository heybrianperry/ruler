...
1. MAY: Modules with domain-specific constants that are strictly private to a single translation unit MAY maintain local constants provided they do not represent shared system keys or cross-cutting configuration.

## Policy Block

- MAY Modules with domain-specific constants that are strictly private to a single translation unit MAY maintain local constants provided they do not represent shared system keys or cross-cutting configuration.
