...
1. MUST: Agent implementations MUST use Node.js core modules (path, fs, fs/promises) as the primary mechanism for file system operations including path manipulation, file reading, and directory access

## Policy Block

- MUST Agent implementations MUST use Node.js core modules (path, fs, fs/promises) as the primary mechanism for file system operations including path manipulation, file reading, and directory access
