# Standardize TypeScript Type Definitions for Public API Contracts: Type Definition Files
...
1. MUST: Type definition files that define public API contracts MUST export all types that are intended for external consumption or cross-module usage

## Policy Block

- MUST Type definition files that define public API contracts MUST export all types that are intended for external consumption or cross-module usage
