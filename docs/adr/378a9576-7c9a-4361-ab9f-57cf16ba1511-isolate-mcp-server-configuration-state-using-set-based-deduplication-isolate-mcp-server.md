...
1. MUST: Isolate MCP server definitions by directory scope, ensuring child directory configurations do not inherit parent server entries unless explicitly configured

## Policy Block

- MUST Isolate MCP server definitions by directory scope, ensuring child directory configurations do not inherit parent server entries unless explicitly configured
