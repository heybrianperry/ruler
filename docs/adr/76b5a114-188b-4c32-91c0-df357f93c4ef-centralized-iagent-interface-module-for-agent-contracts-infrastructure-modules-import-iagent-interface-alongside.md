...
1. MAY: Infrastructure modules MAY import the IAgent interface alongside other internal modules such as configuration loaders, utility functions, and constants as needed for their specific coordination responsibilities.

## Policy Block

- MAY Infrastructure modules MAY import the IAgent interface alongside other internal modules such as configuration loaders, utility functions, and constants as needed for their specific coordination responsibilities.
