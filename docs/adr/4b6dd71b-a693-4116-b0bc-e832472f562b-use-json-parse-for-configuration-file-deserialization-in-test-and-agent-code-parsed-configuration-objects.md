...
1. SHOULD: Parsed configuration objects SHOULD be validated against expected schemas before use to ensure required fields are present and correctly typed

## Policy Block

- SHOULD Parsed configuration objects SHOULD be validated against expected schemas before use to ensure required fields are present and correctly typed
