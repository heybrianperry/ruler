# Standardize Jest as Testing Framework for TypeScript Unit Tests: Test Files Organized
...
1. MUST: Test files MUST be organized under the tests/unit/ directory with appropriate subdirectory structure reflecting the source code organization

## Policy Block

- MUST Test files MUST be organized under the tests/unit/ directory with appropriate subdirectory structure reflecting the source code organization
