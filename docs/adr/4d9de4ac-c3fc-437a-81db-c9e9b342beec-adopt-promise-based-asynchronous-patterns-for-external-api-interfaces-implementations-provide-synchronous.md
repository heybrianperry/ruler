# Adopt Promise-Based Asynchronous Patterns for External API Interfaces: Implementations Provide Synchronous
...
1. MAY: Implementations MAY provide synchronous convenience methods alongside async versions when appropriate, clearly marked with 'Sync' suffix

## Policy Block

- MAY Implementations MAY provide synchronous convenience methods alongside async versions when appropriate, clearly marked with 'Sync' suffix
