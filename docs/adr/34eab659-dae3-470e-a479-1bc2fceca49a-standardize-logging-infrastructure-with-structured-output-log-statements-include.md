# Standardize Logging Infrastructure with Structured Output: Log Statements Include
...
1. MUST: Log statements MUST include appropriate context information (module name, operation, relevant identifiers) to enable effective debugging

## Policy Block

- MUST Log statements MUST include appropriate context information (module name, operation, relevant identifiers) to enable effective debugging
