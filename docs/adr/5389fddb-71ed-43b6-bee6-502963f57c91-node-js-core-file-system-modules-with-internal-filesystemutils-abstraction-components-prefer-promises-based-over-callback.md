...
1. SHOULD: Components SHOULD prefer the promises-based API (fs/promises) over callback-based APIs for new asynchronous file system operations to maintain consistency with modern async/await patterns.

## Policy Block

- SHOULD Components SHOULD prefer the promises-based API (fs/promises) over callback-based APIs for new asynchronous file system operations to maintain consistency with modern async/await patterns.
