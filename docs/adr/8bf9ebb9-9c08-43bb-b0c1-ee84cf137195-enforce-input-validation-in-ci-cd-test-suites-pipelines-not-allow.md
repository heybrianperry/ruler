# Enforce Input Validation in CI/CD Test Suites: Pipelines Not Allow
...
1. MUST_NOT: CI/CD pipelines MUST NOT allow tests to pass if input validation tests are skipped or disabled

## Policy Block

- MUST_NOT CI/CD pipelines MUST NOT allow tests to pass if input validation tests are skipped or disabled
