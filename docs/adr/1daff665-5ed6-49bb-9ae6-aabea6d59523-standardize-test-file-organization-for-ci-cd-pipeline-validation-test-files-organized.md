# Standardize Test File Organization for CI/CD Pipeline Validation: Test Files Organized
...
1. MUST: Test files MUST be organized with clear separation between unit tests (tests/unit/), integration tests (tests/integration/), and configuration tests (tests/)

## Policy Block

- MUST Test files MUST be organized with clear separation between unit tests (tests/unit/), integration tests (tests/integration/), and configuration tests (tests/)
