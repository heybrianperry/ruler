...
1. MUST: Shared utilities, type definitions, and core business logic MUST be organized in dedicated directories that establish clear module ownership boundaries

## Policy Block

- MUST Shared utilities, type definitions, and core business logic MUST be organized in dedicated directories that establish clear module ownership boundaries
