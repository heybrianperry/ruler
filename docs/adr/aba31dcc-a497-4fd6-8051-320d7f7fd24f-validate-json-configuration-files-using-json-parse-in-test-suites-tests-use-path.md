...
1. SHOULD: Tests SHOULD use path.join to construct absolute paths to configuration files within test project roots

## Policy Block

- SHOULD Tests SHOULD use path.join to construct absolute paths to configuration files within test project roots
