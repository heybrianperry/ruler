...
1. MUST: Apply-engine MUST append to generatedPaths for every artifact written, before the operation completes.

## Policy Block

- MUST Apply-engine MUST append to generatedPaths for every artifact written, before the operation completes.
