...
1. MUST: Functions that transform configuration data MUST populate the cache layer before performing merge or update operations

## Policy Block

- MUST Functions that transform configuration data MUST populate the cache layer before performing merge or update operations
