...
1. SHOULD: Modules requiring configuration discovery SHOULD import and use shared utilities from core modules (e.g., FileSystemUtils) to ensure consistent behavior

## Policy Block

- SHOULD Modules requiring configuration discovery SHOULD import and use shared utilities from core modules (e.g., FileSystemUtils) to ensure consistent behavior
