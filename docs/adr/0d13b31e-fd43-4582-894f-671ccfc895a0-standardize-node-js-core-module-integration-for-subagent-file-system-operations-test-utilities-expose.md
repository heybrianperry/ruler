...
1. MAY: Test utilities MAY expose internal reset functions (_resetExperimentalWarningForTests) for testing purposes only

## Policy Block

- MAY Test utilities MAY expose internal reset functions (_resetExperimentalWarningForTests) for testing purposes only
