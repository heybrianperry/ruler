# Adopt Async/Await Concurrency Model for External API Integration: Agent Implementations Use
...
1. SHOULD: Agent implementations SHOULD use async/await for all file system operations, subprocess execution, and network requests

## Policy Block

- SHOULD Agent implementations SHOULD use async/await for all file system operations, subprocess execution, and network requests
