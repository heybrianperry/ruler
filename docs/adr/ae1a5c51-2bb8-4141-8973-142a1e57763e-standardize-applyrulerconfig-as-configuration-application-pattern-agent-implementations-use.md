...
1. MUST: Agent implementations MUST use core library imports from './IAgent' interface or './AgentsMdAgent' base class to ensure contract compliance

## Policy Block

- MUST Agent implementations MUST use core library imports from './IAgent' interface or './AgentsMdAgent' base class to ensure contract compliance
