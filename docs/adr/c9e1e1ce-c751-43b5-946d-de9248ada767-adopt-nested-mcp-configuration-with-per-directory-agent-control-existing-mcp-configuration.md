...
1. MUST: Existing MCP configuration files MUST be backed up with a .bak extension before being overwritten

## Policy Block

- MUST Existing MCP configuration files MUST be backed up with a .bak extension before being overwritten
