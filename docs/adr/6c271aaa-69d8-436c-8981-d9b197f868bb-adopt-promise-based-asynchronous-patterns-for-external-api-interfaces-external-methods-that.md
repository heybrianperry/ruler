# Adopt Promise-Based Asynchronous Patterns for External API Interfaces: External Methods That
...
1. MUST: All external API methods that perform I/O operations, network requests, or long-running computations MUST return Promises

## Policy Block

- MUST All external API methods that perform I/O operations, network requests, or long-running computations MUST return Promises
