# Standardize Environment Variable Access for Configuration Management: Configuration Loaders Agent
...
1. MUST: Configuration loaders and agent implementations MUST provide sensible defaults or explicit error handling when required environment variables are missing

## Policy Block

- MUST Configuration loaders and agent implementations MUST provide sensible defaults or explicit error handling when required environment variables are missing
