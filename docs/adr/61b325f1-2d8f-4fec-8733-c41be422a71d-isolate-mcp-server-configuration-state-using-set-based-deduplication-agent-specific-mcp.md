...
1. SHOULD: Agent-specific MCP configuration paths SHOULD be normalized to relative paths with forward slashes before adding to gitignore Sets

## Policy Block

- SHOULD Agent-specific MCP configuration paths SHOULD be normalized to relative paths with forward slashes before adding to gitignore Sets
