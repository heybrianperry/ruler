...
1. SHOULD: Async configuration functions SHOULD use descriptive names indicating their asynchronous nature (e.g., loadSubagentFile, readGeminiSettings, discoverSubagents)

## Policy Block

- SHOULD Async configuration functions SHOULD use descriptive names indicating their asynchronous nature (e.g., loadSubagentFile, readGeminiSettings, discoverSubagents)
