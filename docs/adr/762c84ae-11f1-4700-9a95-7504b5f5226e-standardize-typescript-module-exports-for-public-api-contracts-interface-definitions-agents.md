# Standardize TypeScript Module Exports for Public API Contracts: Interface Definitions Agents
...
1. MUST: Interface definitions for agents, processors, and utilities MUST be defined in dedicated TypeScript files with clear naming conventions (e.g., IAgent.ts for agent interfaces)

## Policy Block

- MUST Interface definitions for agents, processors, and utilities MUST be defined in dedicated TypeScript files with clear naming conventions (e.g., IAgent.ts for agent interfaces)
