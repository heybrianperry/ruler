...
1. SHOULD: Test files SHOULD use Vitest as the primary test runner and assertion library

## Policy Block

- SHOULD Test files SHOULD use Vitest as the primary test runner and assertion library
