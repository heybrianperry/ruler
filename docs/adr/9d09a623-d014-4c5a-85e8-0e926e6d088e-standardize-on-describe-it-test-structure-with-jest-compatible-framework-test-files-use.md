...
1. MUST: Test files MUST use beforeAll/afterAll hooks for expensive setup operations that can be shared across test cases within a describe block

## Policy Block

- MUST Test files MUST use beforeAll/afterAll hooks for expensive setup operations that can be shared across test cases within a describe block
