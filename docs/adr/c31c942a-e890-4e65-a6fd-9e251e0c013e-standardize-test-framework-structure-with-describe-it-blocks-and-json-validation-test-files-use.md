...
1. MUST: All test files MUST use describe blocks to organize test suites with descriptive names that identify the feature or component under test

## Policy Block

- MUST All test files MUST use describe blocks to organize test suites with descriptive names that identify the feature or component under test
