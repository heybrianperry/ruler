# Standardize Unit and Integration Test Organization in tests/ Directory: Test Files Placed
...
1. MUST: All test files MUST be placed under the tests/ directory at the project root

## Policy Block

- MUST All test files MUST be placed under the tests/ directory at the project root
