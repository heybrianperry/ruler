# Adopt Jest with TypeScript for Unit Testing in Developer Tooling: Agent Implementations Have
...
1. MUST: All agent implementations MUST have corresponding unit test files following the pattern {AgentName}.test.ts

## Policy Block

- MUST All agent implementations MUST have corresponding unit test files following the pattern {AgentName}.test.ts
