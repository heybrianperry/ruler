...
1. MAY: Modules MAY cache file system state (existingServerMap, seen Set) in memory when coordinating multiple related operations, provided cache invalidation is handled correctly

## Policy Block

- MAY Modules MAY cache file system state (existingServerMap, seen Set) in memory when coordinating multiple related operations, provided cache invalidation is handled correctly
