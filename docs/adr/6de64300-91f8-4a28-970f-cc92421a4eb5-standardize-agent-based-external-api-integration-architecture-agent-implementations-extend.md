# Standardize Agent-Based External API Integration Architecture: Agent Implementations Extend
...
1. MUST: All agent implementations MUST extend or implement a common base agent interface that defines standard lifecycle methods (initialize, execute, cleanup) and configuration handling

## Policy Block

- MUST All agent implementations MUST extend or implement a common base agent interface that defines standard lifecycle methods (initialize, execute, cleanup) and configuration handling
