...
1. MUST: All files created or updated by apply-engine MUST record provenance metadata.

## Policy Block

- MUST All files created or updated by apply-engine MUST record provenance metadata.
