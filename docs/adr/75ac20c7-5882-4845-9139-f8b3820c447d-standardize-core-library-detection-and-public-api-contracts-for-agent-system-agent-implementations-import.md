...
1. MUST: All agent implementations MUST import core interfaces from './IAgent' or './AbstractAgent' to establish contract compliance

## Policy Block

- MUST All agent implementations MUST import core interfaces from './IAgent' or './AbstractAgent' to establish contract compliance
