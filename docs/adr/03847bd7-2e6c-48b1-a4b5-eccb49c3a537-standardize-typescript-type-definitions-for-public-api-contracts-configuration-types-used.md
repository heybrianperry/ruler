# Standardize TypeScript Type Definitions for Public API Contracts: Configuration Types Used
...
1. MUST: Configuration types used by multiple agents or exposed through MCP capabilities MUST be defined in UnifiedConfigTypes.ts to ensure consistency

## Policy Block

- MUST Configuration types used by multiple agents or exposed through MCP capabilities MUST be defined in UnifiedConfigTypes.ts to ensure consistency
