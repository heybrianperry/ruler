# Adopt TypeScript with Jest as Standard Testing Framework: Test Files Written
...
1. MUST: All test files MUST be written in TypeScript with the .test.ts file extension

## Policy Block

- MUST All test files MUST be written in TypeScript with the .test.ts file extension
