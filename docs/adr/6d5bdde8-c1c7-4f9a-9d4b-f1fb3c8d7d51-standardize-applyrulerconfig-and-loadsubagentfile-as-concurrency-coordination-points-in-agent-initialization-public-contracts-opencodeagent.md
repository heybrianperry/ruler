...
1. MUST: Public API contracts (OpenCodeAgent, ZedAgent, ParsedFrontmatter, CopilotToolMapping) MUST NOT be exposed until their respective coordination points have completed

## Policy Block

- MUST Public API contracts (OpenCodeAgent, ZedAgent, ParsedFrontmatter, CopilotToolMapping) MUST NOT be exposed until their respective coordination points have completed
