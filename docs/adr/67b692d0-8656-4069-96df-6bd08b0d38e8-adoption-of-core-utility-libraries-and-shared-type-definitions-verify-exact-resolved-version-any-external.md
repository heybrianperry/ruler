...
1. MUST: MUST verify the exact resolved version of any external dependency by inspecting the project's lock file before implementing or updating code that relies on it.

## Policy Block

- MUST MUST verify the exact resolved version of any external dependency by inspecting the project's lock file before implementing or updating code that relies on it.
