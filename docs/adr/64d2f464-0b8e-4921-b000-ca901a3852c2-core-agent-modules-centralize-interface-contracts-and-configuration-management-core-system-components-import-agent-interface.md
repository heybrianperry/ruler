...
1. MUST: Core system components MUST import agent interface contracts from the centralized IAgent module rather than defining local agent interfaces

## Policy Block

- MUST Core system components MUST import agent interface contracts from the centralized IAgent module rather than defining local agent interfaces
