# Adopt Structured Test Organization with Layered Test Suites: Test Files Organized
...
1. MUST: Test files MUST be organized into distinct directories based on test scope: unit/, integration/, and e2e/ (or equivalent layer names)

## Policy Block

- MUST Test files MUST be organized into distinct directories based on test scope: unit/, integration/, and e2e/ (or equivalent layer names)
