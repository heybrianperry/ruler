# Adopt TypeScript-based Unit Testing Framework for Agent and CLI Components: Invalid Error Case
...
1. SHOULD: Invalid or error-case scenarios SHOULD be tested explicitly, as evidenced by invalid-agent.test.ts.

## Policy Block

- SHOULD Invalid or error-case scenarios SHOULD be tested explicitly, as evidenced by invalid-agent.test.ts.
