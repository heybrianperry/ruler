# Standardize Test Configuration and MCP Integration Testing Patterns: Test Files Follow
...
1. SHOULD: Test files SHOULD follow naming conventions that clearly indicate the component and scenario being tested (e.g., unified-config.mcp-json-warning.test.ts)

## Policy Block

- SHOULD Test files SHOULD follow naming conventions that clearly indicate the component and scenario being tested (e.g., unified-config.mcp-json-warning.test.ts)
