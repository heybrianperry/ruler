...
1. MUST: The revert engine MUST verify artifact provenance and ownership prior to executing revert deletions or mutations on target files.

## Policy Block

- MUST The revert engine MUST verify artifact provenance and ownership prior to executing revert deletions or mutations on target files.
