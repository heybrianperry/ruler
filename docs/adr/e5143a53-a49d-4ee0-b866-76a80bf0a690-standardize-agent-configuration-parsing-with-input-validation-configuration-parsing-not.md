...
1. MUST_NOT: Configuration parsing MUST NOT execute or evaluate code embedded in configuration files

## Policy Block

- MUST_NOT Configuration parsing MUST NOT execute or evaluate code embedded in configuration files
