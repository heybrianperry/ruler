...
1. MUST: Retrieve cached agent selections using get operations when accessing root or nested configuration entries

## Policy Block

- MUST Retrieve cached agent selections using get operations when accessing root or nested configuration entries
