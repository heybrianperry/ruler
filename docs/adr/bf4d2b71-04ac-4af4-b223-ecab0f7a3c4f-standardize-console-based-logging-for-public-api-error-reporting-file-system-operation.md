...
1. SHOULD: File system operation errors SHOULD include contextual information such as directory paths and operation type in error messages

## Policy Block

- SHOULD File system operation errors SHOULD include contextual information such as directory paths and operation type in error messages
