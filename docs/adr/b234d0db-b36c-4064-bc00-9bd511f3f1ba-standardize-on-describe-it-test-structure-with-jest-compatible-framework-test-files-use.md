...
1. MUST: Test files MUST use beforeEach/afterEach hooks for setup and teardown when test isolation requires state management

## Policy Block

- MUST Test files MUST use beforeEach/afterEach hooks for setup and teardown when test isolation requires state management
