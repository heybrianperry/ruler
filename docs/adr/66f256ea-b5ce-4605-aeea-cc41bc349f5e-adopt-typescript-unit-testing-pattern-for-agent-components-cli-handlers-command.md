# Adopt TypeScript Unit Testing Pattern for Agent Components: Cli Handlers Command
...
1. SHOULD: CLI handlers and command processing logic SHOULD have dedicated unit tests in tests/unit/cli/ directory

## Policy Block

- SHOULD CLI handlers and command processing logic SHOULD have dedicated unit tests in tests/unit/cli/ directory
