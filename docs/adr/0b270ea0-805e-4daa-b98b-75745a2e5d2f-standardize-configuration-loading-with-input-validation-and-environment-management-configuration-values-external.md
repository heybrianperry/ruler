# Standardize Configuration Loading with Input Validation and Environment Management: Configuration Values External
...
1. MUST: Configuration values from external sources (TOML files, environment variables, user input) MUST be sanitized and validated against expected schemas before use

## Policy Block

- MUST Configuration values from external sources (TOML files, environment variables, user input) MUST be sanitized and validated against expected schemas before use
