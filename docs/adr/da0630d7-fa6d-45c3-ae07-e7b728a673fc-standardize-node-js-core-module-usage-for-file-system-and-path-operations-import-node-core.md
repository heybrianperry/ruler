...
1. MUST: Import Node.js core modules using bare specifiers without 'node:' prefix (e.g., 'fs/promises', 'path', 'os')

## Policy Block

- MUST Import Node.js core modules using bare specifiers without 'node:' prefix (e.g., 'fs/promises', 'path', 'os')
