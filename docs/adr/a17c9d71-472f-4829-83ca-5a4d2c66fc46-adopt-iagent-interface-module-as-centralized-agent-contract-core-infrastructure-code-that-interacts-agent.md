...
1. MUST: All core infrastructure code that interacts with agent abstractions MUST import the IAgent interface module as the contract definition rather than depending on concrete agent implementation classes.

## Policy Block

- MUST All core infrastructure code that interacts with agent abstractions MUST import the IAgent interface module as the contract definition rather than depending on concrete agent implementation classes.
