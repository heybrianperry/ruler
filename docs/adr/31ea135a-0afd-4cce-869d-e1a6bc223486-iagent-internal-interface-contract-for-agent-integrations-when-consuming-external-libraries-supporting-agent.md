...
1. MUST: When consuming external libraries supporting agent integrations, the consumer MUST inspect the dependency manifest and authoritative lock artifact to resolve the exact locked version before implementation.

## Policy Block

- MUST When consuming external libraries supporting agent integrations, the consumer MUST inspect the dependency manifest and authoritative lock artifact to resolve the exact locked version before implementation.
