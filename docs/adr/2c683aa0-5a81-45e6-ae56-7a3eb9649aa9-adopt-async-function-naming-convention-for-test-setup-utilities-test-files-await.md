...
1. MUST: Test files MUST await all async setup utilities before proceeding with test assertions

## Policy Block

- MUST Test files MUST await all async setup utilities before proceeding with test assertions
