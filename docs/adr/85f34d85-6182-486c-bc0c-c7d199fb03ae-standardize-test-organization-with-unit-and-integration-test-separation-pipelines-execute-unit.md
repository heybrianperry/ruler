# Standardize Test Organization with Unit and Integration Test Separation: Pipelines Execute Unit
...
1. SHOULD: CI/CD pipelines SHOULD execute unit tests before integration tests to provide rapid feedback

## Policy Block

- SHOULD CI/CD pipelines SHOULD execute unit tests before integration tests to provide rapid feedback
