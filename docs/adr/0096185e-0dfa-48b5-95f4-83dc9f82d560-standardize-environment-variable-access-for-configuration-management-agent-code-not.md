# Standardize Environment Variable Access for Configuration Management: Agent Code Not
...
1. MUST_NOT: Agent code MUST NOT directly access process.env except through the configuration loader interface to maintain testability and consistency

## Policy Block

- MUST_NOT Agent code MUST NOT directly access process.env except through the configuration loader interface to maintain testability and consistency
