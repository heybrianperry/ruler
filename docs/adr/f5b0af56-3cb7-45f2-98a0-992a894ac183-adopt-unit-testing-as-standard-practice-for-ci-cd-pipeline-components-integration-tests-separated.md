# Adopt Unit Testing as Standard Practice for CI/CD Pipeline Components: Integration Tests Separated
...
1. SHOULD: Integration tests SHOULD be separated from unit tests and placed in tests/integration/ to distinguish between isolated component tests and multi-component scenarios

## Policy Block

- SHOULD Integration tests SHOULD be separated from unit tests and placed in tests/integration/ to distinguish between isolated component tests and multi-component scenarios
