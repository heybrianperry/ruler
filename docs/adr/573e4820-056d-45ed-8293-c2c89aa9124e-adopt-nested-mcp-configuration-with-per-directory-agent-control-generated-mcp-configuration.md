# Adopt Nested MCP Configuration with Per-Directory Agent Control: Generated Mcp Configuration
...
1. MUST: Generated MCP configuration file paths and their backup files MUST be added to .gitignore to prevent version control pollution

## Policy Block

- MUST Generated MCP configuration file paths and their backup files MUST be added to .gitignore to prevent version control pollution
