...
1. SHOULD: Agent utility functions (getAgentOutputPaths, mapRawAgentConfigs) SHOULD be used for common operations rather than implementing agent-specific variants

## Policy Block

- SHOULD Agent utility functions (getAgentOutputPaths, mapRawAgentConfigs) SHOULD be used for common operations rather than implementing agent-specific variants
