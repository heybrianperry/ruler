...
1. MUST: Structured data objects MUST be serialized using stableJson before hashing to ensure deterministic output

## Policy Block

- MUST Structured data objects MUST be serialized using stableJson before hashing to ensure deterministic output
