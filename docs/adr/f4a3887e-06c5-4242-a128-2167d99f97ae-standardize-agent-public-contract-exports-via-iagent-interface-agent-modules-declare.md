...
1. MUST: Agent modules MUST declare their primary export as the api.public.contracts facet to enable automated contract discovery and validation

## Policy Block

- MUST Agent modules MUST declare their primary export as the api.public.contracts facet to enable automated contract discovery and validation
