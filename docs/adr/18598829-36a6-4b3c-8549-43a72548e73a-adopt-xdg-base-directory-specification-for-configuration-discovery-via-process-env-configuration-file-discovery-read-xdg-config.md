...
1. MUST: Configuration file discovery MUST read the XDG_CONFIG_HOME environment variable via process.env to determine the base configuration directory location

## Policy Block

- MUST Configuration file discovery MUST read the XDG_CONFIG_HOME environment variable via process.env to determine the base configuration directory location
