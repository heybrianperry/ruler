...
1. MUST: All agent implementations MUST export a named class that implements the IAgent interface or extends AbstractAgent/AgentsMdAgent base classes

## Policy Block

- MUST All agent implementations MUST export a named class that implements the IAgent interface or extends AbstractAgent/AgentsMdAgent base classes
