# Adopt Async/Await Concurrency Model for External API Integration: Implementations Use Async
...
1. MAY: Implementations MAY use async generators (async function*) for streaming or paginated API responses

## Policy Block

- MAY Implementations MAY use async generators (async function*) for streaming or paginated API responses
