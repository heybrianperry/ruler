...
1. SHOULD: Agent implementations SHOULD use console.warn or equivalent logging for non-fatal parse failures and console.error for fatal parse failures that prevent agent initialization

## Policy Block

- SHOULD Agent implementations SHOULD use console.warn or equivalent logging for non-fatal parse failures and console.error for fatal parse failures that prevent agent initialization
