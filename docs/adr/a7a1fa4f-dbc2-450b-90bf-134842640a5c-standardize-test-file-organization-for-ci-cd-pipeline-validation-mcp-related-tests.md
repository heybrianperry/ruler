# Standardize Test File Organization for CI/CD Pipeline Validation: Mcp Related Tests
...
1. SHOULD: MCP-related tests SHOULD validate key propagation, remote configuration loading, and provider-specific behaviors (Claude, Gemini, Firebase)

## Policy Block

- SHOULD MCP-related tests SHOULD validate key propagation, remote configuration loading, and provider-specific behaviors (Claude, Gemini, Firebase)
