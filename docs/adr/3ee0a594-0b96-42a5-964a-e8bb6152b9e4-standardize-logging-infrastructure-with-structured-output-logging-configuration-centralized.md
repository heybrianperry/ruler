# Standardize Logging Infrastructure with Structured Output: Logging Configuration Centralized
...
1. MUST: Logging configuration MUST be centralized in the constants module to ensure consistency across the application

## Policy Block

- MUST Logging configuration MUST be centralized in the constants module to ensure consistency across the application
