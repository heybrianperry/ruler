# Standardize Test Configuration and MCP Integration Testing Patterns: Mcp Configuration Formats
...
1. MUST: All MCP configuration formats (JSON, TOML) MUST have dedicated test suites that validate both valid and invalid configurations

## Policy Block

- MUST All MCP configuration formats (JSON, TOML) MUST have dedicated test suites that validate both valid and invalid configurations
