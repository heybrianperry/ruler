# Standardize TypeScript Module Exports for Public Agent APIs: Index Files Export
...
1. SHOULD: Index files (index.ts) SHOULD re-export public APIs to provide a single entry point for module consumers

## Policy Block

- SHOULD Index files (index.ts) SHOULD re-export public APIs to provide a single entry point for module consumers
