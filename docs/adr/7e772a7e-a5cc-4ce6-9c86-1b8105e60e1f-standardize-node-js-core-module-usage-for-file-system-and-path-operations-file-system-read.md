...
1. MUST: All file system read and write operations MUST use Node.js core modules 'fs' or 'fs/promises' rather than third-party file system abstraction libraries.

## Policy Block

- MUST All file system read and write operations MUST use Node.js core modules 'fs' or 'fs/promises' rather than third-party file system abstraction libraries.
