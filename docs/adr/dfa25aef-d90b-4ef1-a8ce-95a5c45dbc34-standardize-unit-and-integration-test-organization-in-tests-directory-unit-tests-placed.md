# Standardize Unit and Integration Test Organization in tests/ Directory: Unit Tests Placed
...
1. MUST: All unit tests MUST be placed in the tests/unit/ directory hierarchy

## Policy Block

- MUST All unit tests MUST be placed in the tests/unit/ directory hierarchy
