...
1. MUST: All modules that provide functionality to other modules MUST export explicit public API contracts through TypeScript interfaces, types, or classes.

## Policy Block

- MUST All modules that provide functionality to other modules MUST export explicit public API contracts through TypeScript interfaces, types, or classes.
