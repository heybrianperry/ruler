...
1. MUST: Agent implementations MUST import from core modules using the established relative path conventions ('./IAgent' for same directory, '../core/' for core utilities)

## Policy Block

- MUST Agent implementations MUST import from core modules using the established relative path conventions ('./IAgent' for same directory, '../core/' for core utilities)
