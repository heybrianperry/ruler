# Standardize on Vitest for Unit Testing Agent Modules: Agent Unit Test
...
1. MUST: Agent unit test files MUST be placed in tests/unit/agents/ directory with the naming pattern {AgentName}.test.ts

## Policy Block

- MUST Agent unit test files MUST be placed in tests/unit/agents/ directory with the naming pattern {AgentName}.test.ts
