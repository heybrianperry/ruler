# Standardize Core Library Module Detection and Integration: Core Libraries Used
...
1. MUST: Core libraries used in multiple files (detected in 3+ locations) MUST be documented in a central library registry or architecture documentation

## Policy Block

- MUST Core libraries used in multiple files (detected in 3+ locations) MUST be documented in a central library registry or architecture documentation
