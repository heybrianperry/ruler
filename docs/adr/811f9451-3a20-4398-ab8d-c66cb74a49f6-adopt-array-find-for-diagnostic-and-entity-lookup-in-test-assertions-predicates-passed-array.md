...
1. MUST: Predicates passed to Array.find() MUST match on stable identifiers such as diagnostic codes, entity identifiers, or unique property values

## Policy Block

- MUST Predicates passed to Array.find() MUST match on stable identifiers such as diagnostic codes, entity identifiers, or unique property values
