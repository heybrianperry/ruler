...
1. MUST_NOT: Implementations MUST NOT use external hashing libraries when the Node.js crypto module provides equivalent functionality

## Policy Block

- MUST_NOT Implementations MUST NOT use external hashing libraries when the Node.js crypto module provides equivalent functionality
