...
1. MUST_NOT: Code MUST NOT use eval(), Function(), or other dynamic code execution methods to deserialize JSON configuration files

## Policy Block

- MUST_NOT Code MUST NOT use eval(), Function(), or other dynamic code execution methods to deserialize JSON configuration files
