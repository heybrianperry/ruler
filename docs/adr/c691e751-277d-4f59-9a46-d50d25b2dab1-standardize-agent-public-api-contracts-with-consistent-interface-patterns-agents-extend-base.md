# Standardize Agent Public API Contracts with Consistent Interface Patterns: Agents Extend Base
...
1. MAY: Agents MAY extend the base contract with agent-specific methods, provided they do not conflict with or override standard contract methods

## Policy Block

- MAY Agents MAY extend the base contract with agent-specific methods, provided they do not conflict with or override standard contract methods
