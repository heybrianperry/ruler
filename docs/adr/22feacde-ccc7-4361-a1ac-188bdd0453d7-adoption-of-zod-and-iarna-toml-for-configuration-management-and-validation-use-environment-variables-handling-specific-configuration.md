# Adoption of Zod and Iarna/TOML for Configuration Management and Validation: Use Environment Variables Handling Specific Configuration
...
1. SHOULD: SHOULD use environment variables for handling environment-specific configuration paths or secrets.

## Policy Block

- SHOULD SHOULD use environment variables for handling environment-specific configuration paths or secrets.
