...
1. SHOULD: Test suites SHOULD validate configuration merge behavior by parsing both source and target JSON files

## Policy Block

- SHOULD Test suites SHOULD validate configuration merge behavior by parsing both source and target JSON files
