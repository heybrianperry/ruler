...
1. MUST: Async test utilities MUST use verb-based naming that clearly indicates the I/O operation (e.g., readGeminiSettings, writeProject, writeAgent, pathExists)

## Policy Block

- MUST Async test utilities MUST use verb-based naming that clearly indicates the I/O operation (e.g., readGeminiSettings, writeProject, writeAgent, pathExists)
