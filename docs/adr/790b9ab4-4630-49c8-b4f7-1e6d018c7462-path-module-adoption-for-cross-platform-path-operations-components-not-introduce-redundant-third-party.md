...
1. SHOULD_NOT: Components SHOULD NOT introduce redundant third-party path manipulation dependencies when the adopted core path module provides equivalent functionality.

## Policy Block

- SHOULD_NOT Components SHOULD NOT introduce redundant third-party path manipulation dependencies when the adopted core path module provides equivalent functionality.
