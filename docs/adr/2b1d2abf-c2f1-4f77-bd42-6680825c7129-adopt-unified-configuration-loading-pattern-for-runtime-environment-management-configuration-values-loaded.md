# Adopt Unified Configuration Loading Pattern for Runtime Environment Management: Configuration Values Loaded
...
1. SHOULD: Configuration values SHOULD be loaded once at application startup and cached for the lifetime of the process to avoid repeated environment variable lookups

## Policy Block

- SHOULD Configuration values SHOULD be loaded once at application startup and cached for the lifetime of the process to avoid repeated environment variable lookups
