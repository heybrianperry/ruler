...
1. SHOULD: Subagent processing pipelines SHOULD separate discovery (SubagentsProcessor) from utility operations (SubagentsUtils) to maintain clear boundaries

## Policy Block

- SHOULD Subagent processing pipelines SHOULD separate discovery (SubagentsProcessor) from utility operations (SubagentsUtils) to maintain clear boundaries
