# Adopt TypeScript Test Files with .test.ts Extension as Standard Testing Convention: Integration Tests Placed
...
1. SHOULD: Integration tests SHOULD be placed in tests/integration/ directory and focus on component interactions

## Policy Block

- SHOULD Integration tests SHOULD be placed in tests/integration/ directory and focus on component interactions
