...
1. MUST: Tests MUST verify the presence and structure of agent-specific configuration keys (servers, mcpServers, contextFileName) after parsing

## Policy Block

- MUST Tests MUST verify the presence and structure of agent-specific configuration keys (servers, mcpServers, contextFileName) after parsing
