# Standardize Jest as Testing Framework for TypeScript Unit Tests: Test Execution Generate
...
1. MUST: Test execution in CI/CD MUST generate machine-readable test reports (JUnit XML or JSON format) for integration with build systems

## Policy Block

- MUST Test execution in CI/CD MUST generate machine-readable test reports (JUnit XML or JSON format) for integration with build systems
