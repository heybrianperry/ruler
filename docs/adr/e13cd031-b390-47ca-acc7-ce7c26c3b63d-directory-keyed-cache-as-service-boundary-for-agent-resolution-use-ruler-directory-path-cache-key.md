...
1. MUST: Use the ruler directory path as the cache key when storing and retrieving resolved agent selections

## Policy Block

- MUST Use the ruler directory path as the cache key when storing and retrieving resolved agent selections
