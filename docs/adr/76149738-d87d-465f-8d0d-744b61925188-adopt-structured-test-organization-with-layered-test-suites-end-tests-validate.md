# Adopt Structured Test Organization with Layered Test Suites: End Tests Validate
...
1. MUST: End-to-end tests MUST validate complete user workflows or system behaviors across all layers

## Policy Block

- MUST End-to-end tests MUST validate complete user workflows or system behaviors across all layers
