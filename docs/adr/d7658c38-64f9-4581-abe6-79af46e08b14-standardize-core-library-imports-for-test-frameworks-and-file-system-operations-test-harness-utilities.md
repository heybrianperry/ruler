...
1. SHOULD: Test harness utilities SHOULD be imported from centralized test utility modules (./harness) to promote code reuse.

## Policy Block

- SHOULD Test harness utilities SHOULD be imported from centralized test utility modules (./harness) to promote code reuse.
