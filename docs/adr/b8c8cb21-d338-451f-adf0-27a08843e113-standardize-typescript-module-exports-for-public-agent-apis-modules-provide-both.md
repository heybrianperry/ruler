# Standardize TypeScript Module Exports for Public Agent APIs: Modules Provide Both
...
1. MAY: Modules MAY provide both named and default exports if it improves consumer ergonomics, but named exports are preferred for tree-shaking

## Policy Block

- MAY Modules MAY provide both named and default exports if it improves consumer ergonomics, but named exports are preferred for tree-shaking
