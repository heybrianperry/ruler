...
1. SHOULD: Log messages SHOULD include structured context such as file paths, configuration keys, or operation names to enable rapid diagnosis

## Policy Block

- SHOULD Log messages SHOULD include structured context such as file paths, configuration keys, or operation names to enable rapid diagnosis
