# Standardize on Vitest for Unit Testing Agent Modules: Agent Tests Follow
...
1. SHOULD: Agent tests SHOULD follow consistent describe/it block structure for test organization

## Policy Block

- SHOULD Agent tests SHOULD follow consistent describe/it block structure for test organization
