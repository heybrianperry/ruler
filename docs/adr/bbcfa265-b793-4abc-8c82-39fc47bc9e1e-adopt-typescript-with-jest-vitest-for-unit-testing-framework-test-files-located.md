# Adopt TypeScript with Jest/Vitest for Unit Testing Framework: Test Files Located
...
1. MAY: Test files MAY be co-located with source files in a __tests__/ subdirectory as an alternative organization strategy, provided the .test.ts naming convention is maintained.

## Policy Block

- MAY Test files MAY be co-located with source files in a __tests__/ subdirectory as an alternative organization strategy, provided the .test.ts naming convention is maintained.
