...
1. MUST: All TOML configuration file parsing MUST use the adopted TOML parsing library's API functions

## Policy Block

- MUST All TOML configuration file parsing MUST use the adopted TOML parsing library's API functions
