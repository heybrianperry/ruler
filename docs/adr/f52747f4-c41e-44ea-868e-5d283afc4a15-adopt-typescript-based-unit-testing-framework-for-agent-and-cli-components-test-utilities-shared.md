# Adopt TypeScript-based Unit Testing Framework for Agent and CLI Components: Test Utilities Shared
...
1. MAY: Test utilities and shared test fixtures MAY be extracted to common test helper modules to reduce duplication.

## Policy Block

- MAY Test utilities and shared test fixtures MAY be extracted to common test helper modules to reduce duplication.
