# Standardize Core Utility and Agent Interface Exports for External API Consumption: Public Modules Provide
...
1. MAY: Public API modules MAY provide both synchronous and asynchronous variants of operations to accommodate different integration patterns

## Policy Block

- MAY Public API modules MAY provide both synchronous and asynchronous variants of operations to accommodate different integration patterns
