...
1. MUST_NOT: Modules MUST NOT hardcode platform-specific path separator characters when constructing filesystem paths.

## Policy Block

- MUST_NOT Modules MUST NOT hardcode platform-specific path separator characters when constructing filesystem paths.
