...
1. SHOULD: Collection structures SHOULD be passed to propagation functions (propagateSubagentsForClaude) to enable integration with external tools

## Policy Block

- SHOULD Collection structures SHOULD be passed to propagation functions (propagateSubagentsForClaude) to enable integration with external tools
