# Adopt Unit Testing for CI/CD Pipeline Components: Teams Supplement Unit
...
1. MAY: Teams MAY supplement unit tests with integration tests for end-to-end pipeline validation, but unit tests remain mandatory

## Policy Block

- MAY Teams MAY supplement unit tests with integration tests for end-to-end pipeline validation, but unit tests remain mandatory
