...
1. MUST_NOT: Configuration parsing MUST NOT use eval() or Function() constructors to process file content

## Policy Block

- MUST_NOT Configuration parsing MUST NOT use eval() or Function() constructors to process file content
