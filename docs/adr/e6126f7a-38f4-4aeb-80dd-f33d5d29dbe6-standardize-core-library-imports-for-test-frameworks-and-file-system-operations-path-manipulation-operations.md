...
1. MUST: Path manipulation operations MUST use the Node.js 'path' module to ensure cross-platform compatibility.

## Policy Block

- MUST Path manipulation operations MUST use the Node.js 'path' module to ensure cross-platform compatibility.
