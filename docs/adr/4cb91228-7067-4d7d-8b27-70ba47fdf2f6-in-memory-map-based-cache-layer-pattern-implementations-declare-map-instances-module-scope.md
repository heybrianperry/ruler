...
1. MAY: Implementations MAY declare Map instances at module scope for singleton-like caching or at function scope for operation-local caching depending on the required lifecycle

## Policy Block

- MAY Implementations MAY declare Map instances at module scope for singleton-like caching or at function scope for operation-local caching depending on the required lifecycle
