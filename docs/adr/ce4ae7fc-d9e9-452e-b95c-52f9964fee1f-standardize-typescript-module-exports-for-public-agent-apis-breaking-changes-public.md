# Standardize TypeScript Module Exports for Public Agent APIs: Breaking Changes Public
...
1. SHOULD: Breaking changes to public API exports SHOULD be versioned and documented with migration guides

## Policy Block

- SHOULD Breaking changes to public API exports SHOULD be versioned and documented with migration guides
