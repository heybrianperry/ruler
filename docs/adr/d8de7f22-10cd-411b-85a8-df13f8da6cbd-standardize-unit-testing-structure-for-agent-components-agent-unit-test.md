# Standardize Unit Testing Structure for Agent Components: Agent Unit Test
...
1. MUST: Agent unit test files MUST follow the naming convention {AgentName}.test.ts where {AgentName} matches the agent class name

## Policy Block

- MUST Agent unit test files MUST follow the naming convention {AgentName}.test.ts where {AgentName} matches the agent class name
