...
1. MUST: Before processing a directory, the traversal logic MUST resolve symbolic links to their real paths and check if the real path exists in the visited set

## Policy Block

- MUST Before processing a directory, the traversal logic MUST resolve symbolic links to their real paths and check if the real path exists in the visited set
