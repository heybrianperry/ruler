# Adopt Promise-Based Asynchronous Patterns for External API Interfaces: Public Methods Use
...
1. MUST: Public API methods MUST use async/await syntax for asynchronous operations rather than raw Promise constructors or callback patterns

## Policy Block

- MUST Public API methods MUST use async/await syntax for asynchronous operations rather than raw Promise constructors or callback patterns
