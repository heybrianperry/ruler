# Standardize Unit and Integration Test Organization in tests/ Directory: Integration Tests Organized
...
1. MUST: Integration tests MUST be organized under tests/integration/ subdirectory structure

## Policy Block

- MUST Integration tests MUST be organized under tests/integration/ subdirectory structure
