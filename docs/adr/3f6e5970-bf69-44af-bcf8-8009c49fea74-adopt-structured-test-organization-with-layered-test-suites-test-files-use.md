# Adopt Structured Test Organization with Layered Test Suites: Test Files Use
...
1. MUST: All test files MUST use a consistent naming convention with .test.ts (or language-appropriate) extension

## Policy Block

- MUST All test files MUST use a consistent naming convention with .test.ts (or language-appropriate) extension
