...
1. MUST: All external TOML input MUST be parsed using parseTOML from @iarna/toml library with explicit error handling

## Policy Block

- MUST All external TOML input MUST be parsed using parseTOML from @iarna/toml library with explicit error handling
