...
1. SHOULD: Environment variable names SHOULD be documented in a central configuration schema or constants file

## Policy Block

- SHOULD Environment variable names SHOULD be documented in a central configuration schema or constants file
