...
1. MUST: Cache keys MUST be derived from stable identifiers that uniquely identify the cached resource within the operation scope (URLs for server connections, directory paths for configuration hierarchies, names for server instances)

## Policy Block

- MUST Cache keys MUST be derived from stable identifiers that uniquely identify the cached resource within the operation scope (URLs for server connections, directory paths for configuration hierarchies, names for server instances)
