...
1. MUST: Public API contracts that return subagent collections (discoverSubagents, getSelectedSubagentTargets, getSubagentsGitignorePaths) MUST guarantee uniqueness of returned elements

## Policy Block

- MUST Public API contracts that return subagent collections (discoverSubagents, getSelectedSubagentTargets, getSubagentsGitignorePaths) MUST guarantee uniqueness of returned elements
