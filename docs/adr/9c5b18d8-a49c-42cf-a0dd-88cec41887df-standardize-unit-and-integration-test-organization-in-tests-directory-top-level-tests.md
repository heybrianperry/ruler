# Standardize Unit and Integration Test Organization in tests/ Directory: Top Level Tests
...
1. MAY: Top-level tests/ MAY contain cross-cutting or configuration-level tests that don't fit unit/integration categories

## Policy Block

- MAY Top-level tests/ MAY contain cross-cutting or configuration-level tests that don't fit unit/integration categories
