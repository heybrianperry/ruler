...
1. MUST: Gitignore entries for MCP configuration files MUST include both the primary file path and backup file path (with .bak extension) in the deduplication set

## Policy Block

- MUST Gitignore entries for MCP configuration files MUST include both the primary file path and backup file path (with .bak extension) in the deduplication set
