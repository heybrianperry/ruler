...
1. MUST: Agent-specific MCP enablement flags (agents.<agent>.mcp.enabled) MUST be honored when determining whether to write MCP configuration files for that agent in a given directory

## Policy Block

- MUST Agent-specific MCP enablement flags (agents.<agent>.mcp.enabled) MUST be honored when determining whether to write MCP configuration files for that agent in a given directory
