...
1. MUST: Unit tests MUST be colocated with the code they test following the pattern tests/unit/<module>/<component>.test.ts

## Policy Block

- MUST Unit tests MUST be colocated with the code they test following the pattern tests/unit/<module>/<component>.test.ts
