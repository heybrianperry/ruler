...
1. MUST: MUST use `zod` for defining and validating all application configuration schemas.

## Policy Block

- MUST MUST use `zod` for defining and validating all application configuration schemas.
