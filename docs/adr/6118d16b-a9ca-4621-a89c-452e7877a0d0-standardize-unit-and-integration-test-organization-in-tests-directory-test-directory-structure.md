# Standardize Unit and Integration Test Organization in tests/ Directory: Test Directory Structure
...
1. SHOULD: Test directory structure SHOULD mirror the source code organization (e.g., tests/unit/core/, tests/unit/agents/)

## Policy Block

- SHOULD Test directory structure SHOULD mirror the source code organization (e.g., tests/unit/core/, tests/unit/agents/)
