...
1. SHOULD: Error log messages SHOULD include contextual information using template literals for string interpolation

## Policy Block

- SHOULD Error log messages SHOULD include contextual information using template literals for string interpolation
