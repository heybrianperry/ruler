...
1. MUST_NOT: Test code MUST NOT use direct array indexing (e.g., array[0]) to access parsed configuration objects without prior length validation

## Policy Block

- MUST_NOT Test code MUST NOT use direct array indexing (e.g., array[0]) to access parsed configuration objects without prior length validation
