...
1. MUST: Modules requiring path manipulation MUST utilize the Node.js `path` module.

## Policy Block

- MUST Modules requiring path manipulation MUST utilize the Node.js `path` module.
