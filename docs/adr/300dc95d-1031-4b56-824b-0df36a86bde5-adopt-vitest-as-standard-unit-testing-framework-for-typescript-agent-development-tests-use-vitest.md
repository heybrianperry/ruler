...
1. SHOULD: Tests SHOULD use Vitest's native mocking capabilities (vi.mock, vi.fn) rather than external mocking libraries

## Policy Block

- SHOULD Tests SHOULD use Vitest's native mocking capabilities (vi.mock, vi.fn) rather than external mocking libraries
