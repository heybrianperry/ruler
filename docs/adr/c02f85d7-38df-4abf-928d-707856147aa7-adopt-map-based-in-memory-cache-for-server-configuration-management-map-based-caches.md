...
1. SHOULD: Map-based caches SHOULD be scoped to function execution lifetime and not persisted beyond the configuration synchronization operation

## Policy Block

- SHOULD Map-based caches SHOULD be scoped to function execution lifetime and not persisted beyond the configuration synchronization operation
