# Standardize Logging Patterns for CLI and Core Utilities: Error Conditions Logged
...
1. SHOULD: Error conditions SHOULD be logged with appropriate severity levels (error, warn) and include stack traces or error details when available

## Policy Block

- SHOULD Error conditions SHOULD be logged with appropriate severity levels (error, warn) and include stack traces or error details when available
