# Standardize Unit Testing Framework for Agent Components: Unit Tests Placed
...
1. MUST: Unit tests MUST be placed in the `tests/unit/` directory structure, organized by component type (agents, cli, etc.)

## Policy Block

- MUST Unit tests MUST be placed in the `tests/unit/` directory structure, organized by component type (agents, cli, etc.)
