...
1. SHOULD: Set-based deduplication SHOULD be preferred over array filtering or includes() checks for performance-sensitive collection building

## Policy Block

- SHOULD Set-based deduplication SHOULD be preferred over array filtering or includes() checks for performance-sensitive collection building
