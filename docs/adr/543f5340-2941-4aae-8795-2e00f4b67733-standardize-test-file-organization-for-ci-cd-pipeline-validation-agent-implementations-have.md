# Standardize Test File Organization for CI/CD Pipeline Validation: Agent Implementations Have
...
1. MUST: All agent implementations MUST have corresponding unit test files following the naming pattern tests/unit/agents/{AgentName}.test.ts

## Policy Block

- MUST All agent implementations MUST have corresponding unit test files following the naming pattern tests/unit/agents/{AgentName}.test.ts
