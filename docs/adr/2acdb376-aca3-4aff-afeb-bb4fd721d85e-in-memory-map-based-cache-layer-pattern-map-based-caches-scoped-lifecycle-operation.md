...
1. SHOULD: Map-based caches SHOULD be scoped to the lifecycle of the operation or request they serve, avoiding unintended cross-request state sharing

## Policy Block

- SHOULD Map-based caches SHOULD be scoped to the lifecycle of the operation or request they serve, avoiding unintended cross-request state sharing
