...
1. MUST: Test files MUST ensure proper cleanup of resources (temporary directories, file handles, mock state) in afterAll or afterEach hooks to prevent test pollution

## Policy Block

- MUST Test files MUST ensure proper cleanup of resources (temporary directories, file handles, mock state) in afterAll or afterEach hooks to prevent test pollution
