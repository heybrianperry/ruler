...
1. MUST: Agent implementations MUST be placed in the agents directory and follow the naming convention of the agent type followed by 'Agent' suffix

## Policy Block

- MUST Agent implementations MUST be placed in the agents directory and follow the naming convention of the agent type followed by 'Agent' suffix
