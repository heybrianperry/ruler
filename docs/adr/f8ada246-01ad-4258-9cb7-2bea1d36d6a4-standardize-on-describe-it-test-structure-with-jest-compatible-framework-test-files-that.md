...
1. MUST: Test files that create temporary project structures MUST clean up resources in afterEach or afterAll hooks using teardownTestProject or equivalent

## Policy Block

- MUST Test files that create temporary project structures MUST clean up resources in afterEach or afterAll hooks using teardownTestProject or equivalent
