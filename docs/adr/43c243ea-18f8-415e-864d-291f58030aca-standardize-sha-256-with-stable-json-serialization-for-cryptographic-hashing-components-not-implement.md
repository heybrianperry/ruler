...
1. MUST_NOT: Components MUST NOT implement custom hashing logic outside the standardized API contracts

## Policy Block

- MUST_NOT Components MUST NOT implement custom hashing logic outside the standardized API contracts
