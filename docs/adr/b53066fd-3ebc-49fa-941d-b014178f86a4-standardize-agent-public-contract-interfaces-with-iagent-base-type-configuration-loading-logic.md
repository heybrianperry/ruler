...
1. MUST: Configuration loading logic MUST validate input through JSON.parse or parseTOML before processing agent configuration

## Policy Block

- MUST Configuration loading logic MUST validate input through JSON.parse or parseTOML before processing agent configuration
