# Adopt TypeScript with Jest/Vitest for Unit Testing Framework: Unit Tests Organized
...
1. MUST: Unit tests MUST be organized under the tests/unit/ directory, with subdirectories mirroring the source code structure (e.g., tests/unit/agents/ for agent tests, tests/unit/cli/ for CLI tests).

## Policy Block

- MUST Unit tests MUST be organized under the tests/unit/ directory, with subdirectories mirroring the source code structure (e.g., tests/unit/agents/ for agent tests, tests/unit/cli/ for CLI tests).
