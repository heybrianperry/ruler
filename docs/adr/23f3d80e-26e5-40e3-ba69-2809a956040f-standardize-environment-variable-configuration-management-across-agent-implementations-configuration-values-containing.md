# Standardize Environment Variable Configuration Management Across Agent Implementations: Configuration Values Containing
...
1. MUST: Configuration values containing secrets (API keys, tokens, credentials) MUST NOT be logged or exposed in error messages

## Policy Block

- MUST Configuration values containing secrets (API keys, tokens, credentials) MUST NOT be logged or exposed in error messages
