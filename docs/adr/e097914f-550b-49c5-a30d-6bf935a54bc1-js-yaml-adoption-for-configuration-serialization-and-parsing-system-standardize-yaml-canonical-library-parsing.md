...
1. MUST: The system MUST standardize on js-yaml as the canonical library for parsing and serializing structured YAML configurations within core processing modules.

## Policy Block

- MUST The system MUST standardize on js-yaml as the canonical library for parsing and serializing structured YAML configurations within core processing modules.
