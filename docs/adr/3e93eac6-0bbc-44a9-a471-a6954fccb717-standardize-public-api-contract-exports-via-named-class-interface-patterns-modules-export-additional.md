...
1. MAY: Modules MAY export additional utility types or helper interfaces to support consumers in correctly using the primary API contracts.

## Policy Block

- MAY Modules MAY export additional utility types or helper interfaces to support consumers in correctly using the primary API contracts.
