...
1. MUST: Parsing of TOML formatted configuration files MUST be handled by the `@iarna/toml` library.

## Policy Block

- MUST Parsing of TOML formatted configuration files MUST be handled by the `@iarna/toml` library.
