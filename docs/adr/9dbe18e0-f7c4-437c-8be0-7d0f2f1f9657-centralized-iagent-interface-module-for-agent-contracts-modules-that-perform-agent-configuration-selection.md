...
1. SHOULD: Modules that perform agent configuration, selection, capability detection, or lifecycle management SHOULD depend on the IAgent interface rather than concrete implementations.

## Policy Block

- SHOULD Modules that perform agent configuration, selection, capability detection, or lifecycle management SHOULD depend on the IAgent interface rather than concrete implementations.
