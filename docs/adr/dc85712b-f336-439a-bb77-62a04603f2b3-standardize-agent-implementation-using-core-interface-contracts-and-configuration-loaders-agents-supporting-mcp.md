...
1. SHOULD: Agents supporting MCP capabilities SHOULD use getAgentMcpCapabilities, agentSupportsMcp, and filterMcpConfigForAgent from mcp/capabilities module

## Policy Block

- SHOULD Agents supporting MCP capabilities SHOULD use getAgentMcpCapabilities, agentSupportsMcp, and filterMcpConfigForAgent from mcp/capabilities module
