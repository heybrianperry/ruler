...
1. MUST: All modules that provide public APIs MUST export named classes, interfaces, or type definitions as their primary contract mechanism.

## Policy Block

- MUST All modules that provide public APIs MUST export named classes, interfaces, or type definitions as their primary contract mechanism.
