...
1. SHOULD: Test suites SHOULD use describe/it structure from testing frameworks to organize JSON validation tests by agent type and configuration scenario

## Policy Block

- SHOULD Test suites SHOULD use describe/it structure from testing frameworks to organize JSON validation tests by agent type and configuration scenario
