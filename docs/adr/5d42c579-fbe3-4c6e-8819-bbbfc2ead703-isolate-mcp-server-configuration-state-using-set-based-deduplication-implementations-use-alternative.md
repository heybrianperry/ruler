...
1. MAY: Implementations MAY use alternative deduplication strategies (Map, object keys) if they provide equivalent uniqueness guarantees

## Policy Block

- MAY Implementations MAY use alternative deduplication strategies (Map, object keys) if they provide equivalent uniqueness guarantees
