...
1. MAY: New components MAY route diagnostic and verbose execution messages through namespaced verbose output channels that respect runtime verbosity flags.

## Policy Block

- MAY New components MAY route diagnostic and verbose execution messages through namespaced verbose output channels that respect runtime verbosity flags.
