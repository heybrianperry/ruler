# Standardize Agent-Based External API Integration Architecture: Agent Implementations Use
...
1. SHOULD: Agent implementations SHOULD use the agent-utils module for common operations such as request formatting, response parsing, and error handling

## Policy Block

- SHOULD Agent implementations SHOULD use the agent-utils module for common operations such as request formatting, response parsing, and error handling
