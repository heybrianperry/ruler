...
1. SHOULD: For new cryptographic hashing requirements, SHA256 SHOULD be the default algorithm unless specific security or performance requirements dictate an alternative.
