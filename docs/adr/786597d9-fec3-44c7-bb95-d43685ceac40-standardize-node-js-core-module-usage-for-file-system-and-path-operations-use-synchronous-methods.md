...
1. MUST_NOT: Use synchronous fs methods (e.g., fs.readFileSync) in agent implementations or core processors where async operations are available

## Policy Block

- MUST_NOT Use synchronous fs methods (e.g., fs.readFileSync) in agent implementations or core processors where async operations are available
