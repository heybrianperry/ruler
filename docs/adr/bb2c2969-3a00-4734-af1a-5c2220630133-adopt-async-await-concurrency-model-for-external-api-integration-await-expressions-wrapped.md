# Adopt Async/Await Concurrency Model for External API Integration: Await Expressions Wrapped
...
1. MUST: All await expressions MUST be wrapped in try-catch blocks or have error handling at the call site to prevent unhandled promise rejections

## Policy Block

- MUST All await expressions MUST be wrapped in try-catch blocks or have error handling at the call site to prevent unhandled promise rejections
