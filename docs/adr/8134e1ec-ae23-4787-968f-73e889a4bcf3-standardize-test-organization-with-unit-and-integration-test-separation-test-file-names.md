...
1. SHOULD: Test file names SHOULD mirror the structure and naming of the source files they test, with a '.test.js' or '.test.ts' suffix

## Policy Block

- SHOULD Test file names SHOULD mirror the structure and naming of the source files they test, with a '.test.js' or '.test.ts' suffix
