# Standardize Logging Patterns for Public API Contracts: File System Utility
...
1. MUST: File system utility operations MUST log file paths, operation types, and outcomes (success/failure) with appropriate log levels

## Policy Block

- MUST File system utility operations MUST log file paths, operation types, and outcomes (success/failure) with appropriate log levels
