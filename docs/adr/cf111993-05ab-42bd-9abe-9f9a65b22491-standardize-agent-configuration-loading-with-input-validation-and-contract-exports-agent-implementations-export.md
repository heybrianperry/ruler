...
1. MUST: All agent implementations MUST export a public contract interface that implements IAgent

## Policy Block

- MUST All agent implementations MUST export a public contract interface that implements IAgent
