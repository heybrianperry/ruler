...
1. SHOULD: Test files SHOULD be organized by component type (unit, integration) and functional area (agents, config, paths)

## Policy Block

- SHOULD Test files SHOULD be organized by component type (unit, integration) and functional area (agents, config, paths)
