...
1. SHOULD: Modules that parse TOML configuration files SHOULD validate the parsed output against a schema before consuming configuration values

## Policy Block

- SHOULD Modules that parse TOML configuration files SHOULD validate the parsed output against a schema before consuming configuration values
