...
1. MUST: SHA-256 MUST be the default hashing algorithm for data integrity and content addressing use cases

## Policy Block

- MUST SHA-256 MUST be the default hashing algorithm for data integrity and content addressing use cases
