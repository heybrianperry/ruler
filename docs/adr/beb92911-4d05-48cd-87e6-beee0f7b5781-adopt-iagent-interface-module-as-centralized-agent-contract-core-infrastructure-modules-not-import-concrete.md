...
1. MUST_NOT: Core infrastructure modules MUST NOT import concrete agent implementation classes when only the interface contract is required for type checking or polymorphic handling.

## Policy Block

- MUST_NOT Core infrastructure modules MUST NOT import concrete agent implementation classes when only the interface contract is required for type checking or polymorphic handling.
