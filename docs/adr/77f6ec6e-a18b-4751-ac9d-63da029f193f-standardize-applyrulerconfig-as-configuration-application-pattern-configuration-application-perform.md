...
1. MUST: Configuration application MUST perform input validation using appropriate parsers (JSON.parse, parseTOML) before applying configuration changes

## Policy Block

- MUST Configuration application MUST perform input validation using appropriate parsers (JSON.parse, parseTOML) before applying configuration changes
