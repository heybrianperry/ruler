...
1. MUST: The apply engine MUST write the .ruler-provenance.json sidecar atomically with its corresponding artifact so that no generated artifact exists on disk without a co-located provenance record.

## Policy Block

- MUST The apply engine MUST write the .ruler-provenance.json sidecar atomically with its corresponding artifact so that no generated artifact exists on disk without a co-located provenance record.
