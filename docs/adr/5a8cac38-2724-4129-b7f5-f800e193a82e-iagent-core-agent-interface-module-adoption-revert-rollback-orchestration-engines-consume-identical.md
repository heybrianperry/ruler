...
1. MUST: Revert and rollback orchestration engines MUST consume identical IAgent contract abstractions and resolution mappings as primary execution engines.

## Policy Block

- MUST Revert and rollback orchestration engines MUST consume identical IAgent contract abstractions and resolution mappings as primary execution engines.
