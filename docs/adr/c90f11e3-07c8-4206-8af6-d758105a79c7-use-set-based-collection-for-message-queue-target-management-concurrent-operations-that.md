...
1. MUST: Concurrent operations that populate target collections MUST NOT assume insertion order or rely on array indexing semantics

## Policy Block

- MUST Concurrent operations that populate target collections MUST NOT assume insertion order or rely on array indexing semantics
