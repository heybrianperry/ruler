# Standardize Test File Organization in tests/ Directory with Unit and Integration Separation: Unit Test Files
...
1. SHOULD: Unit test files SHOULD mirror the directory structure of the source files they test (e.g., src/core/RuleProcessor.ts → tests/unit/core/RuleProcessor.test.ts)

## Policy Block

- SHOULD Unit test files SHOULD mirror the directory structure of the source files they test (e.g., src/core/RuleProcessor.ts → tests/unit/core/RuleProcessor.test.ts)
