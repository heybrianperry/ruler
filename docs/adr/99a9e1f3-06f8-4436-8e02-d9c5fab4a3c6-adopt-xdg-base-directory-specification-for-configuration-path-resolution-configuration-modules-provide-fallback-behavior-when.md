...
1. SHOULD: Configuration modules SHOULD provide fallback behavior when XDG_CONFIG_HOME is not set, following XDG specification defaults

## Policy Block

- SHOULD Configuration modules SHOULD provide fallback behavior when XDG_CONFIG_HOME is not set, following XDG specification defaults
