...
1. SHOULD: Agent configuration processors SHOULD implement loadExistingConfig, saveConfig, and handleMcpConfiguration functions to separate concerns of reading, writing, and transforming configuration state

## Policy Block

- SHOULD Agent configuration processors SHOULD implement loadExistingConfig, saveConfig, and handleMcpConfiguration functions to separate concerns of reading, writing, and transforming configuration state
