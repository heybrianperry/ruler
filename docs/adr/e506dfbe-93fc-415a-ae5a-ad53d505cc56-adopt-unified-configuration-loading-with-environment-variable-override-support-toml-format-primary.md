# Adopt Unified Configuration Loading with Environment Variable Override Support: Toml Format Primary
...
1. SHOULD: TOML format SHOULD be the primary file-based configuration format for human-readable configuration files

## Policy Block

- SHOULD TOML format SHOULD be the primary file-based configuration format for human-readable configuration files
