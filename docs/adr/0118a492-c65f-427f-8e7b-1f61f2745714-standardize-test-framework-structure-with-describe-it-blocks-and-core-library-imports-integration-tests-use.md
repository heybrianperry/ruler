...
1. SHOULD: Integration tests SHOULD use beforeEach/afterEach hooks with setupTestProject and teardownTestProject patterns for test isolation

## Policy Block

- SHOULD Integration tests SHOULD use beforeEach/afterEach hooks with setupTestProject and teardownTestProject patterns for test isolation
