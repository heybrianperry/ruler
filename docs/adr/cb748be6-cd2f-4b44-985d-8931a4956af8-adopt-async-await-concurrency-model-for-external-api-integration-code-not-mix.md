# Adopt Async/Await Concurrency Model for External API Integration: Code Not Mix
...
1. MUST_NOT: Code MUST NOT mix callback-based patterns with async/await in the same module without proper promisification

## Policy Block

- MUST_NOT Code MUST NOT mix callback-based patterns with async/await in the same module without proper promisification
