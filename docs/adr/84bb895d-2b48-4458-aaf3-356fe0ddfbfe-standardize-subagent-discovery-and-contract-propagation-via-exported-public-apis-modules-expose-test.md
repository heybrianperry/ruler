...
1. MAY: Modules MAY expose test-only reset functions (_resetExperimentalWarningForTests) to support isolated unit testing without global state pollution

## Policy Block

- MAY Modules MAY expose test-only reset functions (_resetExperimentalWarningForTests) to support isolated unit testing without global state pollution
