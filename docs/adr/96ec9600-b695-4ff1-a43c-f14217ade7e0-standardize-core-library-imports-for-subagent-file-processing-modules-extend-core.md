...
1. MAY: Modules MAY extend the core library set with additional parsing libraries if new configuration formats are introduced

## Policy Block

- MAY Modules MAY extend the core library set with additional parsing libraries if new configuration formats are introduced
