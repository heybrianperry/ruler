...
1. MUST: File system operations MUST use Node.js 'fs', 'path', or 'fs/promises' modules as detected core libraries

## Policy Block

- MUST File system operations MUST use Node.js 'fs', 'path', or 'fs/promises' modules as detected core libraries
