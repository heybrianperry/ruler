...
1. SHOULD: Schema definitions SHOULD be colocated with the modules that consume the configuration to maintain clear ownership and facilitate schema evolution

## Policy Block

- SHOULD Schema definitions SHOULD be colocated with the modules that consume the configuration to maintain clear ownership and facilitate schema evolution
