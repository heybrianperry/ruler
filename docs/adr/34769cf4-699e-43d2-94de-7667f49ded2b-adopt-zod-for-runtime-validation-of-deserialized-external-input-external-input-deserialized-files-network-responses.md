...
1. MUST: All external input deserialized from files, network responses, or user-provided text MUST be validated against a Zod schema before use in application logic

## Policy Block

- MUST All external input deserialized from files, network responses, or user-provided text MUST be validated against a Zod schema before use in application logic
