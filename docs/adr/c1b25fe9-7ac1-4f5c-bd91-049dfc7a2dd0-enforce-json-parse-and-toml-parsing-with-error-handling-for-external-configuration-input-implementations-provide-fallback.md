...
1. MAY: Implementations MAY provide fallback or default configurations when parsing fails, if appropriate for the use case

## Policy Block

- MAY Implementations MAY provide fallback or default configurations when parsing fails, if appropriate for the use case
