...
1. MUST: Use Set data structures when collecting file paths, gitignore entries, or configuration keys that require uniqueness guarantees

## Policy Block

- MUST Use Set data structures when collecting file paths, gitignore entries, or configuration keys that require uniqueness guarantees
