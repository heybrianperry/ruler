# Standardize Test File Organization in tests/ Directory with Unit and Integration Separation: Test Files Placed
...
1. MUST: All test files MUST be placed within the tests/ directory at the project root

## Policy Block

- MUST All test files MUST be placed within the tests/ directory at the project root
