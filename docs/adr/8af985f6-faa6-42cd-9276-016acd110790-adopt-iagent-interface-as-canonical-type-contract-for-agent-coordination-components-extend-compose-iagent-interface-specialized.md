...
1. MAY: Components MAY extend or compose the IAgent interface for specialized coordination scenarios, provided the extension maintains compatibility with the base contract.

## Policy Block

- MAY Components MAY extend or compose the IAgent interface for specialized coordination scenarios, provided the extension maintains compatibility with the base contract.
