...
1. SHOULD: Cache lookup operations SHOULD employ nullish coalescing or explicit existence checks when retrieving keyed definitions to provide deterministic fallback handling for missing cache entries.

## Policy Block

- SHOULD Cache lookup operations SHOULD employ nullish coalescing or explicit existence checks when retrieving keyed definitions to provide deterministic fallback handling for missing cache entries.
