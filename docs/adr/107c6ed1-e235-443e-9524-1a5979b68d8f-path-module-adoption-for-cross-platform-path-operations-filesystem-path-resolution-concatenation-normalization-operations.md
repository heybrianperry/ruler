...
1. MUST: All filesystem path resolution, concatenation, and normalization operations across modules MUST utilize the core path module APIs rather than raw string concatenation or custom delimiter manipulation.

## Policy Block

- MUST All filesystem path resolution, concatenation, and normalization operations across modules MUST utilize the core path module APIs rather than raw string concatenation or custom delimiter manipulation.
