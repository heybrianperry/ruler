...
1. MUST: All file I/O operations in agent implementations and MCP infrastructure MUST use Node.js core filesystem modules (fs, fs/promises, path) as the foundational API layer.

## Policy Block

- MUST All file I/O operations in agent implementations and MCP infrastructure MUST use Node.js core filesystem modules (fs, fs/promises, path) as the foundational API layer.
