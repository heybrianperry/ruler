# Standardize Unit Testing for Agent Implementations: Invalid Edge Case
...
1. SHOULD: Invalid or edge case scenarios SHOULD have dedicated test files (e.g., invalid-agent.test.ts) to verify error handling

## Policy Block

- SHOULD Invalid or edge case scenarios SHOULD have dedicated test files (e.g., invalid-agent.test.ts) to verify error handling
