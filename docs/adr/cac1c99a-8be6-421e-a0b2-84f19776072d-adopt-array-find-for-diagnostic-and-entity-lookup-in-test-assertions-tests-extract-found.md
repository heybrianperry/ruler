...
1. MAY: Tests MAY extract the found object into a named variable when multiple assertions are performed on the same entity

## Policy Block

- MAY Tests MAY extract the found object into a named variable when multiple assertions are performed on the same entity
