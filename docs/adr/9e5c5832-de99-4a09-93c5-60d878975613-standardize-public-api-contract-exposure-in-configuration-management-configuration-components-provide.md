# Standardize Public API Contract Exposure in Configuration Management: Configuration Components Provide
...
1. MAY: Configuration components MAY provide additional utility methods beyond the core contract for convenience, provided they maintain contract compatibility

## Policy Block

- MAY Configuration components MAY provide additional utility methods beyond the core contract for convenience, provided they maintain contract compatibility
