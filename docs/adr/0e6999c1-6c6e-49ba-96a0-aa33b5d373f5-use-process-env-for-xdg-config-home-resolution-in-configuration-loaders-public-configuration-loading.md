...
1. MUST: Public configuration loading contracts (loadUnifiedConfig, loadConfig) MUST maintain consistent XDG_CONFIG_HOME resolution behavior

## Policy Block

- MUST Public configuration loading contracts (loadUnifiedConfig, loadConfig) MUST maintain consistent XDG_CONFIG_HOME resolution behavior
