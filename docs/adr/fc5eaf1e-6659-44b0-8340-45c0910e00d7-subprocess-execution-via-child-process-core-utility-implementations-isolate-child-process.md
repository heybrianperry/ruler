...
1. SHOULD: Core utility implementations SHOULD isolate child_process invocations behind domain-specific abstraction wrappers to permit test substitution.

## Policy Block

- SHOULD Core utility implementations SHOULD isolate child_process invocations behind domain-specific abstraction wrappers to permit test substitution.
