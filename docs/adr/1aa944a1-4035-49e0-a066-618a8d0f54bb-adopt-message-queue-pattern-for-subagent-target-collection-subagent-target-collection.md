...
1. MUST: Subagent target collection MUST use Set-based data structures to ensure uniqueness of discovered targets

## Policy Block

- MUST Subagent target collection MUST use Set-based data structures to ensure uniqueness of discovered targets
