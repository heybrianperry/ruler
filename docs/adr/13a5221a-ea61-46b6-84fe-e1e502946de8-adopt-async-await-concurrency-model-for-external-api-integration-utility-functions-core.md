# Adopt Async/Await Concurrency Model for External API Integration: Utility Functions Core
...
1. SHOULD: Utility functions in core modules (SkillsUtils, GitignoreUtils, revert-engine) SHOULD expose async interfaces for consistency

## Policy Block

- SHOULD Utility functions in core modules (SkillsUtils, GitignoreUtils, revert-engine) SHOULD expose async interfaces for consistency
