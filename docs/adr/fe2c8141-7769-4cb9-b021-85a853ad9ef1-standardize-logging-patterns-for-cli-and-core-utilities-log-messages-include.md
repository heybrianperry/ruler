# Standardize Logging Patterns for CLI and Core Utilities: Log Messages Include
...
1. SHOULD: Log messages SHOULD include contextual information such as operation type, affected resources, and relevant identifiers to enable effective debugging

## Policy Block

- SHOULD Log messages SHOULD include contextual information such as operation type, affected resources, and relevant identifiers to enable effective debugging
