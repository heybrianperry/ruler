...
1. MUST: Runtime global configuration directory resolution MUST prioritize the process.env.XDG_CONFIG_HOME environment variable when set and non-empty before falling back to the standard operating system user configuration path.

## Policy Block

- MUST Runtime global configuration directory resolution MUST prioritize the process.env.XDG_CONFIG_HOME environment variable when set and non-empty before falling back to the standard operating system user configuration path.
