# Adopt TypeScript Test Files with .test.ts Extension as Standard Testing Convention: Test Files Organized
...
1. MUST: Test files MUST be organized under a tests/ directory structure with subdirectories for test types (unit, integration, e2e)

## Policy Block

- MUST Test files MUST be organized under a tests/ directory structure with subdirectories for test types (unit, integration, e2e)
