...
1. MUST: Test code MUST use Array.find() with explicit predicate functions when accessing elements from parsed configuration arrays

## Policy Block

- MUST Test code MUST use Array.find() with explicit predicate functions when accessing elements from parsed configuration arrays
