...
1. SHOULD: Core infrastructure components SHOULD import shared constants from the centralized constants module to maintain consistency across the core layer

## Policy Block

- SHOULD Core infrastructure components SHOULD import shared constants from the centralized constants module to maintain consistency across the core layer
