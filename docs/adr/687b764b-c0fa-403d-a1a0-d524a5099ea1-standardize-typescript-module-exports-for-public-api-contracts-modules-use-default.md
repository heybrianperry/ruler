# Standardize TypeScript Module Exports for Public API Contracts: Modules Use Default
...
1. MAY: Modules MAY use default exports for single-purpose utilities, but named exports are preferred for clarity and tree-shaking optimization

## Policy Block

- MAY Modules MAY use default exports for single-purpose utilities, but named exports are preferred for clarity and tree-shaking optimization
