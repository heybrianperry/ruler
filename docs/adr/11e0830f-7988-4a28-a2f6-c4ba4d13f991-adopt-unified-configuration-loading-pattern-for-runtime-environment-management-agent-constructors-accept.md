# Adopt Unified Configuration Loading Pattern for Runtime Environment Management: Agent Constructors Accept
...
1. SHOULD: Agent constructors SHOULD accept configuration objects that have been pre-loaded through UnifiedConfigLoader rather than loading configuration internally

## Policy Block

- SHOULD Agent constructors SHOULD accept configuration objects that have been pre-loaded through UnifiedConfigLoader rather than loading configuration internally
