...
1. MUST: Before implementing any code that uses @iarna/toml, developers MUST discover the project's dependency lock artifact, resolve the exact installed version, and verify API compatibility against that version's official documentation

## Policy Block

- MUST Before implementing any code that uses @iarna/toml, developers MUST discover the project's dependency lock artifact, resolve the exact installed version, and verify API compatibility against that version's official documentation
