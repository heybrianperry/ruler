# Standardize Core Utility and Agent Interface Exports for External API Consumption: Agent Selection Logic
...
1. SHOULD: Agent selection logic SHOULD provide extension points for registering custom agents without modifying core code

## Policy Block

- SHOULD Agent selection logic SHOULD provide extension points for registering custom agents without modifying core code
