...
1. MUST_NOT: In-memory cache structures MUST NOT be used for shared cross-process persistence or durable datastore requirements without integrating an external datastore abstraction.

## Policy Block

- MUST_NOT In-memory cache structures MUST NOT be used for shared cross-process persistence or durable datastore requirements without integrating an external datastore abstraction.
