...
1. SHOULD: Collection queries SHOULD be performed immediately before assertions to maintain test readability and minimize variable scope

## Policy Block

- SHOULD Collection queries SHOULD be performed immediately before assertions to maintain test readability and minimize variable scope
