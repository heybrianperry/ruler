# Adopt Async/Await Pattern for External API Integration: Async Operations Include
...
1. MUST: All async operations MUST include proper error handling using try/catch blocks or .catch() handlers

## Policy Block

- MUST All async operations MUST include proper error handling using try/catch blocks or .catch() handlers
