...
1. MUST: Global configuration directory paths derived from process.env.XDG_CONFIG_HOME MUST be resolved and normalized as absolute filesystem paths before accessing or checking directory existence.

## Policy Block

- MUST Global configuration directory paths derived from process.env.XDG_CONFIG_HOME MUST be resolved and normalized as absolute filesystem paths before accessing or checking directory existence.
