...
1. MAY: Components MAY implement log sampling or rate limiting for high-frequency events to manage log volume

## Policy Block

- MAY Components MAY implement log sampling or rate limiting for high-frequency events to manage log volume
