...
1. SHOULD: Configuration files referenced by XDG_CONFIG_HOME SHOULD be protected with appropriate file system permissions to restrict unauthorized access.

## Policy Block

- SHOULD Configuration files referenced by XDG_CONFIG_HOME SHOULD be protected with appropriate file system permissions to restrict unauthorized access.
