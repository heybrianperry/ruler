...
1. SHOULD: Hash implementations SHOULD use createHash('sha256') from the crypto module rather than third-party libraries

## Policy Block

- SHOULD Hash implementations SHOULD use createHash('sha256') from the crypto module rather than third-party libraries
