# Adopt AgentsMdAgent Base Class for Agent Implementations: Agent Implementations Import Agentsmdagent Relative Path
...
1. MUST: Agent implementations MUST import AgentsMdAgent using relative path resolution from the agents directory.

## Policy Block

- MUST Agent implementations MUST import AgentsMdAgent using relative path resolution from the agents directory.
